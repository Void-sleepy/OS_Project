...
main(void)
{
  ...
  12:	91250513          	addi	a0,a0,-1774 # 920 <malloc+0x106>
  16:	348000ef          	jal	35e <open>
  ...
  dup(0);  // stdout
  1e:	4501                	li	a0,0
  20:	376000ef          	jal	396 <dup>
  dup(0);  // stderr
  24:	4501                	li	a0,0
  26:	370000ef          	jal	396 <dup>

  for(;;){
    printf("init: starting sh\n");
  2a:	00001917          	auipc	s2,0x1
  2e:	8fe90913          	addi	s2,s2,-1794 # 928 <malloc+0x10e>
  32:	854a                	mv	a0,s2
  ...
  56:	92650513          	addi	a0,a0,-1754 # 978 <malloc+0x15e>
  ...
  6c:	8b850513          	addi	a0,a0,-1864 # 920 <malloc+0x106>
  70:	2f6000ef          	jal	366 <mknod>
    open("console", O_RDWR);
  74:	4589                	li	a1,2
  76:	00001517          	auipc	a0,0x1
  7a:	8aa50513          	addi	a0,a0,-1878 # 920 <malloc+0x106>
  7e:	2e0000ef          	jal	35e <open>
  82:	bf71                	j	1e <main+0x1e>
      printf("init: fork failed\n");
  84:	00001517          	auipc	a0,0x1
  88:	8bc50513          	addi	a0,a0,-1860 # 940 <malloc+0x126>
  ...
  a2:	8ba50513          	addi	a0,a0,-1862 # 958 <malloc+0x13e>
  a6:	2b0000ef          	jal	356 <exec>
      printf("init: exec sh failed\n");
  aa:	00001517          	auipc	a0,0x1
  ae:	8b650513          	addi	a0,a0,-1866 # 960 <malloc+0x146>
...
stat(const char *n, struct stat *st)
{
 ...
 20e:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 210:	85ca                	mv	a1,s2
 212:	164000ef          	jal	376 <fstat>
 216:	892a                	mv	s2,a0
  close(fd);
 218:	8526                	mv	a0,s1
 21a:	1a4000ef          	jal	3be <close>
  return r;
 21e:	64a2                	ld	s1,8(sp)
}
 220:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42e:	57650513          	addi	a0,a0,1398 # 9a0 <digits>
 432:	883a                	mv	a6,a4
...
malloc(uint nbytes)
{
 ...
 83a:	7da53503          	ld	a0,2010(a0) # 1010 <freep>
 ...
 86a:	7aa90913          	addi	s2,s2,1962 # 1010 <freep>
  if(p == (char*)-1)
 86e:	5afd                	li	s5,-1
 ...
 8f4:	72a73023          	sd	a0,1824(a4) # 1010 <freep>
      return (void*)(p + 1);
