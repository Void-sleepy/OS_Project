...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      92:	31d000ef          	jal	bae <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0aa50513          	addi	a0,a0,170 # 1140 <malloc+0xfe>
      9e:	319000ef          	jal	bb6 <chdir>
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     102:	285000ef          	jal	b86 <open>
     106:	2e1000ef          	jal	be6 <close>
    iters++;
    ...
    int what = rand() % 23;
     ...
     2fe:	0d1000ef          	jal	bce <sbrk>
     302:	b521                	j	10a <go+0x96>
    } else if(what == 16){
      if(sbrk(0) > break0)
     304:	4501                	li	a0,0
     306:	0c9000ef          	jal	bce <sbrk>
     30a:	e0aaf0e3          	bgeu	s5,a0,10a <go+0x96>
        sbrk(-(sbrk(0) - break0));
     30e:	4501                	li	a0,0
     310:	0bf000ef          	jal	bce <sbrk>
     314:	40aa853b          	subw	a0,s5,a0
     318:	0b7000ef          	jal	bce <sbrk>
     ...
     352:	035000ef          	jal	b86 <open>
     356:	091000ef          	jal	be6 <close>
        exit(0);
     35a:	4501                	li	a0,0
     ...
     394:	bb9d                	j	10a <go+0x96>
        kill(getpid());
     396:	031000ef          	jal	bc6 <getpid>
     39a:	7dc000ef          	jal	b76 <kill>
        exit(0);
     39e:	4501                	li	a0,0
     ...
     3d0:	017000ef          	jal	be6 <close>
      close(fds[1]);
     3d4:	f9c42503          	lw	a0,-100(s0)
     3d8:	00f000ef          	jal	be6 <close>
      wait(0);
     3dc:	4501                	li	a0,0
     ...
     5ce:	618000ef          	jal	be6 <close>
      close(aa[1]);
     5d2:	f8c42503          	lw	a0,-116(s0)
     5d6:	610000ef          	jal	be6 <close>
      close(bb[1]);
     5da:	f9442503          	lw	a0,-108(s0)
     5de:	608000ef          	jal	be6 <close>
      char buf[4] = { 0, 0, 0, 0 };
     ...
     67a:	56c000ef          	jal	be6 <close>
        close(bb[1]);
     67e:	f9442503          	lw	a0,-108(s0)
     682:	564000ef          	jal	be6 <close>
        close(aa[0]);
     686:	f8842503          	lw	a0,-120(s0)
     68a:	55c000ef          	jal	be6 <close>
        close(1);
     68e:	4505                	li	a0,1
     690:	556000ef          	jal	be6 <close>
        if(dup(aa[1]) != 1){
     694:	f8c42503          	lw	a0,-116(s0)
     698:	526000ef          	jal	bbe <dup>
     69c:	4785                	li	a5,1
     ...
     716:	4d0000ef          	jal	be6 <close>
        close(bb[0]);
     71a:	f9042503          	lw	a0,-112(s0)
     71e:	4c8000ef          	jal	be6 <close>
        close(0);
     722:	4501                	li	a0,0
     724:	4c2000ef          	jal	be6 <close>
        if(dup(aa[0]) != 0){
     728:	f8842503          	lw	a0,-120(s0)
     72c:	492000ef          	jal	bbe <dup>
     ...
     74a:	49c000ef          	jal	be6 <close>
        close(1);
     74e:	4505                	li	a0,1
     750:	496000ef          	jal	be6 <close>
        if(dup(bb[1]) != 1){
     754:	f9442503          	lw	a0,-108(s0)
     758:	466000ef          	jal	bbe <dup>
     75c:	4785                	li	a5,1
...
iter()
{
  ...
  exit(0);
    ...
    kill(pid1);
     8a0:	8526                	mv	a0,s1
     8a2:	2d4000ef          	jal	b76 <kill>
    kill(pid2);
     8a6:	854a                	mv	a0,s2
     8a8:	2ce000ef          	jal	b76 <kill>
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
     a38:	85ca                	mv	a1,s2
     a3a:	164000ef          	jal	b9e <fstat>
     a3e:	892a                	mv	s2,a0
  close(fd);
     a40:	8526                	mv	a0,s1
     a42:	1a4000ef          	jal	be6 <close>
  return r;
     a46:	64a2                	ld	s1,8(sp)
}
     a48:	854a                	mv	a0,s2
