...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	0a650513          	addi	a0,a0,166 # 1130 <malloc+0x102>
      92:	325000ef          	jal	bb6 <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	09a50513          	addi	a0,a0,154 # 1130 <malloc+0x102>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b2:	08a50513          	addi	a0,a0,138 # 1138 <malloc+0x10a>
      b6:	6c5000ef          	jal	f7a <printf>
    exit(1);
      ba:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      ce:	09650513          	addi	a0,a0,150 # 1160 <malloc+0x132>
      d2:	2ed000ef          	jal	bbe <chdir>
      d6:	00001997          	auipc	s3,0x1
      da:	09a98993          	addi	s3,s3,154 # 1170 <malloc+0x142>
      de:	c489                	beqz	s1,e8 <go+0x74>
      e0:	00001997          	auipc	s3,0x1
      e4:	08898993          	addi	s3,s3,136 # 1168 <malloc+0x13a>
  uint64 iters = 0;
      e8:	4481                	li	s1,0
  int fd = -1;
      ea:	5a7d                	li	s4,-1
      ec:	00001917          	auipc	s2,0x1
      f0:	35490913          	addi	s2,s2,852 # 1440 <malloc+0x412>
    ...
    if(what == 1){
      ...
      fe:	07e50513          	addi	a0,a0,126 # 1178 <malloc+0x14a>
    ...
    int what = rand() % 23;
     ...
     14c:	04050513          	addi	a0,a0,64 # 1188 <malloc+0x15a>
     ...
     15e:	01e50513          	addi	a0,a0,30 # 1178 <malloc+0x14a>
     162:	23d000ef          	jal	b9e <unlink>
     166:	b755                	j	10a <go+0x96>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     168:	00001517          	auipc	a0,0x1
     16c:	fc850513          	addi	a0,a0,-56 # 1130 <malloc+0x102>
     ...
     17a:	02a50513          	addi	a0,a0,42 # 11a0 <malloc+0x172>
     17e:	221000ef          	jal	b9e <unlink>
      chdir("/");
     182:	00001517          	auipc	a0,0x1
     186:	fde50513          	addi	a0,a0,-34 # 1160 <malloc+0x132>
     18a:	235000ef          	jal	bbe <chdir>
     18e:	bfb5                	j	10a <go+0x96>
        printf("grind: chdir grindir failed\n");
     190:	00001517          	auipc	a0,0x1
     194:	fa850513          	addi	a0,a0,-88 # 1138 <malloc+0x10a>
     198:	5e3000ef          	jal	f7a <printf>
        exit(1);
     19c:	4505                	li	a0,1
     ...
     1b0:	ffc50513          	addi	a0,a0,-4 # 11a8 <malloc+0x17a>
     ...
     1ca:	ff250513          	addi	a0,a0,-14 # 11b8 <malloc+0x18a>
     ...
     2b8:	f8c50513          	addi	a0,a0,-116 # 1240 <malloc+0x212>
     2bc:	4bf000ef          	jal	f7a <printf>
        exit(1);
     2c0:	4505                	li	a0,1
     ...
     2ea:	f5a50513          	addi	a0,a0,-166 # 1240 <malloc+0x212>
     2ee:	48d000ef          	jal	f7a <printf>
        exit(1);
     2f2:	4505                	li	a0,1
     ...
     32e:	f3650513          	addi	a0,a0,-202 # 1260 <malloc+0x232>
     ...
     34e:	f0e50513          	addi	a0,a0,-242 # 1258 <malloc+0x22a>
     ...
     364:	ee050513          	addi	a0,a0,-288 # 1240 <malloc+0x212>
     368:	413000ef          	jal	f7a <printf>
        exit(1);
     36c:	4505                	li	a0,1
     36e:	7e0000ef          	jal	b4e <exit>
        printf("grind: chdir failed\n");
     372:	00001517          	auipc	a0,0x1
     376:	efe50513          	addi	a0,a0,-258 # 1270 <malloc+0x242>
     37a:	401000ef          	jal	f7a <printf>
        exit(1);
     37e:	4505                	li	a0,1
     ...
     3a8:	e9c50513          	addi	a0,a0,-356 # 1240 <malloc+0x212>
     3ac:	3cf000ef          	jal	f7a <printf>
        exit(1);
     3b0:	4505                	li	a0,1
     ...
     3e8:	ea450513          	addi	a0,a0,-348 # 1288 <malloc+0x25a>
     3ec:	38f000ef          	jal	f7a <printf>
        exit(1);
     3f0:	4505                	li	a0,1
     ...
     404:	ea058593          	addi	a1,a1,-352 # 12a0 <malloc+0x272>
     ...
     434:	e7850513          	addi	a0,a0,-392 # 12a8 <malloc+0x27a>
     438:	343000ef          	jal	f7a <printf>
     43c:	bfe9                	j	416 <go+0x3a2>
          printf("grind: pipe read failed\n");
     43e:	00001517          	auipc	a0,0x1
     442:	e8a50513          	addi	a0,a0,-374 # 12c8 <malloc+0x29a>
     446:	335000ef          	jal	f7a <printf>
     44a:	b7c5                	j	42a <go+0x3b6>
        printf("grind: fork failed\n");
     44c:	00001517          	auipc	a0,0x1
     450:	df450513          	addi	a0,a0,-524 # 1240 <malloc+0x212>
     454:	327000ef          	jal	f7a <printf>
        exit(1);
     458:	4505                	li	a0,1
     ...
     4c6:	d7e50513          	addi	a0,a0,-642 # 1240 <malloc+0x212>
     4ca:	2b1000ef          	jal	f7a <printf>
        exit(1);
     4ce:	4505                	li	a0,1
     ...
     4d8:	e1c50513          	addi	a0,a0,-484 # 12f0 <malloc+0x2c2>
     ...
     4e8:	e0c50513          	addi	a0,a0,-500 # 12f0 <malloc+0x2c2>
     ...
     4fc:	da858593          	addi	a1,a1,-600 # 12a0 <malloc+0x272>
     ...
     536:	dbe50513          	addi	a0,a0,-578 # 12f0 <malloc+0x2c2>
     53a:	664000ef          	jal	b9e <unlink>
     53e:	b6f1                	j	10a <go+0x96>
        printf("grind: create c failed\n");
     540:	00001517          	auipc	a0,0x1
     544:	db850513          	addi	a0,a0,-584 # 12f8 <malloc+0x2ca>
     548:	233000ef          	jal	f7a <printf>
        exit(1);
     54c:	4505                	li	a0,1
     54e:	600000ef          	jal	b4e <exit>
        printf("grind: write c failed\n");
     552:	00001517          	auipc	a0,0x1
     556:	dbe50513          	addi	a0,a0,-578 # 1310 <malloc+0x2e2>
     55a:	221000ef          	jal	f7a <printf>
        exit(1);
     55e:	4505                	li	a0,1
     560:	5ee000ef          	jal	b4e <exit>
        printf("grind: fstat failed\n");
     564:	00001517          	auipc	a0,0x1
     568:	dc450513          	addi	a0,a0,-572 # 1328 <malloc+0x2fa>
     56c:	20f000ef          	jal	f7a <printf>
        exit(1);
     570:	4505                	li	a0,1
     ...
     57c:	dc850513          	addi	a0,a0,-568 # 1340 <malloc+0x312>
     580:	1fb000ef          	jal	f7a <printf>
        exit(1);
     584:	4505                	li	a0,1
     586:	5c8000ef          	jal	b4e <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     58a:	00001517          	auipc	a0,0x1
     58e:	dde50513          	addi	a0,a0,-546 # 1368 <malloc+0x33a>
     592:	1e9000ef          	jal	f7a <printf>
        exit(1);
     596:	4505                	li	a0,1
     ...
     63c:	dd058593          	addi	a1,a1,-560 # 1408 <malloc+0x3da>
     ...
     652:	c3a58593          	addi	a1,a1,-966 # 1288 <malloc+0x25a>
     656:	4509                	li	a0,2
     658:	0f9000ef          	jal	f50 <fprintf>
        exit(1);
     65c:	4505                	li	a0,1
     65e:	4f0000ef          	jal	b4e <exit>
        fprintf(2, "grind: pipe failed\n");
     662:	00001597          	auipc	a1,0x1
     666:	c2658593          	addi	a1,a1,-986 # 1288 <malloc+0x25a>
     66a:	4509                	li	a0,2
     66c:	0e5000ef          	jal	f50 <fprintf>
        exit(1);
     670:	4505                	li	a0,1
     ...
     6a6:	cee58593          	addi	a1,a1,-786 # 1390 <malloc+0x362>
     6aa:	4509                	li	a0,2
     6ac:	0a5000ef          	jal	f50 <fprintf>
          exit(1);
     6b0:	4505                	li	a0,1
     ...
     6c2:	cea78793          	addi	a5,a5,-790 # 13a8 <malloc+0x37a>
     6c6:	f8f43c23          	sd	a5,-104(s0)
     6ca:	00001797          	auipc	a5,0x1
     6ce:	ce678793          	addi	a5,a5,-794 # 13b0 <malloc+0x382>
     6d2:	faf43023          	sd	a5,-96(s0)
     6d6:	fa043423          	sd	zero,-88(s0)
        exec("grindir/../echo", args);
     6da:	f9840593          	addi	a1,s0,-104
     6de:	00001517          	auipc	a0,0x1
     6e2:	cda50513          	addi	a0,a0,-806 # 13b8 <malloc+0x38a>
     6e6:	4a0000ef          	jal	b86 <exec>
        fprintf(2, "grind: echo: not found\n");
     6ea:	00001597          	auipc	a1,0x1
     6ee:	cde58593          	addi	a1,a1,-802 # 13c8 <malloc+0x39a>
     6f2:	4509                	li	a0,2
     6f4:	05d000ef          	jal	f50 <fprintf>
        exit(2);
     6f8:	4509                	li	a0,2
     6fa:	454000ef          	jal	b4e <exit>
        fprintf(2, "grind: fork failed\n");
     6fe:	00001597          	auipc	a1,0x1
     702:	b4258593          	addi	a1,a1,-1214 # 1240 <malloc+0x212>
     706:	4509                	li	a0,2
     708:	049000ef          	jal	f50 <fprintf>
        exit(3);
     70c:	450d                	li	a0,3
     ...
     736:	c5e58593          	addi	a1,a1,-930 # 1390 <malloc+0x362>
     73a:	4509                	li	a0,2
     73c:	015000ef          	jal	f50 <fprintf>
          exit(4);
     740:	4511                	li	a0,4
     ...
     766:	c2e58593          	addi	a1,a1,-978 # 1390 <malloc+0x362>
     76a:	4509                	li	a0,2
     76c:	7e4000ef          	jal	f50 <fprintf>
          exit(5);
     770:	4515                	li	a0,5
     ...
     782:	c6278793          	addi	a5,a5,-926 # 13e0 <malloc+0x3b2>
     786:	f8f43c23          	sd	a5,-104(s0)
     78a:	fa043023          	sd	zero,-96(s0)
        exec("/cat", args);
     78e:	f9840593          	addi	a1,s0,-104
     792:	00001517          	auipc	a0,0x1
     796:	c5650513          	addi	a0,a0,-938 # 13e8 <malloc+0x3ba>
     79a:	3ec000ef          	jal	b86 <exec>
        fprintf(2, "grind: cat: not found\n");
     79e:	00001597          	auipc	a1,0x1
     7a2:	c5258593          	addi	a1,a1,-942 # 13f0 <malloc+0x3c2>
     7a6:	4509                	li	a0,2
     7a8:	7a8000ef          	jal	f50 <fprintf>
        exit(6);
     7ac:	4519                	li	a0,6
     7ae:	3a0000ef          	jal	b4e <exit>
        fprintf(2, "grind: fork failed\n");
     7b2:	00001597          	auipc	a1,0x1
     7b6:	a8e58593          	addi	a1,a1,-1394 # 1240 <malloc+0x212>
     7ba:	4509                	li	a0,2
     7bc:	794000ef          	jal	f50 <fprintf>
        exit(7);
     7c0:	451d                	li	a0,7
     ...
     7d4:	c4050513          	addi	a0,a0,-960 # 1410 <malloc+0x3e2>
     7d8:	7a2000ef          	jal	f7a <printf>
        exit(1);
     7dc:	4505                	li	a0,1
...
iter()
{
  ...
  unlink("a");
     ...
     7ee:	a6e50513          	addi	a0,a0,-1426 # 1258 <malloc+0x22a>
     7f2:	3ac000ef          	jal	b9e <unlink>
  unlink("b");
     7f6:	00001517          	auipc	a0,0x1
     7fa:	a1250513          	addi	a0,a0,-1518 # 1208 <malloc+0x1da>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     830:	a1450513          	addi	a0,a0,-1516 # 1240 <malloc+0x212>
     834:	746000ef          	jal	f7a <printf>
    exit(1);
     838:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     86a:	9da50513          	addi	a0,a0,-1574 # 1240 <malloc+0x212>
     86e:	70c000ef          	jal	f7a <printf>
    exit(1);
     872:	4505                	li	a0,1
...
putc(int fd, char c)
{
     ...
     c0a:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     c0e:	4605                	li	a2,1
     c10:	fef40593          	addi	a1,s0,-17
     c14:	f5bff0ef          	jal	b6e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     c2c:	c299                	beqz	a3,c32 <printint+0x12>
     c2e:	0805c963          	bltz	a1,cc0 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     c32:	2581                	sext.w	a1,a1
  neg = 0;
     c34:	4881                	li	a7,0
     c36:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     c3c:	2601                	sext.w	a2,a2
     c3e:	00001517          	auipc	a0,0x1
     c42:	86250513          	addi	a0,a0,-1950 # 14a0 <digits>
     c46:	883a                	mv	a6,a4
     c48:	2705                	addiw	a4,a4,1
     c4a:	02c5f7bb          	remuw	a5,a1,a2
     c4e:	1782                	slli	a5,a5,0x20
     c50:	9381                	srli	a5,a5,0x20
     c52:	97aa                	add	a5,a5,a0
     c54:	0007c783          	lbu	a5,0(a5)
     c58:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     c5c:	0005879b          	sext.w	a5,a1
     c60:	02c5d5bb          	divuw	a1,a1,a2
     c64:	0685                	addi	a3,a3,1
     c66:	fec7f0e3          	bgeu	a5,a2,c46 <printint+0x26>
  if(neg)
     c6a:	00088c63          	beqz	a7,c82 <printint+0x62>
    buf[i++] = '-';
     c6e:	fd070793          	addi	a5,a4,-48
     c72:	00878733          	add	a4,a5,s0
     c76:	02d00793          	li	a5,45
     c7a:	fef70823          	sb	a5,-16(a4)
     c7e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     c82:	02e05a63          	blez	a4,cb6 <printint+0x96>
     c86:	f04a                	sd	s2,32(sp)
     c88:	ec4e                	sd	s3,24(sp)
     c8a:	fc040793          	addi	a5,s0,-64
     c8e:	00e78933          	add	s2,a5,a4
     c92:	fff78993          	addi	s3,a5,-1
     c96:	99ba                	add	s3,s3,a4
     c98:	377d                	addiw	a4,a4,-1
     c9a:	1702                	slli	a4,a4,0x20
     c9c:	9301                	srli	a4,a4,0x20
     c9e:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     ca2:	fff94583          	lbu	a1,-1(s2)
     ca6:	8526                	mv	a0,s1
     ca8:	f5bff0ef          	jal	c02 <putc>
  while(--i >= 0)
     cac:	197d                	addi	s2,s2,-1
     cae:	ff391ae3          	bne	s2,s3,ca2 <printint+0x82>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     cd6:	26090863          	beqz	s2,f46 <vprintf+0x27e>
     cda:	e4a6                	sd	s1,72(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     cf6:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
     cfa:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
     cfe:	06c00c93          	li	s9,108
     d02:	a005                	j	d22 <vprintf+0x5a>
        putc(fd, c0);
     d04:	85ca                	mv	a1,s2
     d06:	855a                	mv	a0,s6
     d08:	efbff0ef          	jal	c02 <putc>
     d0c:	a019                	j	d12 <vprintf+0x4a>
    } else if(state == '%'){
     d0e:	03598263          	beq	s3,s5,d32 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     d12:	2485                	addiw	s1,s1,1
     d14:	8726                	mv	a4,s1
     d16:	009a07b3          	add	a5,s4,s1
     d1a:	0007c903          	lbu	s2,0(a5)
     d1e:	20090c63          	beqz	s2,f36 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
     d22:	0009079b          	sext.w	a5,s2
    if(state == 0){
     d26:	fe0994e3          	bnez	s3,d0e <vprintf+0x46>
      if(c0 == '%'){
     d2a:	fd579de3          	bne	a5,s5,d04 <vprintf+0x3c>
        state = '%';
     d2e:	89be                	mv	s3,a5
     d30:	b7cd                	j	d12 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     d32:	00ea06b3          	add	a3,s4,a4
     d36:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     d3a:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     d3c:	c681                	beqz	a3,d44 <vprintf+0x7c>
     d3e:	9752                	add	a4,a4,s4
     d40:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     d44:	03878f63          	beq	a5,s8,d82 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
     d48:	05978963          	beq	a5,s9,d9a <vprintf+0xd2>
     ...
     d4c:	07500713          	li	a4,117
     d50:	0ee78363          	beq	a5,a4,e36 <vprintf+0x16e>
     ...
     d58:	12e78563          	beq	a5,a4,e82 <vprintf+0x1ba>
     ...
     d60:	14e78a63          	beq	a5,a4,eb4 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     d64:	07300713          	li	a4,115
     d68:	18e78a63          	beq	a5,a4,efc <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     d6c:	02500713          	li	a4,37
     d70:	04e79563          	bne	a5,a4,dba <vprintf+0xf2>
        putc(fd, '%');
     d74:	02500593          	li	a1,37
     d78:	855a                	mv	a0,s6
     d7a:	e89ff0ef          	jal	c02 <putc>
      ...
      state = 0;
     d7e:	4981                	li	s3,0
     d80:	bf49                	j	d12 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
     d82:	008b8913          	addi	s2,s7,8
     d86:	4685                	li	a3,1
     d88:	4629                	li	a2,10
     d8a:	000ba583          	lw	a1,0(s7)
     d8e:	855a                	mv	a0,s6
     d90:	e91ff0ef          	jal	c20 <printint>
     d94:	8bca                	mv	s7,s2
      state = 0;
     d96:	4981                	li	s3,0
     d98:	bfad                	j	d12 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     d9a:	06400793          	li	a5,100
     d9e:	02f68963          	beq	a3,a5,dd0 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     da2:	06c00793          	li	a5,108
     da6:	04f68263          	beq	a3,a5,dea <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
     daa:	07500793          	li	a5,117
     dae:	0af68063          	beq	a3,a5,e4e <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
     db2:	07800793          	li	a5,120
     db6:	0ef68263          	beq	a3,a5,e9a <vprintf+0x1d2>
        putc(fd, '%');
     dba:	02500593          	li	a1,37
     dbe:	855a                	mv	a0,s6
     dc0:	e43ff0ef          	jal	c02 <putc>
        putc(fd, c0);
     dc4:	85ca                	mv	a1,s2
     dc6:	855a                	mv	a0,s6
     dc8:	e3bff0ef          	jal	c02 <putc>
      state = 0;
     dcc:	4981                	li	s3,0
     dce:	b791                	j	d12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     de6:	4981                	li	s3,0
        i += 1;
     de8:	b72d                	j	d12 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     dea:	06400793          	li	a5,100
     dee:	02f60763          	beq	a2,a5,e1c <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     df2:	07500793          	li	a5,117
     df6:	06f60963          	beq	a2,a5,e68 <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     dfa:	07800793          	li	a5,120
     dfe:	faf61ee3          	bne	a2,a5,dba <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     e42:	855a                	mv	a0,s6
     e44:	dddff0ef          	jal	c20 <printint>
     e48:	8bca                	mv	s7,s2
      state = 0;
     e4a:	4981                	li	s3,0
     e4c:	b5d9                	j	d12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     e8e:	855a                	mv	a0,s6
     e90:	d91ff0ef          	jal	c20 <printint>
     e94:	8bca                	mv	s7,s2
      state = 0;
     e96:	4981                	li	s3,0
     e98:	bdad                	j	d12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     eb0:	4981                	li	s3,0
        i += 1;
     eb2:	b585                	j	d12 <vprintf+0x4a>
     eb4:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
     eb6:	008b8d13          	addi	s10,s7,8
     eba:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     ebe:	03000593          	li	a1,48
     ec2:	855a                	mv	a0,s6
     ec4:	d3fff0ef          	jal	c02 <putc>
  putc(fd, 'x');
     ec8:	07800593          	li	a1,120
     ecc:	855a                	mv	a0,s6
     ece:	d35ff0ef          	jal	c02 <putc>
     ed2:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ed4:	00000b97          	auipc	s7,0x0
     ed8:	5ccb8b93          	addi	s7,s7,1484 # 14a0 <digits>
     edc:	03c9d793          	srli	a5,s3,0x3c
     ee0:	97de                	add	a5,a5,s7
     ee2:	0007c583          	lbu	a1,0(a5)
     ee6:	855a                	mv	a0,s6
     ee8:	d1bff0ef          	jal	c02 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     eec:	0992                	slli	s3,s3,0x4
     eee:	397d                	addiw	s2,s2,-1
     ef0:	fe0916e3          	bnez	s2,edc <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
     ef4:	8bea                	mv	s7,s10
      state = 0;
     ef6:	4981                	li	s3,0
     ef8:	6d02                	ld	s10,0(sp)
     efa:	bd21                	j	d12 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     efc:	008b8993          	addi	s3,s7,8
     f00:	000bb903          	ld	s2,0(s7)
     f04:	00090f63          	beqz	s2,f22 <vprintf+0x25a>
        for(; *s; s++)
     f08:	00094583          	lbu	a1,0(s2)
     f0c:	c195                	beqz	a1,f30 <vprintf+0x268>
          putc(fd, *s);
     f0e:	855a                	mv	a0,s6
     f10:	cf3ff0ef          	jal	c02 <putc>
        for(; *s; s++)
     f14:	0905                	addi	s2,s2,1
     f16:	00094583          	lbu	a1,0(s2)
     f1a:	f9f5                	bnez	a1,f0e <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     f1c:	8bce                	mv	s7,s3
      state = 0;
     f1e:	4981                	li	s3,0
     f20:	bbcd                	j	d12 <vprintf+0x4a>
          s = "(null)";
     f22:	00000917          	auipc	s2,0x0
     f26:	51690913          	addi	s2,s2,1302 # 1438 <malloc+0x40a>
        for(; *s; s++)
     f2a:	02800593          	li	a1,40
     f2e:	b7c5                	j	f0e <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     f30:	8bce                	mv	s7,s3
      state = 0;
     f32:	4981                	li	s3,0
     f34:	bbf9                	j	d12 <vprintf+0x4a>
     f36:	64a6                	ld	s1,72(sp)
     f38:	79e2                	ld	s3,56(sp)
     f3a:	7a42                	ld	s4,48(sp)
     f3c:	7aa2                	ld	s5,40(sp)
     f3e:	7b02                	ld	s6,32(sp)
     f40:	6be2                	ld	s7,24(sp)
     f42:	6c42                	ld	s8,16(sp)
     f44:	6ca2                	ld	s9,8(sp)
    }
  }
}
     ...
     f4a:	6906                	ld	s2,64(sp)
     f4c:	6125                	addi	sp,sp,96
     f4e:	8082                	ret

0000000000000f50 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
     f50:	715d                	addi	sp,sp,-80
     f52:	ec06                	sd	ra,24(sp)
     f54:	e822                	sd	s0,16(sp)
     f56:	1000                	addi	s0,sp,32
     f58:	e010                	sd	a2,0(s0)
     f5a:	e414                	sd	a3,8(s0)
     f5c:	e818                	sd	a4,16(s0)
     f5e:	ec1c                	sd	a5,24(s0)
     f60:	03043023          	sd	a6,32(s0)
     f64:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
     f68:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
     f6c:	8622                	mv	a2,s0
     f6e:	d5bff0ef          	jal	cc8 <vprintf>
}
     f72:	60e2                	ld	ra,24(sp)
     f74:	6442                	ld	s0,16(sp)
     f76:	6161                	addi	sp,sp,80
     f78:	8082                	ret

0000000000000f7a <printf>:

void
printf(const char *fmt, ...)
{
     f7a:	711d                	addi	sp,sp,-96
     f7c:	ec06                	sd	ra,24(sp)
     f7e:	e822                	sd	s0,16(sp)
     f80:	1000                	addi	s0,sp,32
     f82:	e40c                	sd	a1,8(s0)
     f84:	e810                	sd	a2,16(s0)
     f86:	ec14                	sd	a3,24(s0)
     f88:	f018                	sd	a4,32(s0)
     f8a:	f41c                	sd	a5,40(s0)
     f8c:	03043823          	sd	a6,48(s0)
     f90:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
     f94:	00840613          	addi	a2,s0,8
     f98:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
     f9c:	85aa                	mv	a1,a0
     f9e:	4505                	li	a0,1
     fa0:	d29ff0ef          	jal	cc8 <vprintf>
}
     fa4:	60e2                	ld	ra,24(sp)
     fa6:	6442                	ld	s0,16(sp)
...
free(void *ap)
{
     fac:	1141                	addi	sp,sp,-16
     fae:	e422                	sd	s0,8(sp)
     fb0:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
     fb2:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     fb6:	00001797          	auipc	a5,0x1
     fba:	05a7b783          	ld	a5,90(a5) # 2010 <freep>
     fbe:	a02d                	j	fe8 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
     fc0:	4618                	lw	a4,8(a2)
     fc2:	9f2d                	addw	a4,a4,a1
     fc4:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
     fc8:	6398                	ld	a4,0(a5)
     fca:	6310                	ld	a2,0(a4)
     fcc:	a83d                	j	100a <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
     fce:	ff852703          	lw	a4,-8(a0)
     fd2:	9f31                	addw	a4,a4,a2
     fd4:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
     fd6:	ff053683          	ld	a3,-16(a0)
     fda:	a091                	j	101e <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     fdc:	6398                	ld	a4,0(a5)
     fde:	00e7e463          	bltu	a5,a4,fe6 <free+0x3a>
     fe2:	00e6ea63          	bltu	a3,a4,ff6 <free+0x4a>
{
     fe6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     fe8:	fed7fae3          	bgeu	a5,a3,fdc <free+0x30>
     fec:	6398                	ld	a4,0(a5)
     fee:	00e6e463          	bltu	a3,a4,ff6 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
     ff2:	fee7eae3          	bltu	a5,a4,fe6 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    ...
    1006:	fae60de3          	beq	a2,a4,fc0 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    101a:	fae68ae3          	beq	a3,a4,fce <free+0x22>
    p->s.ptr = bp->s.ptr;
  ...
  freep = p;
    ...
    1024:	fef73823          	sd	a5,-16(a4) # 2010 <freep>
}
    1028:	6422                	ld	s0,8(sp)
    102a:	0141                	addi	sp,sp,16
    102c:	8082                	ret

000000000000102e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    102e:	7139                	addi	sp,sp,-64
    1030:	fc06                	sd	ra,56(sp)
    1032:	f822                	sd	s0,48(sp)
    1034:	f426                	sd	s1,40(sp)
    1036:	ec4e                	sd	s3,24(sp)
    1038:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    103a:	02051493          	slli	s1,a0,0x20
    103e:	9081                	srli	s1,s1,0x20
    1040:	04bd                	addi	s1,s1,15
    1042:	8091                	srli	s1,s1,0x4
    1044:	0014899b          	addiw	s3,s1,1
    1048:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    104a:	00001517          	auipc	a0,0x1
    104e:	fc653503          	ld	a0,-58(a0) # 2010 <freep>
    1052:	c915                	beqz	a0,1086 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1058:	08977a63          	bgeu	a4,s1,10ec <malloc+0xbe>
    105c:	f04a                	sd	s2,32(sp)
    105e:	e852                	sd	s4,16(sp)
    1060:	e456                	sd	s5,8(sp)
    1062:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    1064:	8a4e                	mv	s4,s3
    1066:	0009871b          	sext.w	a4,s3
    106a:	6685                	lui	a3,0x1
    106c:	00d77363          	bgeu	a4,a3,1072 <malloc+0x44>
    1070:	6a05                	lui	s4,0x1
    1072:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1076:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    107a:	00001917          	auipc	s2,0x1
    107e:	f9690913          	addi	s2,s2,-106 # 2010 <freep>
  if(p == (char*)-1)
    1082:	5afd                	li	s5,-1
    1084:	a081                	j	10c4 <malloc+0x96>
    1086:	f04a                	sd	s2,32(sp)
    1088:	e852                	sd	s4,16(sp)
    108a:	e456                	sd	s5,8(sp)
    108c:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    108e:	00001797          	auipc	a5,0x1
    1092:	37a78793          	addi	a5,a5,890 # 2408 <base>
    1096:	00001717          	auipc	a4,0x1
    109a:	f6f73d23          	sd	a5,-134(a4) # 2010 <freep>
    109e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    10a0:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    10a4:	b7c1                	j	1064 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    10a6:	6398                	ld	a4,0(a5)
    10a8:	e118                	sd	a4,0(a0)
    10aa:	a8a9                	j	1104 <malloc+0xd6>
  hp->s.size = nu;
    10ac:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    10b0:	0541                	addi	a0,a0,16
    10b2:	efbff0ef          	jal	fac <free>
  return freep;
    10b6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    10ba:	c12d                	beqz	a0,111c <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10bc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    10be:	4798                	lw	a4,8(a5)
    10c0:	02977263          	bgeu	a4,s1,10e4 <malloc+0xb6>
    if(p == freep)
    10c4:	00093703          	ld	a4,0(s2)
    10c8:	853e                	mv	a0,a5
    10ca:	fef719e3          	bne	a4,a5,10bc <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    10ce:	8552                	mv	a0,s4
    10d0:	b07ff0ef          	jal	bd6 <sbrk>
  if(p == (char*)-1)
    10d4:	fd551ce3          	bne	a0,s5,10ac <malloc+0x7e>
        return 0;
    10d8:	4501                	li	a0,0
    10da:	7902                	ld	s2,32(sp)
    10dc:	6a42                	ld	s4,16(sp)
    10de:	6aa2                	ld	s5,8(sp)
    10e0:	6b02                	ld	s6,0(sp)
    10e2:	a03d                	j	1110 <malloc+0xe2>
    10e4:	7902                	ld	s2,32(sp)
    10e6:	6a42                	ld	s4,16(sp)
    10e8:	6aa2                	ld	s5,8(sp)
    10ea:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    10ec:	fae48de3          	beq	s1,a4,10a6 <malloc+0x78>
        p->s.size -= nunits;
    10f0:	4137073b          	subw	a4,a4,s3
    10f4:	c798                	sw	a4,8(a5)
        p += p->s.size;
    10f6:	02071693          	slli	a3,a4,0x20
    10fa:	01c6d713          	srli	a4,a3,0x1c
    10fe:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1100:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1104:	00001717          	auipc	a4,0x1
    1108:	f0a73623          	sd	a0,-244(a4) # 2010 <freep>
      return (void*)(p + 1);
    110c:	01078513          	addi	a0,a5,16
  }
}
    1110:	70e2                	ld	ra,56(sp)
    1112:	7442                	ld	s0,48(sp)
    1114:	74a2                	ld	s1,40(sp)
    1116:	69e2                	ld	s3,24(sp)
    1118:	6121                	addi	sp,sp,64
    111a:	8082                	ret
    111c:	7902                	ld	s2,32(sp)
    111e:	6a42                	ld	s4,16(sp)
    1120:	6aa2                	ld	s5,8(sp)
    1122:	6b02                	ld	s6,0(sp)
    1124:	b7f5                	j	1110 <malloc+0xe2>
