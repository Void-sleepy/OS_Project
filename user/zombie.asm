...
stat(const char *n, struct stat *st)
{
 ...
 170:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 172:	85ca                	mv	a1,s2
 174:	164000ef          	jal	2d8 <fstat>
 178:	892a                	mv	s2,a0
  close(fd);
 17a:	8526                	mv	a0,s1
 17c:	1a4000ef          	jal	320 <close>
  return r;
 180:	64a2                	ld	s1,8(sp)
}
 182:	854a                	mv	a0,s2
