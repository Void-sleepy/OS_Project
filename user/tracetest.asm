...
main(int argc, char *argv[])
{
  ...
  printf("Showing system call statistics:\n");
   ...
   c:	87850513          	addi	a0,a0,-1928 # 880 <malloc+0x104>
  10:	6b8000ef          	jal	6c8 <printf>
  
  // Make a few system calls to increment counters
  getpid();
  14:	308000ef          	jal	31c <getpid>
  sleep(1);
  18:	4505                	li	a0,1
  1a:	312000ef          	jal	32c <sleep>
  fork();
  1e:	276000ef          	jal	294 <fork>
  wait(0);
  22:	4501                	li	a0,0
  24:	280000ef          	jal	2a4 <wait>
  
  // Print the statistics
  stats();
  28:	31e000ef          	jal	346 <stats>
...
trace:
 li a7, SYS_trace
 33c:	03300893          	li	a7,51
 ecall
 340:	00000073          	ecall
 ret
 344:	8082                	ret

0000000000000346 <stats>:

.global stats
stats:
 li a7, SYS_stats
 346:	03400893          	li	a7,52
 ecall
 34a:	00000073          	ecall
 ret
 34e:	8082                	ret
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 626:	28eb8b93          	addi	s7,s7,654 # 8b0 <digits>
 ...
 674:	23890913          	addi	s2,s2,568 # 8a8 <malloc+0x12c>
        for(; *s; s++)
