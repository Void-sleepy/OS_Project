...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	3fa78793          	addi	a5,a5,1018 # 7408 <malloc+0x2494>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	00a50513          	addi	a0,a0,10 # 5070 <malloc+0xfc>
      6e:	653040ef          	jal	4ec0 <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	ff050513          	addi	a0,a0,-16 # 5090 <malloc+0x11c>
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	fe850513          	addi	a0,a0,-24 # 50a8 <malloc+0x134>
      c8:	1f1040ef          	jal	4ab8 <open>
  if(fd < 0){
      cc:	02054263          	bltz	a0,f0 <opentest+0x3e>
  close(fd);
      d0:	249040ef          	jal	4b18 <close>
  fd = open("doesnotexist", 0);
      d4:	4581                	li	a1,0
      d6:	00005517          	auipc	a0,0x5
      da:	ff250513          	addi	a0,a0,-14 # 50c8 <malloc+0x154>
      de:	1db040ef          	jal	4ab8 <open>
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	fbe50513          	addi	a0,a0,-66 # 50b0 <malloc+0x13c>
      fa:	5c7040ef          	jal	4ec0 <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	fd250513          	addi	a0,a0,-46 # 50d8 <malloc+0x164>
     10e:	5b3040ef          	jal	4ec0 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     12c:	fd850513          	addi	a0,a0,-40 # 5100 <malloc+0x18c>
     130:	199040ef          	jal	4ac8 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     134:	60100593          	li	a1,1537
     138:	00005517          	auipc	a0,0x5
     13c:	fc850513          	addi	a0,a0,-56 # 5100 <malloc+0x18c>
     140:	179040ef          	jal	4ab8 <open>
     144:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     146:	4611                	li	a2,4
     148:	00005597          	auipc	a1,0x5
     14c:	fc858593          	addi	a1,a1,-56 # 5110 <malloc+0x19c>
     150:	151040ef          	jal	4aa0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     154:	40100593          	li	a1,1025
     158:	00005517          	auipc	a0,0x5
     15c:	fa850513          	addi	a0,a0,-88 # 5100 <malloc+0x18c>
     160:	159040ef          	jal	4ab8 <open>
     164:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     166:	4605                	li	a2,1
     168:	00005597          	auipc	a1,0x5
     16c:	fb058593          	addi	a1,a1,-80 # 5118 <malloc+0x1a4>
     170:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     180:	f8450513          	addi	a0,a0,-124 # 5100 <malloc+0x18c>
     184:	145040ef          	jal	4ac8 <unlink>
  close(fd1);
     188:	8526                	mv	a0,s1
     18a:	18f040ef          	jal	4b18 <close>
  close(fd2);
     18e:	854a                	mv	a0,s2
     190:	189040ef          	jal	4b18 <close>
}
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	f7a50513          	addi	a0,a0,-134 # 5120 <malloc+0x1ac>
     1ae:	513040ef          	jal	4ec0 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
00000000000001b8 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     1e4:	0d5040ef          	jal	4ab8 <open>
    close(fd);
     1e8:	131040ef          	jal	4b18 <close>
  for(i = 0; i < N; i++){
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	f0450513          	addi	a0,a0,-252 # 5148 <malloc+0x1d4>
     24c:	07d040ef          	jal	4ac8 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	ef4a8a93          	addi	s5,s5,-268 # 5148 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    close(fd);
     296:	854a                	mv	a0,s2
     298:	081040ef          	jal	4b18 <close>
    unlink("bigwrite");
     29c:	8556                	mv	a0,s5
     29e:	02b040ef          	jal	4ac8 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	e9650513          	addi	a0,a0,-362 # 5158 <malloc+0x1e4>
     2ca:	3f7040ef          	jal	4ec0 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	e9c50513          	addi	a0,a0,-356 # 5178 <malloc+0x204>
     2e4:	3dd040ef          	jal	4ec0 <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	e9250513          	addi	a0,a0,-366 # 5190 <malloc+0x21c>
     306:	7c2040ef          	jal	4ac8 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	e8298993          	addi	s3,s3,-382 # 5190 <malloc+0x21c>
    if(fd < 0){
    ...
    close(fd);
     334:	8526                	mv	a0,s1
     336:	7e2040ef          	jal	4b18 <close>
    unlink("junk");
     33a:	854e                	mv	a0,s3
     33c:	78c040ef          	jal	4ac8 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	e4650513          	addi	a0,a0,-442 # 5190 <malloc+0x21c>
     352:	766040ef          	jal	4ab8 <open>
     356:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	dba58593          	addi	a1,a1,-582 # 5118 <malloc+0x1a4>
     366:	73a040ef          	jal	4aa0 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	e4050513          	addi	a0,a0,-448 # 51b0 <malloc+0x23c>
     378:	349040ef          	jal	4ec0 <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	702040ef          	jal	4a80 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	e1650513          	addi	a0,a0,-490 # 5198 <malloc+0x224>
     38a:	337040ef          	jal	4ec0 <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	6f0040ef          	jal	4a80 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	e0450513          	addi	a0,a0,-508 # 5198 <malloc+0x224>
     39c:	325040ef          	jal	4ec0 <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  close(fd);
     3a6:	8526                	mv	a0,s1
     3a8:	770040ef          	jal	4b18 <close>
  unlink("junk");
     3ac:	00005517          	auipc	a0,0x5
     3b0:	de450513          	addi	a0,a0,-540 # 5190 <malloc+0x21c>
     3b4:	714040ef          	jal	4ac8 <unlink>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	f7878793          	addi	a5,a5,-136 # 7408 <malloc+0x2494>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	d02a0a13          	addi	s4,s4,-766 # 51c0 <malloc+0x24c>
    uint64 addr = addrs[ai];
     4c6:	00093983          	ld	s3,0(s2)
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     4ca:	20100593          	li	a1,513
     4ce:	8552                	mv	a0,s4
     4d0:	5e8040ef          	jal	4ab8 <open>
     4d4:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    close(fd);
     4e6:	8526                	mv	a0,s1
     4e8:	630040ef          	jal	4b18 <close>
    unlink("copyin1");
     4ec:	8552                	mv	a0,s4
     4ee:	5da040ef          	jal	4ac8 <unlink>
    ...
    close(fds[0]);
     ...
     520:	5f8040ef          	jal	4b18 <close>
    close(fds[1]);
     524:	f9442503          	lw	a0,-108(s0)
     528:	5f0040ef          	jal	4b18 <close>
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	c8450513          	addi	a0,a0,-892 # 51c8 <malloc+0x254>
     54c:	175040ef          	jal	4ec0 <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	c8650513          	addi	a0,a0,-890 # 51e0 <malloc+0x26c>
     562:	15f040ef          	jal	4ec0 <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	ca050513          	addi	a0,a0,-864 # 5210 <malloc+0x29c>
     578:	149040ef          	jal	4ec0 <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	502040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	cbe50513          	addi	a0,a0,-834 # 5240 <malloc+0x2cc>
     58a:	137040ef          	jal	4ec0 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	cb850513          	addi	a0,a0,-840 # 5250 <malloc+0x2dc>
     5a0:	121040ef          	jal	4ec0 <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	e4a78793          	addi	a5,a5,-438 # 7408 <malloc+0x2494>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	c8ea0a13          	addi	s4,s4,-882 # 5280 <malloc+0x30c>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	b1ea8a93          	addi	s5,s5,-1250 # 5118 <malloc+0x1a4>
    uint64 addr = addrs[ai];
     602:	00093983          	ld	s3,0(s2)
    int fd = open("README", 0);
     606:	4581                	li	a1,0
     608:	8552                	mv	a0,s4
     60a:	4ae040ef          	jal	4ab8 <open>
     60e:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    close(fds[0]);
     ...
     658:	4c0040ef          	jal	4b18 <close>
    close(fds[1]);
     65c:	f8c42503          	lw	a0,-116(s0)
     660:	4b8040ef          	jal	4b18 <close>
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	c0a50513          	addi	a0,a0,-1014 # 5288 <malloc+0x314>
     686:	03b040ef          	jal	4ec0 <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	c0c50513          	addi	a0,a0,-1012 # 52a0 <malloc+0x32c>
     69c:	025040ef          	jal	4ec0 <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	3de040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	b9a50513          	addi	a0,a0,-1126 # 5240 <malloc+0x2cc>
     6ae:	013040ef          	jal	4ec0 <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	3cc040ef          	jal	4a80 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	c1850513          	addi	a0,a0,-1000 # 52d0 <malloc+0x35c>
     6c0:	001040ef          	jal	4ec0 <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	c1a50513          	addi	a0,a0,-998 # 52e8 <malloc+0x374>
     6d6:	7ea040ef          	jal	4ec0 <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	a0c50513          	addi	a0,a0,-1524 # 5100 <malloc+0x18c>
     6fc:	3cc040ef          	jal	4ac8 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	9fc50513          	addi	a0,a0,-1540 # 5100 <malloc+0x18c>
     70c:	3ac040ef          	jal	4ab8 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	9fc58593          	addi	a1,a1,-1540 # 5110 <malloc+0x19c>
     71c:	384040ef          	jal	4aa0 <write>
  close(fd1);
     720:	8526                	mv	a0,s1
     722:	3f6040ef          	jal	4b18 <close>
  int fd2 = open("truncfile", O_RDONLY);
     726:	4581                	li	a1,0
     728:	00005517          	auipc	a0,0x5
     72c:	9d850513          	addi	a0,a0,-1576 # 5100 <malloc+0x18c>
     730:	388040ef          	jal	4ab8 <open>
     734:	84aa                	mv	s1,a0
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	9b450513          	addi	a0,a0,-1612 # 5100 <malloc+0x18c>
     754:	364040ef          	jal	4ab8 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	9a450513          	addi	a0,a0,-1628 # 5100 <malloc+0x18c>
     764:	354040ef          	jal	4ab8 <open>
     768:	892a                	mv	s2,a0
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	bea58593          	addi	a1,a1,-1046 # 5378 <malloc+0x404>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	93c50513          	addi	a0,a0,-1732 # 5100 <malloc+0x18c>
     7cc:	2fc040ef          	jal	4ac8 <unlink>
  close(fd1);
     7d0:	854e                	mv	a0,s3
     7d2:	346040ef          	jal	4b18 <close>
  close(fd2);
     7d6:	8526                	mv	a0,s1
     7d8:	340040ef          	jal	4b18 <close>
  close(fd3);
     7dc:	854a                	mv	a0,s2
     7de:	33a040ef          	jal	4b18 <close>
}
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	b2050513          	addi	a0,a0,-1248 # 5318 <malloc+0x3a4>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	b2c50513          	addi	a0,a0,-1236 # 5338 <malloc+0x3c4>
     814:	6ac040ef          	jal	4ec0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	b2c50513          	addi	a0,a0,-1236 # 5348 <malloc+0x3d4>
     824:	69c040ef          	jal	4ec0 <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	b3850513          	addi	a0,a0,-1224 # 5368 <malloc+0x3f4>
     838:	688040ef          	jal	4ec0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	b0850513          	addi	a0,a0,-1272 # 5348 <malloc+0x3d4>
     848:	678040ef          	jal	4ec0 <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	b2a50513          	addi	a0,a0,-1238 # 5380 <malloc+0x40c>
     85e:	662040ef          	jal	4ec0 <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	b3450513          	addi	a0,a0,-1228 # 53a0 <malloc+0x42c>
     874:	64c040ef          	jal	4ec0 <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	b2850513          	addi	a0,a0,-1240 # 53c0 <malloc+0x44c>
     8a0:	218040ef          	jal	4ab8 <open>
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	b3c98993          	addi	s3,s3,-1220 # 53e8 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	b6ca8a93          	addi	s5,s5,-1172 # 5420 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  close(fd);
     8e6:	854a                	mv	a0,s2
     8e8:	230040ef          	jal	4b18 <close>
  fd = open("small", O_RDONLY);
     8ec:	4581                	li	a1,0
     8ee:	00005517          	auipc	a0,0x5
     8f2:	ad250513          	addi	a0,a0,-1326 # 53c0 <malloc+0x44c>
     8f6:	1c2040ef          	jal	4ab8 <open>
     8fa:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  close(fd);
     918:	8526                	mv	a0,s1
     91a:	1fe040ef          	jal	4b18 <close>
  if(unlink("small") < 0){
     91e:	00005517          	auipc	a0,0x5
     922:	aa250513          	addi	a0,a0,-1374 # 53c0 <malloc+0x44c>
     926:	1a2040ef          	jal	4ac8 <unlink>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	a8450513          	addi	a0,a0,-1404 # 53c8 <malloc+0x454>
     94c:	574040ef          	jal	4ec0 <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	a9e50513          	addi	a0,a0,-1378 # 53f8 <malloc+0x484>
     962:	55e040ef          	jal	4ec0 <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	ac050513          	addi	a0,a0,-1344 # 5430 <malloc+0x4bc>
     978:	548040ef          	jal	4ec0 <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	ad450513          	addi	a0,a0,-1324 # 5458 <malloc+0x4e4>
     98c:	534040ef          	jal	4ec0 <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	ae050513          	addi	a0,a0,-1312 # 5478 <malloc+0x504>
     9a0:	520040ef          	jal	4ec0 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	ae450513          	addi	a0,a0,-1308 # 5490 <malloc+0x51c>
     9b4:	50c040ef          	jal	4ec0 <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	ada50513          	addi	a0,a0,-1318 # 54b0 <malloc+0x53c>
     9de:	0da040ef          	jal	4ab8 <open>
     9e2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9e4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  close(fd);
     a14:	854e                	mv	a0,s3
     a16:	102040ef          	jal	4b18 <close>
  fd = open("big", O_RDONLY);
     a1a:	4581                	li	a1,0
     a1c:	00005517          	auipc	a0,0x5
     a20:	a9450513          	addi	a0,a0,-1388 # 54b0 <malloc+0x53c>
     a24:	094040ef          	jal	4ab8 <open>
     a28:	89aa                	mv	s3,a0
  n = 0;
     a2a:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a5c50513          	addi	a0,a0,-1444 # 54b8 <malloc+0x544>
     a64:	45c040ef          	jal	4ec0 <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	a6650513          	addi	a0,a0,-1434 # 54d8 <malloc+0x564>
     a7a:	446040ef          	jal	4ec0 <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	a7a50513          	addi	a0,a0,-1414 # 5500 <malloc+0x58c>
     a8e:	432040ef          	jal	4ec0 <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  close(fd);
     aa0:	854e                	mv	a0,s3
     aa2:	076040ef          	jal	4b18 <close>
  if(unlink("big") < 0){
     aa6:	00005517          	auipc	a0,0x5
     aaa:	a0a50513          	addi	a0,a0,-1526 # 54b0 <malloc+0x53c>
     aae:	01a040ef          	jal	4ac8 <unlink>
     ...
     ad0:	a5450513          	addi	a0,a0,-1452 # 5520 <malloc+0x5ac>
     ad4:	3ec040ef          	jal	4ec0 <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	a6650513          	addi	a0,a0,-1434 # 5548 <malloc+0x5d4>
     aea:	3d6040ef          	jal	4ec0 <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	a6850513          	addi	a0,a0,-1432 # 5560 <malloc+0x5ec>
     b00:	3c0040ef          	jal	4ec0 <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	a7c50513          	addi	a0,a0,-1412 # 5588 <malloc+0x614>
     b14:	3ac040ef          	jal	4ec0 <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	a6e50513          	addi	a0,a0,-1426 # 55a0 <malloc+0x62c>
     b3a:	77f030ef          	jal	4ab8 <open>
  if(fd < 0){
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	a8a58593          	addi	a1,a1,-1398 # 55d0 <malloc+0x65c>
     b4e:	753030ef          	jal	4aa0 <write>
  close(fd);
     b52:	8526                	mv	a0,s1
     b54:	7c5030ef          	jal	4b18 <close>
  fd = open("unlinkread", O_RDWR);
     b58:	4589                	li	a1,2
     b5a:	00005517          	auipc	a0,0x5
     b5e:	a4650513          	addi	a0,a0,-1466 # 55a0 <malloc+0x62c>
     b62:	757030ef          	jal	4ab8 <open>
     b66:	84aa                	mv	s1,a0
  if(fd < 0){
     b68:	0a054463          	bltz	a0,c10 <unlinkread+0xf2>
  if(unlink("unlinkread") != 0){
     b6c:	00005517          	auipc	a0,0x5
     b70:	a3450513          	addi	a0,a0,-1484 # 55a0 <malloc+0x62c>
     b74:	755030ef          	jal	4ac8 <unlink>
     b78:	e555                	bnez	a0,c24 <unlinkread+0x106>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     b7a:	20200593          	li	a1,514
     b7e:	00005517          	auipc	a0,0x5
     b82:	a2250513          	addi	a0,a0,-1502 # 55a0 <malloc+0x62c>
     b86:	733030ef          	jal	4ab8 <open>
     b8a:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b8c:	460d                	li	a2,3
     b8e:	00005597          	auipc	a1,0x5
     b92:	a8a58593          	addi	a1,a1,-1398 # 5618 <malloc+0x6a4>
     b96:	70b030ef          	jal	4aa0 <write>
  close(fd1);
     b9a:	854a                	mv	a0,s2
     b9c:	77d030ef          	jal	4b18 <close>
  ...
  close(fd);
     bdc:	8526                	mv	a0,s1
     bde:	73b030ef          	jal	4b18 <close>
  unlink("unlinkread");
     be2:	00005517          	auipc	a0,0x5
     be6:	9be50513          	addi	a0,a0,-1602 # 55a0 <malloc+0x62c>
     bea:	6df030ef          	jal	4ac8 <unlink>
}
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	9b250513          	addi	a0,a0,-1614 # 55b0 <malloc+0x63c>
     c06:	2ba040ef          	jal	4ec0 <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	9c650513          	addi	a0,a0,-1594 # 55d8 <malloc+0x664>
     c1a:	2a6040ef          	jal	4ec0 <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	9d250513          	addi	a0,a0,-1582 # 55f8 <malloc+0x684>
     c2e:	292040ef          	jal	4ec0 <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	9e650513          	addi	a0,a0,-1562 # 5620 <malloc+0x6ac>
     c42:	27e040ef          	jal	4ec0 <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	9f250513          	addi	a0,a0,-1550 # 5640 <malloc+0x6cc>
     c56:	26a040ef          	jal	4ec0 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	9fe50513          	addi	a0,a0,-1538 # 5660 <malloc+0x6ec>
     c6a:	256040ef          	jal	4ec0 <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	9fe50513          	addi	a0,a0,-1538 # 5680 <malloc+0x70c>
     c8a:	63f030ef          	jal	4ac8 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	9fa50513          	addi	a0,a0,-1542 # 5688 <malloc+0x714>
     c96:	633030ef          	jal	4ac8 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	9e250513          	addi	a0,a0,-1566 # 5680 <malloc+0x70c>
     ca6:	613030ef          	jal	4ab8 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	91e58593          	addi	a1,a1,-1762 # 55d0 <malloc+0x65c>
     cba:	5e7030ef          	jal	4aa0 <write>
     cbe:	4795                	li	a5,5
     cc0:	0cf51e63          	bne	a0,a5,d9c <linktest+0x128>
  close(fd);
     cc4:	8526                	mv	a0,s1
     cc6:	653030ef          	jal	4b18 <close>
  if(link("lf1", "lf2") < 0){
     cca:	00005597          	auipc	a1,0x5
     cce:	9be58593          	addi	a1,a1,-1602 # 5688 <malloc+0x714>
     cd2:	00005517          	auipc	a0,0x5
     cd6:	9ae50513          	addi	a0,a0,-1618 # 5680 <malloc+0x70c>
     cda:	5ff030ef          	jal	4ad8 <link>
     cde:	0c054963          	bltz	a0,db0 <linktest+0x13c>
  unlink("lf1");
     ce2:	00005517          	auipc	a0,0x5
     ce6:	99e50513          	addi	a0,a0,-1634 # 5680 <malloc+0x70c>
     cea:	5df030ef          	jal	4ac8 <unlink>
  if(open("lf1", 0) >= 0){
     cee:	4581                	li	a1,0
     cf0:	00005517          	auipc	a0,0x5
     cf4:	99050513          	addi	a0,a0,-1648 # 5680 <malloc+0x70c>
     cf8:	5c1030ef          	jal	4ab8 <open>
     cfc:	0c055463          	bgez	a0,dc4 <linktest+0x150>
  fd = open("lf2", 0);
     d00:	4581                	li	a1,0
     d02:	00005517          	auipc	a0,0x5
     d06:	98650513          	addi	a0,a0,-1658 # 5688 <malloc+0x714>
     d0a:	5af030ef          	jal	4ab8 <open>
     d0e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  close(fd);
     d28:	8526                	mv	a0,s1
     d2a:	5ef030ef          	jal	4b18 <close>
  if(link("lf2", "lf2") >= 0){
     d2e:	00005597          	auipc	a1,0x5
     d32:	95a58593          	addi	a1,a1,-1702 # 5688 <malloc+0x714>
     d36:	852e                	mv	a0,a1
     d38:	5a1030ef          	jal	4ad8 <link>
     d3c:	0c055263          	bgez	a0,e00 <linktest+0x18c>
  unlink("lf2");
     d40:	00005517          	auipc	a0,0x5
     d44:	94850513          	addi	a0,a0,-1720 # 5688 <malloc+0x714>
     d48:	581030ef          	jal	4ac8 <unlink>
  if(link("lf2", "lf1") >= 0){
     d4c:	00005597          	auipc	a1,0x5
     d50:	93458593          	addi	a1,a1,-1740 # 5680 <malloc+0x70c>
     d54:	00005517          	auipc	a0,0x5
     d58:	93450513          	addi	a0,a0,-1740 # 5688 <malloc+0x714>
     d5c:	57d030ef          	jal	4ad8 <link>
     d60:	0a055a63          	bgez	a0,e14 <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     d64:	00005597          	auipc	a1,0x5
     d68:	91c58593          	addi	a1,a1,-1764 # 5680 <malloc+0x70c>
     d6c:	00005517          	auipc	a0,0x5
     d70:	a2450513          	addi	a0,a0,-1500 # 5790 <malloc+0x81c>
     d74:	565030ef          	jal	4ad8 <link>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	90650513          	addi	a0,a0,-1786 # 5690 <malloc+0x71c>
     d92:	12e040ef          	jal	4ec0 <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	90a50513          	addi	a0,a0,-1782 # 56a8 <malloc+0x734>
     da6:	11a040ef          	jal	4ec0 <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	90e50513          	addi	a0,a0,-1778 # 56c0 <malloc+0x74c>
     dba:	106040ef          	jal	4ec0 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	91a50513          	addi	a0,a0,-1766 # 56e0 <malloc+0x76c>
     dce:	0f2040ef          	jal	4ec0 <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	93650513          	addi	a0,a0,-1738 # 5710 <malloc+0x79c>
     de2:	0de040ef          	jal	4ec0 <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	93a50513          	addi	a0,a0,-1734 # 5728 <malloc+0x7b4>
     df6:	0ca040ef          	jal	4ec0 <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	93e50513          	addi	a0,a0,-1730 # 5740 <malloc+0x7cc>
     e0a:	0b6040ef          	jal	4ec0 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	95250513          	addi	a0,a0,-1710 # 5768 <malloc+0x7f4>
     e1e:	0a2040ef          	jal	4ec0 <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	96e50513          	addi	a0,a0,-1682 # 5798 <malloc+0x824>
     e32:	08e040ef          	jal	4ec0 <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	96498993          	addi	s3,s3,-1692 # 57b8 <malloc+0x844>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	93c50513          	addi	a0,a0,-1732 # 57c8 <malloc+0x854>
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	93450513          	addi	a0,a0,-1740 # 57e8 <malloc+0x874>
     ebc:	40d030ef          	jal	4ac8 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	92450513          	addi	a0,a0,-1756 # 57e8 <malloc+0x874>
     ecc:	3ed030ef          	jal	4ab8 <open>
  if(fd < 0){
     ed0:	0c054163          	bltz	a0,f92 <bigdir+0xf4>
  close(fd);
     ed4:	445030ef          	jal	4b18 <close>
  for(i = 0; i < N; i++){
     ed8:	4901                	li	s2,0
    name[0] = 'x';
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	90aa0a13          	addi	s4,s4,-1782 # 57e8 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	8bc50513          	addi	a0,a0,-1860 # 57e8 <malloc+0x874>
     f34:	395030ef          	jal	4ac8 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	85c50513          	addi	a0,a0,-1956 # 57f0 <malloc+0x87c>
     f9c:	725030ef          	jal	4ec0 <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	86250513          	addi	a0,a0,-1950 # 5810 <malloc+0x89c>
     fb6:	70b030ef          	jal	4ec0 <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	87650513          	addi	a0,a0,-1930 # 5838 <malloc+0x8c4>
     fca:	6f7030ef          	jal	4ec0 <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	08e98993          	addi	s3,s3,142 # 50a8 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    10e8:	32478793          	addi	a5,a5,804 # 7408 <malloc+0x2494>
    ...
    110c:	fa050513          	addi	a0,a0,-96 # 50a8 <malloc+0x134>
    1110:	1a1030ef          	jal	4ab0 <exec>
    if(ret != -1){
    1114:	57fd                	li	a5,-1
    ...
    1120:	7c450513          	addi	a0,a0,1988 # 58e0 <malloc+0x96c>
    1124:	59d030ef          	jal	4ec0 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	72450513          	addi	a0,a0,1828 # 5858 <malloc+0x8e4>
    113c:	585030ef          	jal	4ec0 <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	72c50513          	addi	a0,a0,1836 # 5878 <malloc+0x904>
    1154:	56d030ef          	jal	4ec0 <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	73250513          	addi	a0,a0,1842 # 5898 <malloc+0x924>
    116e:	553030ef          	jal	4ec0 <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	74250513          	addi	a0,a0,1858 # 58c0 <malloc+0x94c>
    1186:	53b030ef          	jal	4ec0 <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	0f5030ef          	jal	4a80 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	d1850513          	addi	a0,a0,-744 # 6ea8 <malloc+0x1f34>
    1198:	529030ef          	jal	4ec0 <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	73e50513          	addi	a0,a0,1854 # 5908 <malloc+0x994>
    11d2:	4ef030ef          	jal	4ec0 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	f1450513          	addi	a0,a0,-236 # 5100 <malloc+0x18c>
    11f4:	0c5030ef          	jal	4ab8 <open>
    11f8:	121030ef          	jal	4b18 <close>
  pid = fork();
  ...
  if(pid == 0){
    ...
    1216:	eeea0a13          	addi	s4,s4,-274 # 5100 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	74ea8a93          	addi	s5,s5,1870 # 5968 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    1226:	093030ef          	jal	4ab8 <open>
    122a:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    123a:	06f51163          	bne	a0,a5,129c <truncate3+0xc0>
      close(fd);
    123e:	8526                	mv	a0,s1
    1240:	0d9030ef          	jal	4b18 <close>
      fd = open("truncfile", O_RDONLY);
    1244:	4581                	li	a1,0
    1246:	8552                	mv	a0,s4
    1248:	071030ef          	jal	4ab8 <open>
    124c:	84aa                	mv	s1,a0
    ...
    127a:	6c250513          	addi	a0,a0,1730 # 5938 <malloc+0x9c4>
    127e:	443030ef          	jal	4ec0 <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	6c650513          	addi	a0,a0,1734 # 5950 <malloc+0x9dc>
    1292:	42f030ef          	jal	4ec0 <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	6d850513          	addi	a0,a0,1752 # 5978 <malloc+0xa04>
    12a8:	419030ef          	jal	4ec0 <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	e42a0a13          	addi	s4,s4,-446 # 5100 <malloc+0x18c>
    int n = write(fd, "xxx", 3);
    12c6:	00004a97          	auipc	s5,0x4
    12ca:	6d2a8a93          	addi	s5,s5,1746 # 5998 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    12ce:	60100593          	li	a1,1537
    12d2:	8552                	mv	a0,s4
    12d4:	7e4030ef          	jal	4ab8 <open>
    12d8:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  unlink("truncfile");
    ...
    1304:	e0050513          	addi	a0,a0,-512 # 5100 <malloc+0x18c>
    1308:	7c0030ef          	jal	4ac8 <unlink>
  exit(xstatus);
    ...
    131a:	63a50513          	addi	a0,a0,1594 # 5950 <malloc+0x9dc>
    131e:	3a3030ef          	jal	4ec0 <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	67450513          	addi	a0,a0,1652 # 59a0 <malloc+0xa2c>
    1334:	38d030ef          	jal	4ec0 <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	d5e78793          	addi	a5,a5,-674 # 50a8 <malloc+0x134>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00004797          	auipc	a5,0x4
    135a:	66a78793          	addi	a5,a5,1642 # 59c0 <malloc+0xa4c>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00004517          	auipc	a0,0x4
    136a:	66250513          	addi	a0,a0,1634 # 59c8 <malloc+0xa54>
    136e:	75a030ef          	jal	4ac8 <unlink>
  pid = fork();
  ...
  if(pid == 0) {
    ...
    close(1);
    1380:	4505                	li	a0,1
    1382:	796030ef          	jal	4b18 <close>
    fd = open("echo-ok", O_CREATE|O_WRONLY);
    1386:	20100593          	li	a1,513
    138a:	00004517          	auipc	a0,0x4
    138e:	63e50513          	addi	a0,a0,1598 # 59c8 <malloc+0xa54>
    1392:	726030ef          	jal	4ab8 <open>
    if(fd < 0) {
    ...
    13a6:	64650513          	addi	a0,a0,1606 # 59e8 <malloc+0xa74>
    13aa:	317030ef          	jal	4ec0 <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	58050513          	addi	a0,a0,1408 # 5938 <malloc+0x9c4>
    13c0:	301030ef          	jal	4ec0 <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	60450513          	addi	a0,a0,1540 # 59d0 <malloc+0xa5c>
    13d4:	2ed030ef          	jal	4ec0 <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	cc650513          	addi	a0,a0,-826 # 50a8 <malloc+0x134>
    13ea:	6c6030ef          	jal	4ab0 <exec>
  ...
  if(xstatus != 0)
    ...
    140e:	5ee50513          	addi	a0,a0,1518 # 59f8 <malloc+0xa84>
    1412:	2af030ef          	jal	4ec0 <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	5f250513          	addi	a0,a0,1522 # 5a10 <malloc+0xa9c>
    1426:	29b030ef          	jal	4ec0 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	59a50513          	addi	a0,a0,1434 # 59c8 <malloc+0xa54>
    1436:	682030ef          	jal	4ab8 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	02850513          	addi	a0,a0,40 # 5478 <malloc+0x504>
    1458:	269030ef          	jal	4ec0 <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	4ec50513          	addi	a0,a0,1260 # 5950 <malloc+0x9dc>
    146c:	255030ef          	jal	4ec0 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	60e030ef          	jal	4a80 <exit>
  unlink("echo-ok");
    1476:	00004517          	auipc	a0,0x4
    147a:	55250513          	addi	a0,a0,1362 # 59c8 <malloc+0xa54>
    147e:	64a030ef          	jal	4ac8 <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	58c50513          	addi	a0,a0,1420 # 5a28 <malloc+0xab4>
    14a4:	21d030ef          	jal	4ec0 <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	4f850513          	addi	a0,a0,1272 # 5a40 <malloc+0xacc>
    1550:	171030ef          	jal	4ec0 <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	49650513          	addi	a0,a0,1174 # 5a58 <malloc+0xae4>
    15ca:	0f7030ef          	jal	4ec0 <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	49a50513          	addi	a0,a0,1178 # 5a70 <malloc+0xafc>
    15de:	0e3030ef          	jal	4ec0 <printf>
          return;
    ...
    160a:	48250513          	addi	a0,a0,1154 # 5a88 <malloc+0xb14>
    160e:	0b3030ef          	jal	4ec0 <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	46a50513          	addi	a0,a0,1130 # 5aa8 <malloc+0xb34>
    1646:	07b030ef          	jal	4ec0 <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	29850513          	addi	a0,a0,664 # 5938 <malloc+0x9c4>
    16a8:	019030ef          	jal	4ec0 <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	40c50513          	addi	a0,a0,1036 # 5ac0 <malloc+0xb4c>
    16bc:	005030ef          	jal	4ec0 <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	41050513          	addi	a0,a0,1040 # 5ad8 <malloc+0xb64>
    16d0:	7f0030ef          	jal	4ec0 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	21450513          	addi	a0,a0,532 # 5938 <malloc+0x9c4>
    172c:	794030ef          	jal	4ec0 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	1fc50513          	addi	a0,a0,508 # 5938 <malloc+0x9c4>
    1744:	77c030ef          	jal	4ec0 <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	35e50513          	addi	a0,a0,862 # 5af8 <malloc+0xb84>
    17a2:	71e030ef          	jal	4ec0 <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	2d8030ef          	jal	4a80 <exit>
{
    ...
    17da:	33250513          	addi	a0,a0,818 # 5b08 <malloc+0xb94>
    17de:	6e2030ef          	jal	4ec0 <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	69850513          	addi	a0,a0,1688 # 6ea8 <malloc+0x1f34>
    1818:	6a8030ef          	jal	4ec0 <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	0a650513          	addi	a0,a0,166 # 5938 <malloc+0x9c4>
    189a:	626030ef          	jal	4ec0 <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	11a50513          	addi	a0,a0,282 # 59d0 <malloc+0xa5c>
    18be:	602030ef          	jal	4ec0 <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    18de:	1da030ef          	jal	4ab8 <open>
        if(fd < 0){
    18e2:	fc0549e3          	bltz	a0,18b4 <createdelete+0x84>
        close(fd);
    18e6:	232030ef          	jal	4b18 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    190a:	1be030ef          	jal	4ac8 <unlink>
    190e:	fa055de3          	bgez	a0,18c8 <createdelete+0x98>
            printf("%s: unlink failed\n", s);
    1912:	85e6                	mv	a1,s9
    1914:	00004517          	auipc	a0,0x4
    1918:	21450513          	addi	a0,a0,532 # 5b28 <malloc+0xbb4>
    191c:	5a4030ef          	jal	4ec0 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	20850513          	addi	a0,a0,520 # 5b40 <malloc+0xbcc>
    1940:	580030ef          	jal	4ec0 <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	1de50513          	addi	a0,a0,478 # 5b68 <malloc+0xbf4>
    1992:	52e030ef          	jal	4ec0 <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	6f450513          	addi	a0,a0,1780 # 5118 <malloc+0x1a4>
    1a2c:	09c030ef          	jal	4ac8 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	6c0b0b13          	addi	s6,s6,1728 # 5118 <malloc+0x1a4>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	130c0c13          	addi	s8,s8,304 # 5b90 <malloc+0xc1c>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	ecc50513          	addi	a0,a0,-308 # 5938 <malloc+0x9c4>
    1a74:	44c030ef          	jal	4ec0 <printf>
    exit(1);
    1a78:	4505                	li	a0,1
    ...
    1a82:	855a                	mv	a0,s6
    1a84:	034030ef          	jal	4ab8 <open>
    1a88:	090030ef          	jal	4b18 <close>
  for(i = 0; i < 100; i++){
    ...
    1aa4:	01778663          	beq	a5,s7,1ab0 <linkunlink+0xa8>
      unlink("x");
    1aa8:	855a                	mv	a0,s6
    1aaa:	01e030ef          	jal	4ac8 <unlink>
    1aae:	bff9                	j	1a8c <linkunlink+0x84>
      link("cat", "x");
    1ab0:	85da                	mv	a1,s6
    1ab2:	8562                	mv	a0,s8
    1ab4:	024030ef          	jal	4ad8 <link>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	0d450513          	addi	a0,a0,212 # 5be0 <malloc+0xc6c>
    1b14:	3ac030ef          	jal	4ec0 <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	07450513          	addi	a0,a0,116 # 5b98 <malloc+0xc24>
    1b2c:	394030ef          	jal	4ec0 <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	07850513          	addi	a0,a0,120 # 5bb0 <malloc+0xc3c>
    1b40:	380030ef          	jal	4ec0 <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	07c50513          	addi	a0,a0,124 # 5bc8 <malloc+0xc54>
    1b54:	36c030ef          	jal	4ec0 <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	d4e50513          	addi	a0,a0,-690 # 5938 <malloc+0x9c4>
    1bf2:	2ce030ef          	jal	4ec0 <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	00450513          	addi	a0,a0,4 # 5c08 <malloc+0xc94>
    1c0c:	2b4030ef          	jal	4ec0 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	cc650513          	addi	a0,a0,-826 # 5938 <malloc+0x9c4>
    1c7a:	246030ef          	jal	4ec0 <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	f9250513          	addi	a0,a0,-110 # 5c28 <malloc+0xcb4>
    1c9e:	222030ef          	jal	4ec0 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	f5a50513          	addi	a0,a0,-166 # 5c40 <malloc+0xccc>
    1cee:	1d2030ef          	jal	4ec0 <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	c3e50513          	addi	a0,a0,-962 # 5938 <malloc+0x9c4>
    1d02:	1be030ef          	jal	4ec0 <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	6e678793          	addi	a5,a5,1766 # 7408 <malloc+0x2494>
  ...
  exit(0);
    ...
    1d8e:	ede50513          	addi	a0,a0,-290 # 5c68 <malloc+0xcf4>
    1d92:	12e030ef          	jal	4ec0 <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	b9a50513          	addi	a0,a0,-1126 # 5938 <malloc+0x9c4>
    1da6:	11a030ef          	jal	4ec0 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	09e50513          	addi	a0,a0,158 # 6ea8 <malloc+0x1f34>
    1e12:	0ae030ef          	jal	4ec0 <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	dec50513          	addi	a0,a0,-532 # 5c88 <malloc+0xd14>
    1ea4:	01c030ef          	jal	4ec0 <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	2c450513          	addi	a0,a0,708 # 5178 <malloc+0x204>
    1ebc:	004030ef          	jal	4ec0 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    1ed6:	42b020ef          	jal	4b00 <sbrk>
  uint64 top = (uint64) sbrk(0);
    1eda:	4501                	li	a0,0
    1edc:	425020ef          	jal	4b00 <sbrk>
  if((top % PGSIZE) != 0){
    1ee0:	03451793          	slli	a5,a0,0x34
    1ee4:	e7bd                	bnez	a5,1f52 <copyinstr3+0x88>
  top = (uint64) sbrk(0);
    1ee6:	4501                	li	a0,0
    1ee8:	419020ef          	jal	4b00 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    1f5c:	3a5020ef          	jal	4b00 <sbrk>
    1f60:	b759                	j	1ee6 <copyinstr3+0x1c>
    printf("oops\n");
    1f62:	00004517          	auipc	a0,0x4
    1f66:	d3e50513          	addi	a0,a0,-706 # 5ca0 <malloc+0xd2c>
    1f6a:	757020ef          	jal	4ec0 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	8e050513          	addi	a0,a0,-1824 # 5858 <malloc+0x8e4>
    ...
    1f92:	8ea50513          	addi	a0,a0,-1814 # 5878 <malloc+0x904>
    1f96:	72b020ef          	jal	4ec0 <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	8f250513          	addi	a0,a0,-1806 # 5898 <malloc+0x924>
    1fae:	713020ef          	jal	4ec0 <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	90450513          	addi	a0,a0,-1788 # 58c0 <malloc+0x94c>
    1fc4:	6fd020ef          	jal	4ec0 <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	ce850513          	addi	a0,a0,-792 # 5ce0 <malloc+0xd6c>
    2000:	2b9020ef          	jal	4ab8 <open>
    2004:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    2024:	ce050513          	addi	a0,a0,-800 # 5d00 <malloc+0xd8c>
    2028:	699020ef          	jal	4ec0 <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	c7250513          	addi	a0,a0,-910 # 5ca8 <malloc+0xd34>
    203e:	683020ef          	jal	4ec0 <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	c7650513          	addi	a0,a0,-906 # 5cc0 <malloc+0xd4c>
    2052:	66f020ef          	jal	4ec0 <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	229020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	c8c50513          	addi	a0,a0,-884 # 5ce8 <malloc+0xd74>
    2064:	65d020ef          	jal	4ec0 <printf>
    exit(1);
    2068:	4505                	li	a0,1
    206a:	217020ef          	jal	4a80 <exit>
  close(fd);
    206e:	854a                	mv	a0,s2
    2070:	2a9020ef          	jal	4b18 <close>
  unlink("rwsbrk");
    2074:	00004517          	auipc	a0,0x4
    2078:	c6c50513          	addi	a0,a0,-916 # 5ce0 <malloc+0xd6c>
    207c:	24d020ef          	jal	4ac8 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	1fe50513          	addi	a0,a0,510 # 5280 <malloc+0x30c>
    208a:	22f020ef          	jal	4ab8 <open>
    208e:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    20a8:	c8c50513          	addi	a0,a0,-884 # 5d30 <malloc+0xdbc>
    20ac:	615020ef          	jal	4ec0 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	1cf020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    20b6:	00004517          	auipc	a0,0x4
    20ba:	c3250513          	addi	a0,a0,-974 # 5ce8 <malloc+0xd74>
    20be:	603020ef          	jal	4ec0 <printf>
    exit(1);
    20c2:	4505                	li	a0,1
    20c4:	1bd020ef          	jal	4a80 <exit>
  close(fd);
    20c8:	854a                	mv	a0,s2
    20ca:	24f020ef          	jal	4b18 <close>
  exit(0);
    20ce:	4501                	li	a0,0
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	c3850513          	addi	a0,a0,-968 # 5d58 <malloc+0xde4>
    2128:	599020ef          	jal	4ec0 <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	c0850513          	addi	a0,a0,-1016 # 5d78 <malloc+0xe04>
    2178:	549020ef          	jal	4ec0 <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  c = sbrk(1);
    21a8:	4505                	li	a0,1
    21aa:	157020ef          	jal	4b00 <sbrk>
  c = sbrk(1);
    21ae:	4505                	li	a0,1
    21b0:	151020ef          	jal	4b00 <sbrk>
  if(c != a + 1){
    ...
    21c0:	c1c50513          	addi	a0,a0,-996 # 5dd8 <malloc+0xe64>
    21c4:	4fd020ef          	jal	4ec0 <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	bc250513          	addi	a0,a0,-1086 # 5d98 <malloc+0xe24>
    21de:	4e3020ef          	jal	4ec0 <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	bce50513          	addi	a0,a0,-1074 # 5db8 <malloc+0xe44>
    21f2:	4cf020ef          	jal	4ec0 <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  oldbrk = sbrk(0);
    2228:	4501                	li	a0,0
    222a:	0d7020ef          	jal	4b00 <sbrk>
    222e:	892a                	mv	s2,a0
  a = sbrk(0);
    2230:	4501                	li	a0,0
    2232:	0cf020ef          	jal	4b00 <sbrk>
    2236:	84aa                	mv	s1,a0
  p = sbrk(amt);
    2238:	06400537          	lui	a0,0x6400
    223c:	9d05                	subw	a0,a0,s1
    223e:	0c3020ef          	jal	4b00 <sbrk>
  if (p != a) {
    2242:	0aa49463          	bne	s1,a0,22ea <sbrkmuch+0xd4>
  char *eee = sbrk(0);
    2246:	4501                	li	a0,0
    2248:	0b9020ef          	jal	4b00 <sbrk>
    224c:	87aa                	mv	a5,a0
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    226c:	4501                	li	a0,0
    226e:	093020ef          	jal	4b00 <sbrk>
    2272:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2274:	757d                	lui	a0,0xfffff
    2276:	08b020ef          	jal	4b00 <sbrk>
  if(c == (char*)0xffffffffffffffffL){
    227a:	57fd                	li	a5,-1
    227c:	08f50163          	beq	a0,a5,22fe <sbrkmuch+0xe8>
  c = sbrk(0);
    2280:	4501                	li	a0,0
    2282:	07f020ef          	jal	4b00 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    228e:	4501                	li	a0,0
    2290:	071020ef          	jal	4b00 <sbrk>
    2294:	84aa                	mv	s1,a0
  c = sbrk(PGSIZE);
    2296:	6505                	lui	a0,0x1
    2298:	069020ef          	jal	4b00 <sbrk>
    229c:	8a2a                	mv	s4,a0
  if(c != a || sbrk(0) != a + PGSIZE){
    229e:	08a49663          	bne	s1,a0,232a <sbrkmuch+0x114>
    22a2:	4501                	li	a0,0
    22a4:	05d020ef          	jal	4b00 <sbrk>
  ...
  a = sbrk(0);
    22c0:	4501                	li	a0,0
    22c2:	03f020ef          	jal	4b00 <sbrk>
    22c6:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    22c8:	4501                	li	a0,0
    22ca:	037020ef          	jal	4b00 <sbrk>
    22ce:	40a9053b          	subw	a0,s2,a0
    22d2:	02f020ef          	jal	4b00 <sbrk>
  if(c != a){
    ...
    22f0:	b0c50513          	addi	a0,a0,-1268 # 5df8 <malloc+0xe84>
    22f4:	3cd020ef          	jal	4ec0 <printf>
    exit(1);
    22f8:	4505                	li	a0,1
    ...
    2304:	b4050513          	addi	a0,a0,-1216 # 5e40 <malloc+0xecc>
    2308:	3b9020ef          	jal	4ec0 <printf>
    exit(1);
    230c:	4505                	li	a0,1
    ...
    231c:	b4850513          	addi	a0,a0,-1208 # 5e60 <malloc+0xeec>
    2320:	3a1020ef          	jal	4ec0 <printf>
    exit(1);
    2324:	4505                	li	a0,1
    ...
    2334:	b7050513          	addi	a0,a0,-1168 # 5ea0 <malloc+0xf2c>
    2338:	389020ef          	jal	4ec0 <printf>
    exit(1);
    233c:	4505                	li	a0,1
    ...
    2348:	b8c50513          	addi	a0,a0,-1140 # 5ed0 <malloc+0xf5c>
    234c:	375020ef          	jal	4ec0 <printf>
    exit(1);
    2350:	4505                	li	a0,1
    ...
    2360:	bac50513          	addi	a0,a0,-1108 # 5f08 <malloc+0xf94>
    2364:	35d020ef          	jal	4ec0 <printf>
    exit(1);
    2368:	4505                	li	a0,1
...
000000000000236e <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    2380:	780020ef          	jal	4b00 <sbrk>
    2384:	892a                	mv	s2,a0
  fd = open("sbrk", O_CREATE|O_WRONLY);
    2386:	20100593          	li	a1,513
    238a:	00004517          	auipc	a0,0x4
    238e:	ba650513          	addi	a0,a0,-1114 # 5f30 <malloc+0xfbc>
    2392:	726020ef          	jal	4ab8 <open>
    2396:	84aa                	mv	s1,a0
  unlink("sbrk");
    2398:	00004517          	auipc	a0,0x4
    239c:	b9850513          	addi	a0,a0,-1128 # 5f30 <malloc+0xfbc>
    23a0:	728020ef          	jal	4ac8 <unlink>
  if(fd < 0)  {
  ...
  close(fd);
    23b6:	8526                	mv	a0,s1
    23b8:	760020ef          	jal	4b18 <close>
  a = sbrk(PGSIZE);
    23bc:	6505                	lui	a0,0x1
    23be:	742020ef          	jal	4b00 <sbrk>
  if(pipe((int *) a) != 0){
    ...
    23dc:	b6050513          	addi	a0,a0,-1184 # 5f38 <malloc+0xfc4>
    23e0:	2e1020ef          	jal	4ec0 <printf>
    exit(1);
    23e4:	4505                	li	a0,1
    ...
    23f0:	b6450513          	addi	a0,a0,-1180 # 5f50 <malloc+0xfdc>
    23f4:	2cd020ef          	jal	4ec0 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    2404:	64050513          	addi	a0,a0,1600 # 5a40 <malloc+0xacc>
    2408:	2b9020ef          	jal	4ec0 <printf>
    exit(1);
    240c:	4505                	li	a0,1
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2426:	b4650513          	addi	a0,a0,-1210 # 5f68 <malloc+0xff4>
    242a:	68e020ef          	jal	4ab8 <open>
  if (fd < 0) {
    242e:	02054563          	bltz	a0,2458 <argptest+0x46>
    2432:	84aa                	mv	s1,a0
  read(fd, sbrk(0) - 1, -1);
    2434:	4501                	li	a0,0
    2436:	6ca020ef          	jal	4b00 <sbrk>
    243a:	567d                	li	a2,-1
  ...
  close(fd);
    ...
    245e:	4f650513          	addi	a0,a0,1270 # 5950 <malloc+0x9dc>
    2462:	25f020ef          	jal	4ec0 <printf>
    exit(1);
    2466:	4505                	li	a0,1
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247e:	682020ef          	jal	4b00 <sbrk>
    sbrk(-sz);
    2482:	40a0053b          	negw	a0,a0
    2486:	67a020ef          	jal	4b00 <sbrk>
    exit(0);
    248a:	4501                	li	a0,0
    248c:	5f4020ef          	jal	4a80 <exit>
    printf("fork failed\n");
    2490:	00005517          	auipc	a0,0x5
    2494:	a1850513          	addi	a0,a0,-1512 # 6ea8 <malloc+0x1f34>
    2498:	229020ef          	jal	4ec0 <printf>
    exit(1);
    249c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24ec:	614020ef          	jal	4b00 <sbrk>
    24f0:	67ad                	lui	a5,0xb
    24f2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x298>
    24f6:	40a7853b          	subw	a0,a5,a0
    24fa:	606020ef          	jal	4b00 <sbrk>
    sbrk(-10);
    24fe:	5559                	li	a0,-10
    2500:	600020ef          	jal	4b00 <sbrk>
    exit(0);
    2504:	4501                	li	a0,0
    2506:	57a020ef          	jal	4a80 <exit>
    printf("fork failed\n");
    250a:	00005517          	auipc	a0,0x5
    250e:	99e50513          	addi	a0,a0,-1634 # 6ea8 <malloc+0x1f34>
    2512:	1af020ef          	jal	4ec0 <printf>
    exit(1);
    2516:	4505                	li	a0,1
...
0000000000002528 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    2538:	4501                	li	a0,0
    253a:	5c6020ef          	jal	4b00 <sbrk>
  if((top % 4096) != 0)
    253e:	03451793          	slli	a5,a0,0x34
    2542:	ebad                	bnez	a5,25b4 <sbrklast+0x8c>
  sbrk(4096);
    2544:	6505                	lui	a0,0x1
    2546:	5ba020ef          	jal	4b00 <sbrk>
  sbrk(10);
    254a:	4529                	li	a0,10
    254c:	5b4020ef          	jal	4b00 <sbrk>
  sbrk(-20);
    2550:	5531                	li	a0,-20
    2552:	5ae020ef          	jal	4b00 <sbrk>
  top = (uint64) sbrk(0);
    2556:	4501                	li	a0,0
    2558:	5a8020ef          	jal	4b00 <sbrk>
    255c:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  close(fd);
    2582:	854e                	mv	a0,s3
    2584:	594020ef          	jal	4b18 <close>
  fd = open(p, O_RDWR);
    2588:	4589                	li	a1,2
    258a:	854a                	mv	a0,s2
    258c:	52c020ef          	jal	4ab8 <open>
  p[0] = '\0';
...
00000000000025ca <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    25d8:	528020ef          	jal	4b00 <sbrk>
  volatile char *top = sbrk(0);
    25dc:	4501                	li	a0,0
    25de:	522020ef          	jal	4b00 <sbrk>
  *(top-1) = *(top-1) + 1;
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    262e:	87e50513          	addi	a0,a0,-1922 # 6ea8 <malloc+0x1f34>
    2632:	08f020ef          	jal	4ec0 <printf>
      exit(1);
    2636:	4505                	li	a0,1
...
0000000000002694 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26a4:	aa050513          	addi	a0,a0,-1376 # 6140 <malloc+0x11cc>
    26a8:	438020ef          	jal	4ae0 <mkdir>
    26ac:	e555                	bnez	a0,2758 <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    26ae:	00004517          	auipc	a0,0x4
    26b2:	8ea50513          	addi	a0,a0,-1814 # 5f98 <malloc+0x1024>
    26b6:	42a020ef          	jal	4ae0 <mkdir>
    26ba:	e94d                	bnez	a0,276c <fourteen+0xd8>
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    26bc:	20000593          	li	a1,512
    26c0:	00004517          	auipc	a0,0x4
    26c4:	93050513          	addi	a0,a0,-1744 # 5ff0 <malloc+0x107c>
    26c8:	3f0020ef          	jal	4ab8 <open>
  if(fd < 0){
    26cc:	0a054a63          	bltz	a0,2780 <fourteen+0xec>
  close(fd);
    26d0:	448020ef          	jal	4b18 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    26d4:	4581                	li	a1,0
    26d6:	00004517          	auipc	a0,0x4
    26da:	99250513          	addi	a0,a0,-1646 # 6068 <malloc+0x10f4>
    26de:	3da020ef          	jal	4ab8 <open>
  if(fd < 0){
    26e2:	0a054963          	bltz	a0,2794 <fourteen+0x100>
  close(fd);
    26e6:	432020ef          	jal	4b18 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    26ea:	00004517          	auipc	a0,0x4
    26ee:	9ee50513          	addi	a0,a0,-1554 # 60d8 <malloc+0x1164>
    26f2:	3ee020ef          	jal	4ae0 <mkdir>
    26f6:	c94d                	beqz	a0,27a8 <fourteen+0x114>
  if(mkdir("123456789012345/12345678901234") == 0){
    26f8:	00004517          	auipc	a0,0x4
    26fc:	a3850513          	addi	a0,a0,-1480 # 6130 <malloc+0x11bc>
    2700:	3e0020ef          	jal	4ae0 <mkdir>
    2704:	cd45                	beqz	a0,27bc <fourteen+0x128>
  unlink("123456789012345/12345678901234");
    2706:	00004517          	auipc	a0,0x4
    270a:	a2a50513          	addi	a0,a0,-1494 # 6130 <malloc+0x11bc>
    270e:	3ba020ef          	jal	4ac8 <unlink>
  unlink("12345678901234/12345678901234");
    2712:	00004517          	auipc	a0,0x4
    2716:	9c650513          	addi	a0,a0,-1594 # 60d8 <malloc+0x1164>
    271a:	3ae020ef          	jal	4ac8 <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    271e:	00004517          	auipc	a0,0x4
    2722:	94a50513          	addi	a0,a0,-1718 # 6068 <malloc+0x10f4>
    2726:	3a2020ef          	jal	4ac8 <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    272a:	00004517          	auipc	a0,0x4
    272e:	8c650513          	addi	a0,a0,-1850 # 5ff0 <malloc+0x107c>
    2732:	396020ef          	jal	4ac8 <unlink>
  unlink("12345678901234/123456789012345");
    2736:	00004517          	auipc	a0,0x4
    273a:	86250513          	addi	a0,a0,-1950 # 5f98 <malloc+0x1024>
    273e:	38a020ef          	jal	4ac8 <unlink>
  unlink("12345678901234");
    2742:	00004517          	auipc	a0,0x4
    2746:	9fe50513          	addi	a0,a0,-1538 # 6140 <malloc+0x11cc>
    274a:	37e020ef          	jal	4ac8 <unlink>
}
    ...
    275e:	81650513          	addi	a0,a0,-2026 # 5f70 <malloc+0xffc>
    2762:	75e020ef          	jal	4ec0 <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2772:	84a50513          	addi	a0,a0,-1974 # 5fb8 <malloc+0x1044>
    2776:	74a020ef          	jal	4ec0 <printf>
    exit(1);
    277a:	4505                	li	a0,1
    ...
    2786:	89e50513          	addi	a0,a0,-1890 # 6020 <malloc+0x10ac>
    278a:	736020ef          	jal	4ec0 <printf>
    exit(1);
    278e:	4505                	li	a0,1
    ...
    279a:	90250513          	addi	a0,a0,-1790 # 6098 <malloc+0x1124>
    279e:	722020ef          	jal	4ec0 <printf>
    exit(1);
    27a2:	4505                	li	a0,1
    ...
    27ae:	94e50513          	addi	a0,a0,-1714 # 60f8 <malloc+0x1184>
    27b2:	70e020ef          	jal	4ec0 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
    ...
    27c2:	99250513          	addi	a0,a0,-1646 # 6150 <malloc+0x11dc>
    27c6:	6fa020ef          	jal	4ec0 <printf>
    exit(1);
    27ca:	4505                	li	a0,1
...
00000000000027d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    280a:	98250513          	addi	a0,a0,-1662 # 6188 <malloc+0x1214>
    280e:	2ba020ef          	jal	4ac8 <unlink>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2836:	96650513          	addi	a0,a0,-1690 # 6198 <malloc+0x1224>
    283a:	686020ef          	jal	4ec0 <printf>
      break;
    283e:	a039                	j	284c <diskfull+0x7c>
        close(fd);
    2840:	854a                	mv	a0,s2
    2842:	2d6020ef          	jal	4b18 <close>
    close(fd);
    2846:	854a                	mv	a0,s2
    2848:	2d0020ef          	jal	4b18 <close>
  for(int i = 0; i < nzz; i++){
    284c:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29a0:	128020ef          	jal	4ac8 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    29a4:	60200593          	li	a1,1538
    29a8:	b8040513          	addi	a0,s0,-1152
    29ac:	10c020ef          	jal	4ab8 <open>
    29b0:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    29da:	7e250513          	addi	a0,a0,2018 # 61b8 <malloc+0x1244>
    29de:	4e2020ef          	jal	4ec0 <printf>
...
00000000000029e4 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    29f4:	7f850513          	addi	a0,a0,2040 # 61e8 <malloc+0x1274>
    29f8:	0e8020ef          	jal	4ae0 <mkdir>
    29fc:	02054f63          	bltz	a0,2a3a <iputtest+0x56>
  if(chdir("iputdir") < 0){
    2a00:	00003517          	auipc	a0,0x3
    2a04:	7e850513          	addi	a0,a0,2024 # 61e8 <malloc+0x1274>
    2a08:	0e0020ef          	jal	4ae8 <chdir>
    2a0c:	04054163          	bltz	a0,2a4e <iputtest+0x6a>
  if(unlink("../iputdir") < 0){
    2a10:	00004517          	auipc	a0,0x4
    2a14:	81850513          	addi	a0,a0,-2024 # 6228 <malloc+0x12b4>
    2a18:	0b0020ef          	jal	4ac8 <unlink>
    2a1c:	04054363          	bltz	a0,2a62 <iputtest+0x7e>
  if(chdir("/") < 0){
    2a20:	00004517          	auipc	a0,0x4
    2a24:	83850513          	addi	a0,a0,-1992 # 6258 <malloc+0x12e4>
    2a28:	0c0020ef          	jal	4ae8 <chdir>
    ...
    2a40:	7b450513          	addi	a0,a0,1972 # 61f0 <malloc+0x127c>
    ...
    2a54:	7b850513          	addi	a0,a0,1976 # 6208 <malloc+0x1294>
    2a58:	468020ef          	jal	4ec0 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a68:	7d450513          	addi	a0,a0,2004 # 6238 <malloc+0x12c4>
    2a6c:	454020ef          	jal	4ec0 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
    ...
    2a7c:	7e850513          	addi	a0,a0,2024 # 6260 <malloc+0x12ec>
    2a80:	440020ef          	jal	4ec0 <printf>
    exit(1);
    2a84:	4505                	li	a0,1
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2aa4:	74850513          	addi	a0,a0,1864 # 61e8 <malloc+0x1274>
    2aa8:	038020ef          	jal	4ae0 <mkdir>
    2aac:	02054f63          	bltz	a0,2aea <exitiputtest+0x60>
    if(chdir("iputdir") < 0){
    2ab0:	00003517          	auipc	a0,0x3
    2ab4:	73850513          	addi	a0,a0,1848 # 61e8 <malloc+0x1274>
    2ab8:	030020ef          	jal	4ae8 <chdir>
    2abc:	04054163          	bltz	a0,2afe <exitiputtest+0x74>
    if(unlink("../iputdir") < 0){
    2ac0:	00003517          	auipc	a0,0x3
    2ac4:	76850513          	addi	a0,a0,1896 # 6228 <malloc+0x12b4>
    2ac8:	000020ef          	jal	4ac8 <unlink>
    ...
    2adc:	e6050513          	addi	a0,a0,-416 # 5938 <malloc+0x9c4>
    2ae0:	3e0020ef          	jal	4ec0 <printf>
    exit(1);
    2ae4:	4505                	li	a0,1
    ...
    2af0:	70450513          	addi	a0,a0,1796 # 61f0 <malloc+0x127c>
    2af4:	3cc020ef          	jal	4ec0 <printf>
      exit(1);
    2af8:	4505                	li	a0,1
    ...
    2b04:	77850513          	addi	a0,a0,1912 # 6278 <malloc+0x1304>
    2b08:	3b8020ef          	jal	4ec0 <printf>
      exit(1);
    2b0c:	4505                	li	a0,1
    ...
    2b18:	72450513          	addi	a0,a0,1828 # 6238 <malloc+0x12c4>
    2b1c:	3a4020ef          	jal	4ec0 <printf>
      exit(1);
    2b20:	4505                	li	a0,1
...
0000000000002b36 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2b46:	74e50513          	addi	a0,a0,1870 # 6290 <malloc+0x131c>
    2b4a:	797010ef          	jal	4ae0 <mkdir>
    2b4e:	02054f63          	bltz	a0,2b8c <dirtest+0x56>
  if(chdir("dir0") < 0){
    2b52:	00003517          	auipc	a0,0x3
    2b56:	73e50513          	addi	a0,a0,1854 # 6290 <malloc+0x131c>
    2b5a:	78f010ef          	jal	4ae8 <chdir>
    2b5e:	04054163          	bltz	a0,2ba0 <dirtest+0x6a>
  if(chdir("..") < 0){
    2b62:	00003517          	auipc	a0,0x3
    2b66:	74e50513          	addi	a0,a0,1870 # 62b0 <malloc+0x133c>
    2b6a:	77f010ef          	jal	4ae8 <chdir>
    2b6e:	04054363          	bltz	a0,2bb4 <dirtest+0x7e>
  if(unlink("dir0") < 0){
    2b72:	00003517          	auipc	a0,0x3
    2b76:	71e50513          	addi	a0,a0,1822 # 6290 <malloc+0x131c>
    2b7a:	74f010ef          	jal	4ac8 <unlink>
    ...
    2b92:	66250513          	addi	a0,a0,1634 # 61f0 <malloc+0x127c>
    2b96:	32a020ef          	jal	4ec0 <printf>
    exit(1);
    2b9a:	4505                	li	a0,1
    ...
    2ba6:	6f650513          	addi	a0,a0,1782 # 6298 <malloc+0x1324>
    2baa:	316020ef          	jal	4ec0 <printf>
    exit(1);
    2bae:	4505                	li	a0,1
    ...
    2bba:	70250513          	addi	a0,a0,1794 # 62b8 <malloc+0x1344>
    2bbe:	302020ef          	jal	4ec0 <printf>
    exit(1);
    2bc2:	4505                	li	a0,1
    ...
    2bce:	70650513          	addi	a0,a0,1798 # 62d0 <malloc+0x135c>
    2bd2:	2ee020ef          	jal	4ec0 <printf>
    exit(1);
    2bd6:	4505                	li	a0,1
...
0000000000002bdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2bee:	82e50513          	addi	a0,a0,-2002 # 6418 <malloc+0x14a4>
    2bf2:	6d7010ef          	jal	4ac8 <unlink>
  if(mkdir("dd") != 0){
    2bf6:	00003517          	auipc	a0,0x3
    2bfa:	6f250513          	addi	a0,a0,1778 # 62e8 <malloc+0x1374>
    2bfe:	6e3010ef          	jal	4ae0 <mkdir>
    2c02:	2e051263          	bnez	a0,2ee6 <subdir+0x30a>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    2c06:	20200593          	li	a1,514
    2c0a:	00003517          	auipc	a0,0x3
    2c0e:	6fe50513          	addi	a0,a0,1790 # 6308 <malloc+0x1394>
    2c12:	6a7010ef          	jal	4ab8 <open>
    2c16:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    2c22:	7fa58593          	addi	a1,a1,2042 # 6418 <malloc+0x14a4>
    2c26:	67b010ef          	jal	4aa0 <write>
  close(fd);
    2c2a:	8526                	mv	a0,s1
    2c2c:	6ed010ef          	jal	4b18 <close>
  if(unlink("dd") >= 0){
    2c30:	00003517          	auipc	a0,0x3
    2c34:	6b850513          	addi	a0,a0,1720 # 62e8 <malloc+0x1374>
    2c38:	691010ef          	jal	4ac8 <unlink>
    2c3c:	2c055963          	bgez	a0,2f0e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c40:	00003517          	auipc	a0,0x3
    2c44:	72050513          	addi	a0,a0,1824 # 6360 <malloc+0x13ec>
    2c48:	699010ef          	jal	4ae0 <mkdir>
    2c4c:	2c051b63          	bnez	a0,2f22 <subdir+0x346>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2c50:	20200593          	li	a1,514
    2c54:	00003517          	auipc	a0,0x3
    2c58:	73450513          	addi	a0,a0,1844 # 6388 <malloc+0x1414>
    2c5c:	65d010ef          	jal	4ab8 <open>
    2c60:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    2c6c:	75058593          	addi	a1,a1,1872 # 63b8 <malloc+0x1444>
    2c70:	631010ef          	jal	4aa0 <write>
  close(fd);
    2c74:	8526                	mv	a0,s1
    2c76:	6a3010ef          	jal	4b18 <close>
  fd = open("dd/dd/../ff", 0);
    2c7a:	4581                	li	a1,0
    2c7c:	00003517          	auipc	a0,0x3
    2c80:	74450513          	addi	a0,a0,1860 # 63c0 <malloc+0x144c>
    2c84:	635010ef          	jal	4ab8 <open>
    2c88:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  close(fd);
    2cb2:	8526                	mv	a0,s1
    2cb4:	665010ef          	jal	4b18 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2cb8:	00003597          	auipc	a1,0x3
    2cbc:	75858593          	addi	a1,a1,1880 # 6410 <malloc+0x149c>
    2cc0:	00003517          	auipc	a0,0x3
    2cc4:	6c850513          	addi	a0,a0,1736 # 6388 <malloc+0x1414>
    2cc8:	611010ef          	jal	4ad8 <link>
    2ccc:	2a051363          	bnez	a0,2f72 <subdir+0x396>
  if(unlink("dd/dd/ff") != 0){
    2cd0:	00003517          	auipc	a0,0x3
    2cd4:	6b850513          	addi	a0,a0,1720 # 6388 <malloc+0x1414>
    2cd8:	5f1010ef          	jal	4ac8 <unlink>
    2cdc:	2a051563          	bnez	a0,2f86 <subdir+0x3aa>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2ce0:	4581                	li	a1,0
    2ce2:	00003517          	auipc	a0,0x3
    2ce6:	6a650513          	addi	a0,a0,1702 # 6388 <malloc+0x1414>
    2cea:	5cf010ef          	jal	4ab8 <open>
    2cee:	2a055663          	bgez	a0,2f9a <subdir+0x3be>
  if(chdir("dd") != 0){
    2cf2:	00003517          	auipc	a0,0x3
    2cf6:	5f650513          	addi	a0,a0,1526 # 62e8 <malloc+0x1374>
    2cfa:	5ef010ef          	jal	4ae8 <chdir>
    2cfe:	2a051863          	bnez	a0,2fae <subdir+0x3d2>
  if(chdir("dd/../../dd") != 0){
    2d02:	00003517          	auipc	a0,0x3
    2d06:	7a650513          	addi	a0,a0,1958 # 64a8 <malloc+0x1534>
    2d0a:	5df010ef          	jal	4ae8 <chdir>
    2d0e:	2a051a63          	bnez	a0,2fc2 <subdir+0x3e6>
  if(chdir("dd/../../../dd") != 0){
    2d12:	00003517          	auipc	a0,0x3
    2d16:	7c650513          	addi	a0,a0,1990 # 64d8 <malloc+0x1564>
    2d1a:	5cf010ef          	jal	4ae8 <chdir>
    2d1e:	2a051c63          	bnez	a0,2fd6 <subdir+0x3fa>
  if(chdir("./..") != 0){
    2d22:	00003517          	auipc	a0,0x3
    2d26:	7ee50513          	addi	a0,a0,2030 # 6510 <malloc+0x159c>
    2d2a:	5bf010ef          	jal	4ae8 <chdir>
    2d2e:	2a051e63          	bnez	a0,2fea <subdir+0x40e>
  fd = open("dd/dd/ffff", 0);
    2d32:	4581                	li	a1,0
    2d34:	00003517          	auipc	a0,0x3
    2d38:	6dc50513          	addi	a0,a0,1756 # 6410 <malloc+0x149c>
    2d3c:	57d010ef          	jal	4ab8 <open>
    2d40:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  close(fd);
    2d5a:	8526                	mv	a0,s1
    2d5c:	5bd010ef          	jal	4b18 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2d60:	4581                	li	a1,0
    2d62:	00003517          	auipc	a0,0x3
    2d66:	62650513          	addi	a0,a0,1574 # 6388 <malloc+0x1414>
    2d6a:	54f010ef          	jal	4ab8 <open>
    2d6e:	2a055c63          	bgez	a0,3026 <subdir+0x44a>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2d72:	20200593          	li	a1,514
    2d76:	00004517          	auipc	a0,0x4
    2d7a:	82a50513          	addi	a0,a0,-2006 # 65a0 <malloc+0x162c>
    2d7e:	53b010ef          	jal	4ab8 <open>
    2d82:	2a055c63          	bgez	a0,303a <subdir+0x45e>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2d86:	20200593          	li	a1,514
    2d8a:	00004517          	auipc	a0,0x4
    2d8e:	84650513          	addi	a0,a0,-1978 # 65d0 <malloc+0x165c>
    2d92:	527010ef          	jal	4ab8 <open>
    2d96:	2a055c63          	bgez	a0,304e <subdir+0x472>
  if(open("dd", O_CREATE) >= 0){
    2d9a:	20000593          	li	a1,512
    2d9e:	00003517          	auipc	a0,0x3
    2da2:	54a50513          	addi	a0,a0,1354 # 62e8 <malloc+0x1374>
    2da6:	513010ef          	jal	4ab8 <open>
    2daa:	2a055c63          	bgez	a0,3062 <subdir+0x486>
  if(open("dd", O_RDWR) >= 0){
    2dae:	4589                	li	a1,2
    2db0:	00003517          	auipc	a0,0x3
    2db4:	53850513          	addi	a0,a0,1336 # 62e8 <malloc+0x1374>
    2db8:	501010ef          	jal	4ab8 <open>
    2dbc:	2a055d63          	bgez	a0,3076 <subdir+0x49a>
  if(open("dd", O_WRONLY) >= 0){
    2dc0:	4585                	li	a1,1
    2dc2:	00003517          	auipc	a0,0x3
    2dc6:	52650513          	addi	a0,a0,1318 # 62e8 <malloc+0x1374>
    2dca:	4ef010ef          	jal	4ab8 <open>
    2dce:	2a055e63          	bgez	a0,308a <subdir+0x4ae>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2dd2:	00004597          	auipc	a1,0x4
    2dd6:	88e58593          	addi	a1,a1,-1906 # 6660 <malloc+0x16ec>
    2dda:	00003517          	auipc	a0,0x3
    2dde:	7c650513          	addi	a0,a0,1990 # 65a0 <malloc+0x162c>
    2de2:	4f7010ef          	jal	4ad8 <link>
    2de6:	2a050c63          	beqz	a0,309e <subdir+0x4c2>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2dea:	00004597          	auipc	a1,0x4
    2dee:	87658593          	addi	a1,a1,-1930 # 6660 <malloc+0x16ec>
    2df2:	00003517          	auipc	a0,0x3
    2df6:	7de50513          	addi	a0,a0,2014 # 65d0 <malloc+0x165c>
    2dfa:	4df010ef          	jal	4ad8 <link>
    2dfe:	2a050a63          	beqz	a0,30b2 <subdir+0x4d6>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2e02:	00003597          	auipc	a1,0x3
    2e06:	60e58593          	addi	a1,a1,1550 # 6410 <malloc+0x149c>
    2e0a:	00003517          	auipc	a0,0x3
    2e0e:	4fe50513          	addi	a0,a0,1278 # 6308 <malloc+0x1394>
    2e12:	4c7010ef          	jal	4ad8 <link>
    2e16:	2a050863          	beqz	a0,30c6 <subdir+0x4ea>
  if(mkdir("dd/ff/ff") == 0){
    2e1a:	00003517          	auipc	a0,0x3
    2e1e:	78650513          	addi	a0,a0,1926 # 65a0 <malloc+0x162c>
    2e22:	4bf010ef          	jal	4ae0 <mkdir>
    2e26:	2a050a63          	beqz	a0,30da <subdir+0x4fe>
  if(mkdir("dd/xx/ff") == 0){
    2e2a:	00003517          	auipc	a0,0x3
    2e2e:	7a650513          	addi	a0,a0,1958 # 65d0 <malloc+0x165c>
    2e32:	4af010ef          	jal	4ae0 <mkdir>
    2e36:	2a050c63          	beqz	a0,30ee <subdir+0x512>
  if(mkdir("dd/dd/ffff") == 0){
    2e3a:	00003517          	auipc	a0,0x3
    2e3e:	5d650513          	addi	a0,a0,1494 # 6410 <malloc+0x149c>
    2e42:	49f010ef          	jal	4ae0 <mkdir>
    2e46:	2a050e63          	beqz	a0,3102 <subdir+0x526>
  if(unlink("dd/xx/ff") == 0){
    2e4a:	00003517          	auipc	a0,0x3
    2e4e:	78650513          	addi	a0,a0,1926 # 65d0 <malloc+0x165c>
    2e52:	477010ef          	jal	4ac8 <unlink>
    2e56:	2c050063          	beqz	a0,3116 <subdir+0x53a>
  if(unlink("dd/ff/ff") == 0){
    2e5a:	00003517          	auipc	a0,0x3
    2e5e:	74650513          	addi	a0,a0,1862 # 65a0 <malloc+0x162c>
    2e62:	467010ef          	jal	4ac8 <unlink>
    2e66:	2c050263          	beqz	a0,312a <subdir+0x54e>
  if(chdir("dd/ff") == 0){
    2e6a:	00003517          	auipc	a0,0x3
    2e6e:	49e50513          	addi	a0,a0,1182 # 6308 <malloc+0x1394>
    2e72:	477010ef          	jal	4ae8 <chdir>
    2e76:	2c050463          	beqz	a0,313e <subdir+0x562>
  if(chdir("dd/xx") == 0){
    2e7a:	00004517          	auipc	a0,0x4
    2e7e:	93650513          	addi	a0,a0,-1738 # 67b0 <malloc+0x183c>
    2e82:	467010ef          	jal	4ae8 <chdir>
    2e86:	2c050663          	beqz	a0,3152 <subdir+0x576>
  if(unlink("dd/dd/ffff") != 0){
    2e8a:	00003517          	auipc	a0,0x3
    2e8e:	58650513          	addi	a0,a0,1414 # 6410 <malloc+0x149c>
    2e92:	437010ef          	jal	4ac8 <unlink>
    2e96:	2c051863          	bnez	a0,3166 <subdir+0x58a>
  if(unlink("dd/ff") != 0){
    2e9a:	00003517          	auipc	a0,0x3
    2e9e:	46e50513          	addi	a0,a0,1134 # 6308 <malloc+0x1394>
    2ea2:	427010ef          	jal	4ac8 <unlink>
    2ea6:	2c051a63          	bnez	a0,317a <subdir+0x59e>
  if(unlink("dd") == 0){
    2eaa:	00003517          	auipc	a0,0x3
    2eae:	43e50513          	addi	a0,a0,1086 # 62e8 <malloc+0x1374>
    2eb2:	417010ef          	jal	4ac8 <unlink>
    2eb6:	2c050c63          	beqz	a0,318e <subdir+0x5b2>
  if(unlink("dd/dd") < 0){
    2eba:	00004517          	auipc	a0,0x4
    2ebe:	96650513          	addi	a0,a0,-1690 # 6820 <malloc+0x18ac>
    2ec2:	407010ef          	jal	4ac8 <unlink>
    2ec6:	2c054e63          	bltz	a0,31a2 <subdir+0x5c6>
  if(unlink("dd") < 0){
    2eca:	00003517          	auipc	a0,0x3
    2ece:	41e50513          	addi	a0,a0,1054 # 62e8 <malloc+0x1374>
    2ed2:	3f7010ef          	jal	4ac8 <unlink>
    ...
    2eec:	40850513          	addi	a0,a0,1032 # 62f0 <malloc+0x137c>
    2ef0:	7d1010ef          	jal	4ec0 <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f00:	41450513          	addi	a0,a0,1044 # 6310 <malloc+0x139c>
    2f04:	7bd010ef          	jal	4ec0 <printf>
    exit(1);
    2f08:	4505                	li	a0,1
    ...
    2f14:	42050513          	addi	a0,a0,1056 # 6330 <malloc+0x13bc>
    2f18:	7a9010ef          	jal	4ec0 <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f28:	44450513          	addi	a0,a0,1092 # 6368 <malloc+0x13f4>
    2f2c:	795010ef          	jal	4ec0 <printf>
    exit(1);
    2f30:	4505                	li	a0,1
    ...
    2f3c:	46050513          	addi	a0,a0,1120 # 6398 <malloc+0x1424>
    2f40:	781010ef          	jal	4ec0 <printf>
    exit(1);
    2f44:	4505                	li	a0,1
    ...
    2f50:	48450513          	addi	a0,a0,1156 # 63d0 <malloc+0x145c>
    2f54:	76d010ef          	jal	4ec0 <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f64:	49050513          	addi	a0,a0,1168 # 63f0 <malloc+0x147c>
    2f68:	759010ef          	jal	4ec0 <printf>
    exit(1);
    2f6c:	4505                	li	a0,1
    ...
    2f78:	4ac50513          	addi	a0,a0,1196 # 6420 <malloc+0x14ac>
    2f7c:	745010ef          	jal	4ec0 <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f8c:	4c050513          	addi	a0,a0,1216 # 6448 <malloc+0x14d4>
    2f90:	731010ef          	jal	4ec0 <printf>
    exit(1);
    2f94:	4505                	li	a0,1
    ...
    2fa0:	4cc50513          	addi	a0,a0,1228 # 6468 <malloc+0x14f4>
    2fa4:	71d010ef          	jal	4ec0 <printf>
    exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2fb4:	4e050513          	addi	a0,a0,1248 # 6490 <malloc+0x151c>
    2fb8:	709010ef          	jal	4ec0 <printf>
    exit(1);
    2fbc:	4505                	li	a0,1
    ...
    2fc8:	4f450513          	addi	a0,a0,1268 # 64b8 <malloc+0x1544>
    2fcc:	6f5010ef          	jal	4ec0 <printf>
    exit(1);
    2fd0:	4505                	li	a0,1
    ...
    2fdc:	51050513          	addi	a0,a0,1296 # 64e8 <malloc+0x1574>
    2fe0:	6e1010ef          	jal	4ec0 <printf>
    exit(1);
    2fe4:	4505                	li	a0,1
    ...
    2ff0:	52c50513          	addi	a0,a0,1324 # 6518 <malloc+0x15a4>
    2ff4:	6cd010ef          	jal	4ec0 <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3004:	53050513          	addi	a0,a0,1328 # 6530 <malloc+0x15bc>
    3008:	6b9010ef          	jal	4ec0 <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    3018:	53c50513          	addi	a0,a0,1340 # 6550 <malloc+0x15dc>
    301c:	6a5010ef          	jal	4ec0 <printf>
    exit(1);
    3020:	4505                	li	a0,1
    ...
    302c:	54850513          	addi	a0,a0,1352 # 6570 <malloc+0x15fc>
    3030:	691010ef          	jal	4ec0 <printf>
    exit(1);
    3034:	4505                	li	a0,1
    ...
    3040:	57450513          	addi	a0,a0,1396 # 65b0 <malloc+0x163c>
    3044:	67d010ef          	jal	4ec0 <printf>
    exit(1);
    3048:	4505                	li	a0,1
    ...
    3054:	59050513          	addi	a0,a0,1424 # 65e0 <malloc+0x166c>
    3058:	669010ef          	jal	4ec0 <printf>
    exit(1);
    305c:	4505                	li	a0,1
    ...
    3068:	59c50513          	addi	a0,a0,1436 # 6600 <malloc+0x168c>
    306c:	655010ef          	jal	4ec0 <printf>
    exit(1);
    3070:	4505                	li	a0,1
    ...
    307c:	5a850513          	addi	a0,a0,1448 # 6620 <malloc+0x16ac>
    3080:	641010ef          	jal	4ec0 <printf>
    exit(1);
    3084:	4505                	li	a0,1
    ...
    3090:	5b450513          	addi	a0,a0,1460 # 6640 <malloc+0x16cc>
    3094:	62d010ef          	jal	4ec0 <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a4:	5d050513          	addi	a0,a0,1488 # 6670 <malloc+0x16fc>
    30a8:	619010ef          	jal	4ec0 <printf>
    exit(1);
    30ac:	4505                	li	a0,1
    ...
    30b8:	5e450513          	addi	a0,a0,1508 # 6698 <malloc+0x1724>
    30bc:	605010ef          	jal	4ec0 <printf>
    exit(1);
    30c0:	4505                	li	a0,1
    ...
    30cc:	5f850513          	addi	a0,a0,1528 # 66c0 <malloc+0x174c>
    30d0:	5f1010ef          	jal	4ec0 <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    ...
    30e0:	60c50513          	addi	a0,a0,1548 # 66e8 <malloc+0x1774>
    30e4:	5dd010ef          	jal	4ec0 <printf>
    exit(1);
    30e8:	4505                	li	a0,1
    ...
    30f4:	61850513          	addi	a0,a0,1560 # 6708 <malloc+0x1794>
    ...
    3108:	62450513          	addi	a0,a0,1572 # 6728 <malloc+0x17b4>
    ...
    311c:	63850513          	addi	a0,a0,1592 # 6750 <malloc+0x17dc>
    3120:	5a1010ef          	jal	4ec0 <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3130:	64450513          	addi	a0,a0,1604 # 6770 <malloc+0x17fc>
    3134:	58d010ef          	jal	4ec0 <printf>
    exit(1);
    3138:	4505                	li	a0,1
    ...
    3144:	65050513          	addi	a0,a0,1616 # 6790 <malloc+0x181c>
    3148:	579010ef          	jal	4ec0 <printf>
    exit(1);
    314c:	4505                	li	a0,1
    ...
    3158:	66450513          	addi	a0,a0,1636 # 67b8 <malloc+0x1844>
    ...
    316c:	2e050513          	addi	a0,a0,736 # 6448 <malloc+0x14d4>
    ...
    3180:	65c50513          	addi	a0,a0,1628 # 67d8 <malloc+0x1864>
    3184:	53d010ef          	jal	4ec0 <printf>
    exit(1);
    3188:	4505                	li	a0,1
    ...
    3194:	66850513          	addi	a0,a0,1640 # 67f8 <malloc+0x1884>
    3198:	529010ef          	jal	4ec0 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31a8:	68450513          	addi	a0,a0,1668 # 6828 <malloc+0x18b4>
    31ac:	515010ef          	jal	4ec0 <printf>
    exit(1);
    31b0:	4505                	li	a0,1
    ...
    31bc:	69050513          	addi	a0,a0,1680 # 6848 <malloc+0x18d4>
    31c0:	501010ef          	jal	4ec0 <printf>
    exit(1);
    31c4:	4505                	li	a0,1
...
00000000000031ca <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    31da:	68a50513          	addi	a0,a0,1674 # 6860 <malloc+0x18ec>
    31de:	103010ef          	jal	4ae0 <mkdir>
    31e2:	e53d                	bnez	a0,3250 <rmdot+0x86>
  if(chdir("dots") != 0){
    31e4:	00003517          	auipc	a0,0x3
    31e8:	67c50513          	addi	a0,a0,1660 # 6860 <malloc+0x18ec>
    31ec:	0fd010ef          	jal	4ae8 <chdir>
    31f0:	e935                	bnez	a0,3264 <rmdot+0x9a>
  if(unlink(".") == 0){
    31f2:	00002517          	auipc	a0,0x2
    31f6:	59e50513          	addi	a0,a0,1438 # 5790 <malloc+0x81c>
    31fa:	0cf010ef          	jal	4ac8 <unlink>
    31fe:	cd2d                	beqz	a0,3278 <rmdot+0xae>
  if(unlink("..") == 0){
    3200:	00003517          	auipc	a0,0x3
    3204:	0b050513          	addi	a0,a0,176 # 62b0 <malloc+0x133c>
    3208:	0c1010ef          	jal	4ac8 <unlink>
    320c:	c141                	beqz	a0,328c <rmdot+0xc2>
  if(chdir("/") != 0){
    320e:	00003517          	auipc	a0,0x3
    3212:	04a50513          	addi	a0,a0,74 # 6258 <malloc+0x12e4>
    3216:	0d3010ef          	jal	4ae8 <chdir>
    321a:	e159                	bnez	a0,32a0 <rmdot+0xd6>
  if(unlink("dots/.") == 0){
    321c:	00003517          	auipc	a0,0x3
    3220:	6ac50513          	addi	a0,a0,1708 # 68c8 <malloc+0x1954>
    3224:	0a5010ef          	jal	4ac8 <unlink>
    3228:	c551                	beqz	a0,32b4 <rmdot+0xea>
  if(unlink("dots/..") == 0){
    322a:	00003517          	auipc	a0,0x3
    322e:	6c650513          	addi	a0,a0,1734 # 68f0 <malloc+0x197c>
    3232:	097010ef          	jal	4ac8 <unlink>
    3236:	c949                	beqz	a0,32c8 <rmdot+0xfe>
  if(unlink("dots") != 0){
    3238:	00003517          	auipc	a0,0x3
    323c:	62850513          	addi	a0,a0,1576 # 6860 <malloc+0x18ec>
    3240:	089010ef          	jal	4ac8 <unlink>
    ...
    3256:	61650513          	addi	a0,a0,1558 # 6868 <malloc+0x18f4>
    325a:	467010ef          	jal	4ec0 <printf>
    exit(1);
    325e:	4505                	li	a0,1
    ...
    326a:	61a50513          	addi	a0,a0,1562 # 6880 <malloc+0x190c>
    326e:	453010ef          	jal	4ec0 <printf>
    exit(1);
    3272:	4505                	li	a0,1
    ...
    327e:	61e50513          	addi	a0,a0,1566 # 6898 <malloc+0x1924>
    3282:	43f010ef          	jal	4ec0 <printf>
    exit(1);
    3286:	4505                	li	a0,1
    ...
    3292:	62250513          	addi	a0,a0,1570 # 68b0 <malloc+0x193c>
    3296:	42b010ef          	jal	4ec0 <printf>
    exit(1);
    329a:	4505                	li	a0,1
    ...
    32a6:	fbe50513          	addi	a0,a0,-66 # 6260 <malloc+0x12ec>
    32aa:	417010ef          	jal	4ec0 <printf>
    exit(1);
    32ae:	4505                	li	a0,1
    ...
    32ba:	61a50513          	addi	a0,a0,1562 # 68d0 <malloc+0x195c>
    32be:	403010ef          	jal	4ec0 <printf>
    exit(1);
    32c2:	4505                	li	a0,1
    ...
    32ce:	62e50513          	addi	a0,a0,1582 # 68f8 <malloc+0x1984>
    32d2:	3ef010ef          	jal	4ec0 <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e2:	63a50513          	addi	a0,a0,1594 # 6918 <malloc+0x19a4>
    32e6:	3db010ef          	jal	4ec0 <printf>
    exit(1);
    32ea:	4505                	li	a0,1
...
00000000000032f0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3306:	63650513          	addi	a0,a0,1590 # 6938 <malloc+0x19c4>
    330a:	7ae010ef          	jal	4ab8 <open>
  if(fd < 0){
    330e:	0c054563          	bltz	a0,33d8 <dirfile+0xe8>
  close(fd);
    3312:	007010ef          	jal	4b18 <close>
  if(chdir("dirfile") == 0){
    3316:	00003517          	auipc	a0,0x3
    331a:	62250513          	addi	a0,a0,1570 # 6938 <malloc+0x19c4>
    331e:	7ca010ef          	jal	4ae8 <chdir>
    3322:	c569                	beqz	a0,33ec <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3324:	4581                	li	a1,0
    3326:	00003517          	auipc	a0,0x3
    332a:	65a50513          	addi	a0,a0,1626 # 6980 <malloc+0x1a0c>
    332e:	78a010ef          	jal	4ab8 <open>
  if(fd >= 0){
    3332:	0c055763          	bgez	a0,3400 <dirfile+0x110>
  fd = open("dirfile/xx", O_CREATE);
    3336:	20000593          	li	a1,512
    333a:	00003517          	auipc	a0,0x3
    333e:	64650513          	addi	a0,a0,1606 # 6980 <malloc+0x1a0c>
    3342:	776010ef          	jal	4ab8 <open>
  if(fd >= 0){
    3346:	0c055763          	bgez	a0,3414 <dirfile+0x124>
  if(mkdir("dirfile/xx") == 0){
    334a:	00003517          	auipc	a0,0x3
    334e:	63650513          	addi	a0,a0,1590 # 6980 <malloc+0x1a0c>
    3352:	78e010ef          	jal	4ae0 <mkdir>
    3356:	0c050963          	beqz	a0,3428 <dirfile+0x138>
  if(unlink("dirfile/xx") == 0){
    335a:	00003517          	auipc	a0,0x3
    335e:	62650513          	addi	a0,a0,1574 # 6980 <malloc+0x1a0c>
    3362:	766010ef          	jal	4ac8 <unlink>
    3366:	0c050b63          	beqz	a0,343c <dirfile+0x14c>
  if(link("README", "dirfile/xx") == 0){
    336a:	00003597          	auipc	a1,0x3
    336e:	61658593          	addi	a1,a1,1558 # 6980 <malloc+0x1a0c>
    3372:	00002517          	auipc	a0,0x2
    3376:	f0e50513          	addi	a0,a0,-242 # 5280 <malloc+0x30c>
    337a:	75e010ef          	jal	4ad8 <link>
    337e:	0c050963          	beqz	a0,3450 <dirfile+0x160>
  if(unlink("dirfile") != 0){
    3382:	00003517          	auipc	a0,0x3
    3386:	5b650513          	addi	a0,a0,1462 # 6938 <malloc+0x19c4>
    338a:	73e010ef          	jal	4ac8 <unlink>
    338e:	0c051b63          	bnez	a0,3464 <dirfile+0x174>
  fd = open(".", O_RDWR);
    3392:	4589                	li	a1,2
    3394:	00002517          	auipc	a0,0x2
    3398:	3fc50513          	addi	a0,a0,1020 # 5790 <malloc+0x81c>
    339c:	71c010ef          	jal	4ab8 <open>
  if(fd >= 0){
    33a0:	0c055c63          	bgez	a0,3478 <dirfile+0x188>
  fd = open(".", 0);
    33a4:	4581                	li	a1,0
    33a6:	00002517          	auipc	a0,0x2
    33aa:	3ea50513          	addi	a0,a0,1002 # 5790 <malloc+0x81c>
    33ae:	70a010ef          	jal	4ab8 <open>
    33b2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    33b4:	4605                	li	a2,1
    33b6:	00002597          	auipc	a1,0x2
    33ba:	d6258593          	addi	a1,a1,-670 # 5118 <malloc+0x1a4>
    33be:	6e2010ef          	jal	4aa0 <write>
    33c2:	0ca04563          	bgtz	a0,348c <dirfile+0x19c>
  close(fd);
    33c6:	8526                	mv	a0,s1
    33c8:	750010ef          	jal	4b18 <close>
}
    ...
    33de:	56650513          	addi	a0,a0,1382 # 6940 <malloc+0x19cc>
    33e2:	2df010ef          	jal	4ec0 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	57250513          	addi	a0,a0,1394 # 6960 <malloc+0x19ec>
    33f6:	2cb010ef          	jal	4ec0 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	58e50513          	addi	a0,a0,1422 # 6990 <malloc+0x1a1c>
    340a:	2b7010ef          	jal	4ec0 <printf>
    exit(1);
    340e:	4505                	li	a0,1
    ...
    341a:	57a50513          	addi	a0,a0,1402 # 6990 <malloc+0x1a1c>
    341e:	2a3010ef          	jal	4ec0 <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    342e:	58e50513          	addi	a0,a0,1422 # 69b8 <malloc+0x1a44>
    3432:	28f010ef          	jal	4ec0 <printf>
    exit(1);
    3436:	4505                	li	a0,1
    ...
    3442:	5a250513          	addi	a0,a0,1442 # 69e0 <malloc+0x1a6c>
    3446:	27b010ef          	jal	4ec0 <printf>
    exit(1);
    344a:	4505                	li	a0,1
    ...
    3456:	5b650513          	addi	a0,a0,1462 # 6a08 <malloc+0x1a94>
    345a:	267010ef          	jal	4ec0 <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346a:	5ca50513          	addi	a0,a0,1482 # 6a30 <malloc+0x1abc>
    346e:	253010ef          	jal	4ec0 <printf>
    exit(1);
    3472:	4505                	li	a0,1
    ...
    347e:	5d650513          	addi	a0,a0,1494 # 6a50 <malloc+0x1adc>
    3482:	23f010ef          	jal	4ec0 <printf>
    exit(1);
    3486:	4505                	li	a0,1
    ...
    3492:	5ea50513          	addi	a0,a0,1514 # 6a78 <malloc+0x1b04>
    3496:	22b010ef          	jal	4ec0 <printf>
    exit(1);
    349a:	4505                	li	a0,1
...
00000000000034a0 <iref>:
{
    ...
    34be:	5d6a0a13          	addi	s4,s4,1494 # 6a90 <malloc+0x1b1c>
    mkdir("");
    34c2:	00003497          	auipc	s1,0x3
    34c6:	0d648493          	addi	s1,s1,214 # 6598 <malloc+0x1624>
    link("README", "");
    34ca:	00002a97          	auipc	s5,0x2
    34ce:	db6a8a93          	addi	s5,s5,-586 # 5280 <malloc+0x30c>
    fd = open("xx", O_CREATE);
    34d2:	00003997          	auipc	s3,0x3
    34d6:	4b698993          	addi	s3,s3,1206 # 6988 <malloc+0x1a14>
    34da:	a835                	j	3516 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34dc:	85da                	mv	a1,s6
    34de:	00003517          	auipc	a0,0x3
    34e2:	5ba50513          	addi	a0,a0,1466 # 6a98 <malloc+0x1b24>
    34e6:	1db010ef          	jal	4ec0 <printf>
      exit(1);
    34ea:	4505                	li	a0,1
    ...
    34f6:	5be50513          	addi	a0,a0,1470 # 6ab0 <malloc+0x1b3c>
    34fa:	1c7010ef          	jal	4ec0 <printf>
      exit(1);
    34fe:	4505                	li	a0,1
    3500:	580010ef          	jal	4a80 <exit>
      close(fd);
    3504:	614010ef          	jal	4b18 <close>
    3508:	a82d                	j	3542 <iref+0xa2>
    unlink("xx");
    350a:	854e                	mv	a0,s3
    350c:	5bc010ef          	jal	4ac8 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    3510:	397d                	addiw	s2,s2,-1
    3512:	04090263          	beqz	s2,3556 <iref+0xb6>
    if(mkdir("irefd") != 0){
    3516:	8552                	mv	a0,s4
    3518:	5c8010ef          	jal	4ae0 <mkdir>
    351c:	f161                	bnez	a0,34dc <iref+0x3c>
    if(chdir("irefd") != 0){
    351e:	8552                	mv	a0,s4
    3520:	5c8010ef          	jal	4ae8 <chdir>
    3524:	f571                	bnez	a0,34f0 <iref+0x50>
    mkdir("");
    3526:	8526                	mv	a0,s1
    3528:	5b8010ef          	jal	4ae0 <mkdir>
    link("README", "");
    352c:	85a6                	mv	a1,s1
    352e:	8556                	mv	a0,s5
    3530:	5a8010ef          	jal	4ad8 <link>
    fd = open("", O_CREATE);
    3534:	20000593          	li	a1,512
    3538:	8526                	mv	a0,s1
    353a:	57e010ef          	jal	4ab8 <open>
    if(fd >= 0)
    353e:	fc0553e3          	bgez	a0,3504 <iref+0x64>
    fd = open("xx", O_CREATE);
    3542:	20000593          	li	a1,512
    3546:	854e                	mv	a0,s3
    3548:	570010ef          	jal	4ab8 <open>
    if(fd >= 0)
    354c:	fa054fe3          	bltz	a0,350a <iref+0x6a>
      close(fd);
    3550:	5c8010ef          	jal	4b18 <close>
    3554:	bf5d                	j	350a <iref+0x6a>
    3556:	03300493          	li	s1,51
    chdir("..");
    355a:	00003997          	auipc	s3,0x3
    355e:	d5698993          	addi	s3,s3,-682 # 62b0 <malloc+0x133c>
    unlink("irefd");
    3562:	00003917          	auipc	s2,0x3
    3566:	52e90913          	addi	s2,s2,1326 # 6a90 <malloc+0x1b1c>
    chdir("..");
    356a:	854e                	mv	a0,s3
    356c:	57c010ef          	jal	4ae8 <chdir>
    unlink("irefd");
    3570:	854a                	mv	a0,s2
    3572:	556010ef          	jal	4ac8 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    3576:	34fd                	addiw	s1,s1,-1
    3578:	f8ed                	bnez	s1,356a <iref+0xca>
  chdir("/");
    357a:	00003517          	auipc	a0,0x3
    357e:	cde50513          	addi	a0,a0,-802 # 6258 <malloc+0x12e4>
    3582:	566010ef          	jal	4ae8 <chdir>
}
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35aa:	52250513          	addi	a0,a0,1314 # 6ac8 <malloc+0x1b54>
    35ae:	532010ef          	jal	4ae0 <mkdir>
  ...
  if(pid == 0){
    ...
    35c6:	50650513          	addi	a0,a0,1286 # 6ac8 <malloc+0x1b54>
    35ca:	4ee010ef          	jal	4ab8 <open>
    if(fd >= 0){
    35ce:	04054063          	bltz	a0,360e <openiputtest+0x74>
      printf("%s: open directory for write succeeded\n", s);
    35d2:	85a6                	mv	a1,s1
    35d4:	00003517          	auipc	a0,0x3
    35d8:	51450513          	addi	a0,a0,1300 # 6ae8 <malloc+0x1b74>
    35dc:	0e5010ef          	jal	4ec0 <printf>
      exit(1);
    35e0:	4505                	li	a0,1
    ...
    35ec:	4e850513          	addi	a0,a0,1256 # 6ad0 <malloc+0x1b5c>
    35f0:	0d1010ef          	jal	4ec0 <printf>
    exit(1);
    35f4:	4505                	li	a0,1
    ...
    3600:	33c50513          	addi	a0,a0,828 # 5938 <malloc+0x9c4>
    3604:	0bd010ef          	jal	4ec0 <printf>
    exit(1);
    3608:	4505                	li	a0,1
  ...
  sleep(1);
    3614:	4505                	li	a0,1
    3616:	4f2010ef          	jal	4b08 <sleep>
  if(unlink("oidir") != 0){
    361a:	00003517          	auipc	a0,0x3
    361e:	4ae50513          	addi	a0,a0,1198 # 6ac8 <malloc+0x1b54>
    3622:	4a6010ef          	jal	4ac8 <unlink>
    3626:	c919                	beqz	a0,363c <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3628:	85a6                	mv	a1,s1
    362a:	00002517          	auipc	a0,0x2
    362e:	4fe50513          	addi	a0,a0,1278 # 5b28 <malloc+0xbb4>
    3632:	08f010ef          	jal	4ec0 <printf>
    exit(1);
    3636:	4505                	li	a0,1
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    365c:	4b850513          	addi	a0,a0,1208 # 6b10 <malloc+0x1b9c>
    3660:	468010ef          	jal	4ac8 <unlink>
  int pid = fork();
  ...
  sleep(20); // two seconds
    366e:	4551                	li	a0,20
    3670:	498010ef          	jal	4b08 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    3674:	20200593          	li	a1,514
    3678:	00003517          	auipc	a0,0x3
    367c:	49850513          	addi	a0,a0,1176 # 6b10 <malloc+0x1b9c>
    3680:	438010ef          	jal	4ab8 <open>
    3684:	494010ef          	jal	4b18 <close>
  wait(0);
    3688:	4501                	li	a0,0
    368a:	3fe010ef          	jal	4a88 <wait>
  sleep(10); // one second
    368e:	4529                	li	a0,10
    3690:	478010ef          	jal	4b08 <sleep>
}
    ...
    36a4:	45850513          	addi	a0,a0,1112 # 5af8 <malloc+0xb84>
    36a8:	019010ef          	jal	4ec0 <printf>
    exit(1);
    36ac:	4505                	li	a0,1
    36ae:	3d2010ef          	jal	4a80 <exit>
      int fd = open("stopforking", 0);
    36b2:	00003497          	auipc	s1,0x3
    36b6:	45e48493          	addi	s1,s1,1118 # 6b10 <malloc+0x1b9c>
    36ba:	4581                	li	a1,0
    36bc:	8526                	mv	a0,s1
    36be:	3fa010ef          	jal	4ab8 <open>
      if(fd >= 0){
    ...
    36d6:	43e50513          	addi	a0,a0,1086 # 6b10 <malloc+0x1b9c>
    36da:	3de010ef          	jal	4ab8 <open>
    36de:	43a010ef          	jal	4b18 <close>
...
00000000000036ea <killstatus>:
{
    ...
    sleep(1);
    370e:	4505                	li	a0,1
    3710:	3f8010ef          	jal	4b08 <sleep>
    kill(pid1);
    3714:	8526                	mv	a0,s1
    3716:	392010ef          	jal	4aa8 <kill>
    wait(&xst);
  ...
  exit(0);
    ...
    373c:	20050513          	addi	a0,a0,512 # 5938 <malloc+0x9c4>
    3740:	780010ef          	jal	4ec0 <printf>
      exit(1);
    3744:	4505                	li	a0,1
    3746:	33a010ef          	jal	4a80 <exit>
        getpid();
    374a:	3ae010ef          	jal	4af8 <getpid>
      while(1) {
    374e:	bff5                	j	374a <killstatus+0x60>
       printf("%s: status should be -1\n", s);
    3750:	85d2                	mv	a1,s4
    3752:	00003517          	auipc	a0,0x3
    3756:	3ce50513          	addi	a0,a0,974 # 6b20 <malloc+0x1bac>
    375a:	766010ef          	jal	4ec0 <printf>
       exit(1);
    375e:	4505                	li	a0,1
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    378a:	37250513          	addi	a0,a0,882 # 5af8 <malloc+0xb84>
    378e:	732010ef          	jal	4ec0 <printf>
    exit(1);
    3792:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    37ac:	19050513          	addi	a0,a0,400 # 5938 <malloc+0x9c4>
    37b0:	710010ef          	jal	4ec0 <printf>
    exit(1);
    37b4:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37d2:	346010ef          	jal	4b18 <close>
    if(write(pfds[1], "x", 1) != 1)
    37d6:	4605                	li	a2,1
    37d8:	00002597          	auipc	a1,0x2
    37dc:	94058593          	addi	a1,a1,-1728 # 5118 <malloc+0x1a4>
    ...
    37f2:	326010ef          	jal	4b18 <close>
    for(;;)
    37f6:	a001                	j	37f6 <preempt+0x92>
     printf("%s: fork failed\n", s);
    37f8:	85ca                	mv	a1,s2
    37fa:	00002517          	auipc	a0,0x2
    37fe:	13e50513          	addi	a0,a0,318 # 5938 <malloc+0x9c4>
    3802:	6be010ef          	jal	4ec0 <printf>
     exit(1);
    3806:	4505                	li	a0,1
    ...
    3812:	33250513          	addi	a0,a0,818 # 6b40 <malloc+0x1bcc>
    3816:	6aa010ef          	jal	4ec0 <printf>
    381a:	bfd1                	j	37ee <preempt+0x8a>
  close(pfds[1]);
    381c:	fcc42503          	lw	a0,-52(s0)
    3820:	2f8010ef          	jal	4b18 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3842:	31a50513          	addi	a0,a0,794 # 6b58 <malloc+0x1be4>
    3846:	67a010ef          	jal	4ec0 <printf>
}
  ...
  close(pfds[0]);
    ...
    385e:	2ba010ef          	jal	4b18 <close>
  printf("kill... ");
    3862:	00003517          	auipc	a0,0x3
    3866:	30e50513          	addi	a0,a0,782 # 6b70 <malloc+0x1bfc>
    386a:	656010ef          	jal	4ec0 <printf>
  kill(pid1);
    386e:	8526                	mv	a0,s1
    3870:	238010ef          	jal	4aa8 <kill>
  kill(pid2);
    3874:	854e                	mv	a0,s3
    3876:	232010ef          	jal	4aa8 <kill>
  kill(pid3);
    387a:	8552                	mv	a0,s4
    387c:	22c010ef          	jal	4aa8 <kill>
  printf("wait... ");
    3880:	00003517          	auipc	a0,0x3
    3884:	30050513          	addi	a0,a0,768 # 6b80 <malloc+0x1c0c>
    3888:	638010ef          	jal	4ec0 <printf>
  wait(0);
    388c:	4501                	li	a0,0
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    38e4:	05850513          	addi	a0,a0,88 # 5938 <malloc+0x9c4>
    38e8:	5d8010ef          	jal	4ec0 <printf>
      exit(1);
    38ec:	4505                	li	a0,1
    ...
    38f8:	1cc50513          	addi	a0,a0,460 # 5ac0 <malloc+0xb4c>
    38fc:	5c4010ef          	jal	4ec0 <printf>
        exit(1);
    3900:	4505                	li	a0,1
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3952:	0f250513          	addi	a0,a0,242 # 5a40 <malloc+0xacc>
    3956:	56a010ef          	jal	4ec0 <printf>
    exit(1);
    395a:	4505                	li	a0,1
    395c:	124010ef          	jal	4a80 <exit>
      sbrk(BIG - (uint64)sbrk(0));
    3960:	1a0010ef          	jal	4b00 <sbrk>
    3964:	064007b7          	lui	a5,0x6400
    3968:	40a7853b          	subw	a0,a5,a0
    396c:	194010ef          	jal	4b00 <sbrk>
      write(fds[1], "x", 1);
    3970:	4605                	li	a2,1
    3972:	00001597          	auipc	a1,0x1
    3976:	7a658593          	addi	a1,a1,1958 # 5118 <malloc+0x1a4>
    397a:	fb442503          	lw	a0,-76(s0)
    397e:	122010ef          	jal	4aa0 <write>
      for(;;) sleep(1000);
    3982:	3e800513          	li	a0,1000
    3986:	182010ef          	jal	4b08 <sleep>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3a16:	17e50513          	addi	a0,a0,382 # 6b90 <malloc+0x1c1c>
    3a1a:	4a6010ef          	jal	4ec0 <printf>
    exit(1);
    3a1e:	4505                	li	a0,1
    ...
    3a2a:	f1250513          	addi	a0,a0,-238 # 5938 <malloc+0x9c4>
    3a2e:	492010ef          	jal	4ec0 <printf>
    exit(1);
    3a32:	4505                	li	a0,1
    3a34:	04c010ef          	jal	4a80 <exit>
    a = sbrk(0);
    3a38:	4501                	li	a0,0
    3a3a:	0c6010ef          	jal	4b00 <sbrk>
    3a3e:	892a                	mv	s2,a0
    sbrk(10*BIG);
    3a40:	3e800537          	lui	a0,0x3e800
    3a44:	0bc010ef          	jal	4b00 <sbrk>
    ...
    3a66:	14e50513          	addi	a0,a0,334 # 6bb0 <malloc+0x1c3c>
    3a6a:	456010ef          	jal	4ec0 <printf>
    exit(1);
    3a6e:	4505                	li	a0,1
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3abe:	6084                	ld	s1,0(s1)
      free(m1);
    3ac0:	432010ef          	jal	4ef2 <free>
    while(m1){
    3ac4:	fce5                	bnez	s1,3abc <mem+0x42>
    m1 = malloc(1024*20);
    3ac6:	6515                	lui	a0,0x5
    3ac8:	4ac010ef          	jal	4f74 <malloc>
    if(m1 == 0){
    3acc:	c511                	beqz	a0,3ad8 <mem+0x5e>
    free(m1);
    3ace:	424010ef          	jal	4ef2 <free>
    exit(0);
    3ad2:	4501                	li	a0,0
    ...
    3ade:	10650513          	addi	a0,a0,262 # 6be0 <malloc+0x1c6c>
    3ae2:	3de010ef          	jal	4ec0 <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
...
0000000000003af2 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b02:	10250513          	addi	a0,a0,258 # 6c00 <malloc+0x1c8c>
    3b06:	7c3000ef          	jal	4ac8 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b0a:	20200593          	li	a1,514
    3b0e:	00003517          	auipc	a0,0x3
    3b12:	0f250513          	addi	a0,a0,242 # 6c00 <malloc+0x1c8c>
    3b16:	7a3000ef          	jal	4ab8 <open>
  if(fd < 0){
  ...
  if(pid == 0) {
    ...
    3b7c:	09850513          	addi	a0,a0,152 # 6c10 <malloc+0x1c9c>
    3b80:	340010ef          	jal	4ec0 <printf>
    exit(1);
    3b84:	4505                	li	a0,1
    ...
    3b90:	0ac50513          	addi	a0,a0,172 # 6c38 <malloc+0x1cc4>
    3b94:	32c010ef          	jal	4ec0 <printf>
      exit(1);
    3b98:	4505                	li	a0,1
  ...
  close(fd);
    3bb4:	854a                	mv	a0,s2
    3bb6:	763000ef          	jal	4b18 <close>
  fd = open("sharedfd", 0);
    3bba:	4581                	li	a1,0
    3bbc:	00003517          	auipc	a0,0x3
    3bc0:	04450513          	addi	a0,a0,68 # 6c00 <malloc+0x1c8c>
    3bc4:	6f5000ef          	jal	4ab8 <open>
    3bc8:	8baa                	mv	s7,a0
  nc = np = 0;
    3bca:	8ace                	mv	s5,s3
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bf8:	06450513          	addi	a0,a0,100 # 6c58 <malloc+0x1ce4>
    3bfc:	2c4010ef          	jal	4ec0 <printf>
    exit(1);
    3c00:	4505                	li	a0,1
  ...
  close(fd);
    3c1e:	855e                	mv	a0,s7
    3c20:	6f9000ef          	jal	4b18 <close>
  unlink("sharedfd");
    3c24:	00003517          	auipc	a0,0x3
    3c28:	fdc50513          	addi	a0,a0,-36 # 6c00 <malloc+0x1c8c>
    3c2c:	69d000ef          	jal	4ac8 <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    3c4a:	03a50513          	addi	a0,a0,58 # 6c80 <malloc+0x1d0c>
    3c4e:	272010ef          	jal	4ec0 <printf>
    exit(1);
    3c52:	4505                	li	a0,1
...
0000000000003c5e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c82:	01a78793          	addi	a5,a5,26 # 6c98 <malloc+0x1d24>
    3c86:	f6f43823          	sd	a5,-144(s0)
    3c8a:	00003797          	auipc	a5,0x3
    3c8e:	01678793          	addi	a5,a5,22 # 6ca0 <malloc+0x1d2c>
    3c92:	f6f43c23          	sd	a5,-136(s0)
    3c96:	00003797          	auipc	a5,0x3
    3c9a:	01278793          	addi	a5,a5,18 # 6ca8 <malloc+0x1d34>
    3c9e:	f8f43023          	sd	a5,-128(s0)
    3ca2:	00003797          	auipc	a5,0x3
    3ca6:	00e78793          	addi	a5,a5,14 # 6cb0 <malloc+0x1d3c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d08:	c3450513          	addi	a0,a0,-972 # 5938 <malloc+0x9c4>
    3d0c:	1b4010ef          	jal	4ec0 <printf>
      exit(1);
    3d10:	4505                	li	a0,1
    ...
    3d6a:	c6a50513          	addi	a0,a0,-918 # 59d0 <malloc+0xa5c>
    3d6e:	152010ef          	jal	4ec0 <printf>
        exit(1);
    3d72:	4505                	li	a0,1
    3d74:	50d000ef          	jal	4a80 <exit>
          printf("write failed %d\n", n);
    3d78:	00003517          	auipc	a0,0x3
    3d7c:	f4050513          	addi	a0,a0,-192 # 6cb8 <malloc+0x1d44>
    3d80:	140010ef          	jal	4ec0 <printf>
          exit(1);
    3d84:	4505                	li	a0,1
    ...
    3d96:	f3e50513          	addi	a0,a0,-194 # 6cd0 <malloc+0x1d5c>
    3d9a:	126010ef          	jal	4ec0 <printf>
          exit(1);
    3d9e:	4505                	li	a0,1
    ...
    close(fd);
    3dd2:	854e                	mv	a0,s3
    3dd4:	545000ef          	jal	4b18 <close>
    if(total != N*SZ){
    3dd8:	03a91463          	bne	s2,s10,3e00 <fourfiles+0x1a2>
    unlink(fname);
    3ddc:	8562                	mv	a0,s8
    3dde:	4eb000ef          	jal	4ac8 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    3e06:	ede50513          	addi	a0,a0,-290 # 6ce0 <malloc+0x1d6c>
    3e0a:	0b6010ef          	jal	4ec0 <printf>
      exit(1);
    3e0e:	4505                	li	a0,1
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e60:	e9cb8b93          	addi	s7,s7,-356 # 6cf8 <malloc+0x1d84>
  for(i = 0; i < N; i++){
    ...
    3e8a:	42f000ef          	jal	4ab8 <open>
      if(fd < 0){
    3e8e:	1e055063          	bgez	a0,406e <concreate+0x23c>
        printf("concreate create %s failed\n", file);
    3e92:	fa840593          	addi	a1,s0,-88
    3e96:	00003517          	auipc	a0,0x3
    3e9a:	e6a50513          	addi	a0,a0,-406 # 6d00 <malloc+0x1d8c>
    3e9e:	022010ef          	jal	4ec0 <printf>
        exit(1);
    3ea2:	4505                	li	a0,1
    ...
    3eb0:	e4c50513          	addi	a0,a0,-436 # 6cf8 <malloc+0x1d84>
    3eb4:	425000ef          	jal	4ad8 <link>
      exit(0);
    3eb8:	4501                	li	a0,0
  ...
  fd = open(".", 0);
    ...
    3ed8:	8bc50513          	addi	a0,a0,-1860 # 5790 <malloc+0x81c>
    3edc:	3dd000ef          	jal	4ab8 <open>
    3ee0:	892a                	mv	s2,a0
  n = 0;
    3ee2:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f48:	ddc50513          	addi	a0,a0,-548 # 6d20 <malloc+0x1dac>
    3f4c:	775000ef          	jal	4ec0 <printf>
        exit(1);
    3f50:	4505                	li	a0,1
    ...
    3f60:	de450513          	addi	a0,a0,-540 # 6d40 <malloc+0x1dcc>
  ...
  for(i = 0; i < N; i++){
    ...
    3f8c:	de050513          	addi	a0,a0,-544 # 6d68 <malloc+0x1df4>
    3f90:	731000ef          	jal	4ec0 <printf>
    exit(1);
    3f94:	4505                	li	a0,1
    ...
    3fa0:	99c50513          	addi	a0,a0,-1636 # 5938 <malloc+0x9c4>
    3fa4:	71d000ef          	jal	4ec0 <printf>
      exit(1);
    3fa8:	4505                	li	a0,1
    ...
    3fb4:	305000ef          	jal	4ab8 <open>
    3fb8:	361000ef          	jal	4b18 <close>
      close(open(file, 0));
    3fbc:	4581                	li	a1,0
    3fbe:	fa840513          	addi	a0,s0,-88
    3fc2:	2f7000ef          	jal	4ab8 <open>
    3fc6:	353000ef          	jal	4b18 <close>
      close(open(file, 0));
    3fca:	4581                	li	a1,0
    3fcc:	fa840513          	addi	a0,s0,-88
    3fd0:	2e9000ef          	jal	4ab8 <open>
    3fd4:	345000ef          	jal	4b18 <close>
      close(open(file, 0));
    3fd8:	4581                	li	a1,0
    3fda:	fa840513          	addi	a0,s0,-88
    3fde:	2db000ef          	jal	4ab8 <open>
    3fe2:	337000ef          	jal	4b18 <close>
      close(open(file, 0));
    3fe6:	4581                	li	a1,0
    3fe8:	fa840513          	addi	a0,s0,-88
    3fec:	2cd000ef          	jal	4ab8 <open>
    3ff0:	329000ef          	jal	4b18 <close>
      close(open(file, 0));
    3ff4:	4581                	li	a1,0
    3ff6:	fa840513          	addi	a0,s0,-88
    3ffa:	2bf000ef          	jal	4ab8 <open>
    3ffe:	31b000ef          	jal	4b18 <close>
    if(pid == 0)
  ...
  for(i = 0; i < N; i++){
    ...
    403a:	28f000ef          	jal	4ac8 <unlink>
      unlink(file);
    403e:	fa840513          	addi	a0,s0,-88
    4042:	287000ef          	jal	4ac8 <unlink>
      unlink(file);
    4046:	fa840513          	addi	a0,s0,-88
    404a:	27f000ef          	jal	4ac8 <unlink>
      unlink(file);
    404e:	fa840513          	addi	a0,s0,-88
    4052:	277000ef          	jal	4ac8 <unlink>
      unlink(file);
    4056:	fa840513          	addi	a0,s0,-88
    405a:	26f000ef          	jal	4ac8 <unlink>
      unlink(file);
    405e:	fa840513          	addi	a0,s0,-88
    4062:	267000ef          	jal	4ac8 <unlink>
    4066:	bf71                	j	4002 <concreate+0x1d0>
      exit(0);
    4068:	4501                	li	a0,0
    406a:	217000ef          	jal	4a80 <exit>
      close(fd);
    406e:	2ab000ef          	jal	4b18 <close>
    if(pid == 0) {
    4072:	b599                	j	3eb8 <concreate+0x86>
      close(fd);
    4074:	2a5000ef          	jal	4b18 <close>
      wait(&xstatus);
...
00000000000040d6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ee:	cb650513          	addi	a0,a0,-842 # 6da0 <malloc+0x1e2c>
    40f2:	1d7000ef          	jal	4ac8 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40f6:	20200593          	li	a1,514
    40fa:	00003517          	auipc	a0,0x3
    40fe:	ca650513          	addi	a0,a0,-858 # 6da0 <malloc+0x1e2c>
    4102:	1b7000ef          	jal	4ab8 <open>
    4106:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4108:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  close(fd);
    413e:	854e                	mv	a0,s3
    4140:	1d9000ef          	jal	4b18 <close>
  fd = open("bigfile.dat", 0);
    4144:	4581                	li	a1,0
    4146:	00003517          	auipc	a0,0x3
    414a:	c5a50513          	addi	a0,a0,-934 # 6da0 <malloc+0x1e2c>
    414e:	16b000ef          	jal	4ab8 <open>
    4152:	8a2a                	mv	s4,a0
  total = 0;
    4154:	4981                	li	s3,0
  for(i = 0; ; i++){
  ...
  for(i = 0; ; i++){
    ...
    41a6:	c0e50513          	addi	a0,a0,-1010 # 6db0 <malloc+0x1e3c>
    41aa:	517000ef          	jal	4ec0 <printf>
    exit(1);
    41ae:	4505                	li	a0,1
    ...
    41ba:	c1a50513          	addi	a0,a0,-998 # 6dd0 <malloc+0x1e5c>
    41be:	503000ef          	jal	4ec0 <printf>
      exit(1);
    41c2:	4505                	li	a0,1
    ...
    41ce:	c2650513          	addi	a0,a0,-986 # 6df0 <malloc+0x1e7c>
    41d2:	4ef000ef          	jal	4ec0 <printf>
    exit(1);
    41d6:	4505                	li	a0,1
    ...
    41e2:	c3250513          	addi	a0,a0,-974 # 6e10 <malloc+0x1e9c>
    41e6:	4db000ef          	jal	4ec0 <printf>
      exit(1);
    41ea:	4505                	li	a0,1
    ...
    41f6:	c3e50513          	addi	a0,a0,-962 # 6e30 <malloc+0x1ebc>
    41fa:	4c7000ef          	jal	4ec0 <printf>
      exit(1);
    41fe:	4505                	li	a0,1
    ...
    420a:	c4250513          	addi	a0,a0,-958 # 6e48 <malloc+0x1ed4>
    420e:	4b3000ef          	jal	4ec0 <printf>
      exit(1);
    4212:	4505                	li	a0,1
    4214:	06d000ef          	jal	4a80 <exit>
  close(fd);
    4218:	8552                	mv	a0,s4
    421a:	0ff000ef          	jal	4b18 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    422c:	b7850513          	addi	a0,a0,-1160 # 6da0 <malloc+0x1e2c>
    4230:	099000ef          	jal	4ac8 <unlink>
}
    ...
    424c:	c2050513          	addi	a0,a0,-992 # 6e68 <malloc+0x1ef4>
    4250:	471000ef          	jal	4ec0 <printf>
    exit(1);
    4254:	4505                	li	a0,1
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426a:	c2250513          	addi	a0,a0,-990 # 6e88 <malloc+0x1f14>
    426e:	05b000ef          	jal	4ac8 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    4290:	bfc50513          	addi	a0,a0,-1028 # 6e88 <malloc+0x1f14>
    4294:	025000ef          	jal	4ab8 <open>
  if(fd < 0){
    4298:	08054663          	bltz	a0,4324 <bigargtest+0xca>
  close(fd);
    429c:	07d000ef          	jal	4b18 <close>
}
    ...
    42ea:	dc250513          	addi	a0,a0,-574 # 50a8 <malloc+0x134>
    42ee:	7c2000ef          	jal	4ab0 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	b9250513          	addi	a0,a0,-1134 # 6e88 <malloc+0x1f14>
    42fe:	7ba000ef          	jal	4ab8 <open>
    close(fd);
    4302:	017000ef          	jal	4b18 <close>
    exit(0);
    4306:	4501                	li	a0,0
    ...
    4312:	b8a50513          	addi	a0,a0,-1142 # 6e98 <malloc+0x1f24>
    4316:	3ab000ef          	jal	4ec0 <printf>
    exit(1);
    431a:	4505                	li	a0,1
    ...
    432a:	b9250513          	addi	a0,a0,-1134 # 6eb8 <malloc+0x1f44>
    432e:	393000ef          	jal	4ec0 <printf>
    exit(1);
    4332:	4505                	li	a0,1
...
0000000000004338 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4358:	b8450513          	addi	a0,a0,-1148 # 6ed8 <malloc+0x1f64>
    435c:	365000ef          	jal	4ec0 <printf>
  for(nfiles = 0; ; nfiles++){
    4360:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4374:	b78c8c93          	addi	s9,s9,-1160 # 6ee8 <malloc+0x1f74>
    name[0] = 'f';
    ...
    43bc:	8566                	mv	a0,s9
    43be:	303000ef          	jal	4ec0 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    43c2:	20200593          	li	a1,514
    43c6:	f6040513          	addi	a0,s0,-160
    43ca:	6ee000ef          	jal	4ab8 <open>
    43ce:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    43dc:	b2050513          	addi	a0,a0,-1248 # 6ef8 <malloc+0x1f84>
    43e0:	2e1000ef          	jal	4ec0 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    444a:	ad250513          	addi	a0,a0,-1326 # 6f18 <malloc+0x1fa4>
    444e:	273000ef          	jal	4ec0 <printf>
}
    ...
    4498:	a7450513          	addi	a0,a0,-1420 # 6f08 <malloc+0x1f94>
    449c:	225000ef          	jal	4ec0 <printf>
    close(fd);
    44a0:	854a                	mv	a0,s2
    44a2:	676000ef          	jal	4b18 <close>
    if(total == 0)
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    44c2:	a7250513          	addi	a0,a0,-1422 # 6f30 <malloc+0x1fbc>
    44c6:	1fb000ef          	jal	4ec0 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    44e6:	a7650513          	addi	a0,a0,-1418 # 6f58 <malloc+0x1fe4>
    44ea:	1d7000ef          	jal	4ec0 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4506:	a3e50513          	addi	a0,a0,-1474 # 6f40 <malloc+0x1fcc>
    450a:	1b7000ef          	jal	4ec0 <printf>
    exit(1);
    450e:	4505                	li	a0,1
    ...
    4522:	a4250513          	addi	a0,a0,-1470 # 6f60 <malloc+0x1fec>
    4526:	19b000ef          	jal	4ec0 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    457a:	9f250513          	addi	a0,a0,-1550 # 6f68 <malloc+0x1ff4>
    457e:	143000ef          	jal	4ec0 <printf>
          return 1;
    4582:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    45da:	b4298993          	addi	s3,s3,-1214 # 5118 <malloc+0x1a4>
      uint64 a = (uint64) sbrk(4096);
    45de:	6505                	lui	a0,0x1
    45e0:	520000ef          	jal	4b00 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    4604:	9c050513          	addi	a0,a0,-1600 # 6fc0 <malloc+0x204c>
    4608:	0b9000ef          	jal	4ec0 <printf>
        exit(1);
    460c:	4505                	li	a0,1
    ...
    461c:	96850513          	addi	a0,a0,-1688 # 6f80 <malloc+0x200c>
    4620:	0a1000ef          	jal	4ec0 <printf>
    exit(1);
    4624:	4505                	li	a0,1
    ...
    4634:	97050513          	addi	a0,a0,-1680 # 6fa0 <malloc+0x202c>
    4638:	089000ef          	jal	4ec0 <printf>
    exit(1);
    463c:	4505                	li	a0,1
  ...
  while(1){
    ...
    4674:	97050513          	addi	a0,a0,-1680 # 6fe0 <malloc+0x206c>
    4678:	049000ef          	jal	4ec0 <printf>
      exit(1);
    467c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    46c2:	942b8b93          	addi	s7,s7,-1726 # 7000 <malloc+0x208c>
    int free0 = countfree();
    int free1 = 0;
    ...
    46dc:	940d0d13          	addi	s10,s10,-1728 # 7018 <malloc+0x20a4>
          return 1;
        }
      }
    }
    ...
    46e4:	958c8c93          	addi	s9,s9,-1704 # 7038 <malloc+0x20c4>
    46e8:	a819                	j	46fe <drivetests+0x62>
        printf("usertests slow tests starting\n");
    46ea:	856a                	mv	a0,s10
    46ec:	7d4000ef          	jal	4ec0 <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    47a0:	8cc58593          	addi	a1,a1,-1844 # 7068 <malloc+0x20f4>
    47a4:	854a                	mv	a0,s2
    ...
    47b2:	8c258593          	addi	a1,a1,-1854 # 7070 <malloc+0x20fc>
    47b6:	854a                	mv	a0,s2
    47b8:	08c000ef          	jal	4844 <strcmp>
    47bc:	cd15                	beqz	a0,47f8 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    47be:	00003597          	auipc	a1,0x3
    47c2:	8ba58593          	addi	a1,a1,-1862 # 7078 <malloc+0x2104>
    47c6:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    47e4:	8a050513          	addi	a0,a0,-1888 # 7080 <malloc+0x210c>
    47e8:	6d8000ef          	jal	4ec0 <printf>
    exit(1);
    47ec:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4808:	8ac50513          	addi	a0,a0,-1876 # 70b0 <malloc+0x213c>
    480c:	6b4000ef          	jal	4ec0 <printf>
  exit(0);
    4810:	4501                	li	a0,0
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
    496a:	85ca                	mv	a1,s2
    496c:	164000ef          	jal	4ad0 <fstat>
    4970:	892a                	mv	s2,a0
  close(fd);
    4972:	8526                	mv	a0,s1
    4974:	1a4000ef          	jal	4b18 <close>
  return r;
...
putc(int fd, char c)
{
    4b48:	1101                	addi	sp,sp,-32
    4b4a:	ec06                	sd	ra,24(sp)
    4b4c:	e822                	sd	s0,16(sp)
    4b4e:	1000                	addi	s0,sp,32
    4b50:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4b54:	4605                	li	a2,1
    4b56:	fef40593          	addi	a1,s0,-17
    4b5a:	f47ff0ef          	jal	4aa0 <write>
}
    4b5e:	60e2                	ld	ra,24(sp)
    4b60:	6442                	ld	s0,16(sp)
    4b62:	6105                	addi	sp,sp,32
    4b64:	8082                	ret

0000000000004b66 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4b66:	7139                	addi	sp,sp,-64
    4b68:	fc06                	sd	ra,56(sp)
    4b6a:	f822                	sd	s0,48(sp)
    4b6c:	f426                	sd	s1,40(sp)
    4b6e:	0080                	addi	s0,sp,64
    4b70:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4b72:	c299                	beqz	a3,4b78 <printint+0x12>
    4b74:	0805c963          	bltz	a1,4c06 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4b78:	2581                	sext.w	a1,a1
  neg = 0;
    4b7a:	4881                	li	a7,0
    4b7c:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4b82:	2601                	sext.w	a2,a2
    4b84:	00003517          	auipc	a0,0x3
    4b88:	8fc50513          	addi	a0,a0,-1796 # 7480 <digits>
    4b8c:	883a                	mv	a6,a4
    4b8e:	2705                	addiw	a4,a4,1
    4b90:	02c5f7bb          	remuw	a5,a1,a2
    4b94:	1782                	slli	a5,a5,0x20
    4b96:	9381                	srli	a5,a5,0x20
    4b98:	97aa                	add	a5,a5,a0
    4b9a:	0007c783          	lbu	a5,0(a5)
    4b9e:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4ba2:	0005879b          	sext.w	a5,a1
    4ba6:	02c5d5bb          	divuw	a1,a1,a2
    4baa:	0685                	addi	a3,a3,1
    4bac:	fec7f0e3          	bgeu	a5,a2,4b8c <printint+0x26>
  if(neg)
    4bb0:	00088c63          	beqz	a7,4bc8 <printint+0x62>
    buf[i++] = '-';
    4bb4:	fd070793          	addi	a5,a4,-48
    4bb8:	00878733          	add	a4,a5,s0
    4bbc:	02d00793          	li	a5,45
    4bc0:	fef70823          	sb	a5,-16(a4)
    4bc4:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4bc8:	02e05a63          	blez	a4,4bfc <printint+0x96>
    4bcc:	f04a                	sd	s2,32(sp)
    4bce:	ec4e                	sd	s3,24(sp)
    4bd0:	fc040793          	addi	a5,s0,-64
    4bd4:	00e78933          	add	s2,a5,a4
    4bd8:	fff78993          	addi	s3,a5,-1
    4bdc:	99ba                	add	s3,s3,a4
    4bde:	377d                	addiw	a4,a4,-1
    4be0:	1702                	slli	a4,a4,0x20
    4be2:	9301                	srli	a4,a4,0x20
    4be4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4be8:	fff94583          	lbu	a1,-1(s2)
    4bec:	8526                	mv	a0,s1
    4bee:	f5bff0ef          	jal	4b48 <putc>
  while(--i >= 0)
    4bf2:	197d                	addi	s2,s2,-1
    4bf4:	ff391ae3          	bne	s2,s3,4be8 <printint+0x82>
    4bf8:	7902                	ld	s2,32(sp)
    4bfa:	69e2                	ld	s3,24(sp)
}
    4bfc:	70e2                	ld	ra,56(sp)
    4bfe:	7442                	ld	s0,48(sp)
    4c00:	74a2                	ld	s1,40(sp)
    4c02:	6121                	addi	sp,sp,64
    4c04:	8082                	ret
    x = -xx;
    4c06:	40b005bb          	negw	a1,a1
    neg = 1;
    4c0a:	4885                	li	a7,1
    x = -xx;
    4c0c:	bf85                	j	4b7c <printint+0x16>

0000000000004c0e <vprintf>:
}
...
{
    4c0e:	711d                	addi	sp,sp,-96
    4c10:	ec86                	sd	ra,88(sp)
    4c12:	e8a2                	sd	s0,80(sp)
    4c14:	e0ca                	sd	s2,64(sp)
    4c16:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4c18:	0005c903          	lbu	s2,0(a1)
    4c1c:	26090863          	beqz	s2,4e8c <vprintf+0x27e>
    4c20:	e4a6                	sd	s1,72(sp)
    4c22:	fc4e                	sd	s3,56(sp)
    4c24:	f852                	sd	s4,48(sp)
    4c26:	f456                	sd	s5,40(sp)
    4c28:	f05a                	sd	s6,32(sp)
    4c2a:	ec5e                	sd	s7,24(sp)
    4c2c:	e862                	sd	s8,16(sp)
    4c2e:	e466                	sd	s9,8(sp)
    4c30:	8b2a                	mv	s6,a0
    4c32:	8a2e                	mv	s4,a1
    4c34:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4c3c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4c40:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4c44:	06c00c93          	li	s9,108
    4c48:	a005                	j	4c68 <vprintf+0x5a>
        putc(fd, c0);
    4c4a:	85ca                	mv	a1,s2
    4c4c:	855a                	mv	a0,s6
    4c4e:	efbff0ef          	jal	4b48 <putc>
    4c52:	a019                	j	4c58 <vprintf+0x4a>
    } else if(state == '%'){
    4c54:	03598263          	beq	s3,s5,4c78 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4c58:	2485                	addiw	s1,s1,1
    4c5a:	8726                	mv	a4,s1
    4c5c:	009a07b3          	add	a5,s4,s1
    4c60:	0007c903          	lbu	s2,0(a5)
    4c64:	20090c63          	beqz	s2,4e7c <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
    4c68:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4c6c:	fe0994e3          	bnez	s3,4c54 <vprintf+0x46>
      if(c0 == '%'){
    4c70:	fd579de3          	bne	a5,s5,4c4a <vprintf+0x3c>
        state = '%';
    4c74:	89be                	mv	s3,a5
    4c76:	b7cd                	j	4c58 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4c78:	00ea06b3          	add	a3,s4,a4
    4c7c:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4c80:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4c82:	c681                	beqz	a3,4c8a <vprintf+0x7c>
    4c84:	9752                	add	a4,a4,s4
    4c86:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4c8a:	03878f63          	beq	a5,s8,4cc8 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
    4c8e:	05978963          	beq	a5,s9,4ce0 <vprintf+0xd2>
    ...
    4c92:	07500713          	li	a4,117
    4c96:	0ee78363          	beq	a5,a4,4d7c <vprintf+0x16e>
    ...
    4c9a:	07800713          	li	a4,120
    4c9e:	12e78563          	beq	a5,a4,4dc8 <vprintf+0x1ba>
    ...
    4ca2:	07000713          	li	a4,112
    4ca6:	14e78a63          	beq	a5,a4,4dfa <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4caa:	07300713          	li	a4,115
    4cae:	18e78a63          	beq	a5,a4,4e42 <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4cb2:	02500713          	li	a4,37
    4cb6:	04e79563          	bne	a5,a4,4d00 <vprintf+0xf2>
        putc(fd, '%');
    4cba:	02500593          	li	a1,37
    4cbe:	855a                	mv	a0,s6
    4cc0:	e89ff0ef          	jal	4b48 <putc>
      ...
      state = 0;
    4cc4:	4981                	li	s3,0
    4cc6:	bf49                	j	4c58 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4cc8:	008b8913          	addi	s2,s7,8
    4ccc:	4685                	li	a3,1
    4cce:	4629                	li	a2,10
    4cd0:	000ba583          	lw	a1,0(s7)
    4cd4:	855a                	mv	a0,s6
    4cd6:	e91ff0ef          	jal	4b66 <printint>
    4cda:	8bca                	mv	s7,s2
      state = 0;
    4cdc:	4981                	li	s3,0
    4cde:	bfad                	j	4c58 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4ce0:	06400793          	li	a5,100
    4ce4:	02f68963          	beq	a3,a5,4d16 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ce8:	06c00793          	li	a5,108
    4cec:	04f68263          	beq	a3,a5,4d30 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
    4cf0:	07500793          	li	a5,117
    4cf4:	0af68063          	beq	a3,a5,4d94 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
    4cf8:	07800793          	li	a5,120
    4cfc:	0ef68263          	beq	a3,a5,4de0 <vprintf+0x1d2>
        putc(fd, '%');
    4d00:	02500593          	li	a1,37
    4d04:	855a                	mv	a0,s6
    4d06:	e43ff0ef          	jal	4b48 <putc>
        putc(fd, c0);
    4d0a:	85ca                	mv	a1,s2
    4d0c:	855a                	mv	a0,s6
    4d0e:	e3bff0ef          	jal	4b48 <putc>
      state = 0;
    4d12:	4981                	li	s3,0
    4d14:	b791                	j	4c58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4d22:	855a                	mv	a0,s6
    4d24:	e43ff0ef          	jal	4b66 <printint>
        i += 1;
    ...
    4d2c:	4981                	li	s3,0
        i += 1;
    4d2e:	b72d                	j	4c58 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4d30:	06400793          	li	a5,100
    4d34:	02f60763          	beq	a2,a5,4d62 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4d38:	07500793          	li	a5,117
    4d3c:	06f60963          	beq	a2,a5,4dae <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4d40:	07800793          	li	a5,120
    4d44:	faf61ee3          	bne	a2,a5,4d00 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4d54:	855a                	mv	a0,s6
    4d56:	e11ff0ef          	jal	4b66 <printint>
        i += 2;
    ...
    4d6e:	855a                	mv	a0,s6
    4d70:	df7ff0ef          	jal	4b66 <printint>
        i += 2;
    4d74:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d76:	8bca                	mv	s7,s2
      state = 0;
    4d78:	4981                	li	s3,0
        i += 2;
    4d7a:	bdf9                	j	4c58 <vprintf+0x4a>
    ...
    4d88:	855a                	mv	a0,s6
    4d8a:	dddff0ef          	jal	4b66 <printint>
    4d8e:	8bca                	mv	s7,s2
      state = 0;
    4d90:	4981                	li	s3,0
    4d92:	b5d9                	j	4c58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4da0:	855a                	mv	a0,s6
    4da2:	dc5ff0ef          	jal	4b66 <printint>
        i += 1;
    4da6:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4da8:	8bca                	mv	s7,s2
      state = 0;
    4daa:	4981                	li	s3,0
        i += 1;
    4dac:	b575                	j	4c58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4dba:	855a                	mv	a0,s6
    4dbc:	dabff0ef          	jal	4b66 <printint>
        i += 2;
    4dc0:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4dc2:	8bca                	mv	s7,s2
      state = 0;
    4dc4:	4981                	li	s3,0
        i += 2;
    4dc6:	bd49                	j	4c58 <vprintf+0x4a>
    ...
    4dd4:	855a                	mv	a0,s6
    4dd6:	d91ff0ef          	jal	4b66 <printint>
    4dda:	8bca                	mv	s7,s2
      state = 0;
    4ddc:	4981                	li	s3,0
    4dde:	bdad                	j	4c58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4de0:	008b8913          	addi	s2,s7,8
    4de4:	4681                	li	a3,0
    4de6:	4641                	li	a2,16
    4de8:	000ba583          	lw	a1,0(s7)
    4dec:	855a                	mv	a0,s6
    4dee:	d79ff0ef          	jal	4b66 <printint>
        i += 1;
    ...
    4df6:	4981                	li	s3,0
        i += 1;
    4df8:	b585                	j	4c58 <vprintf+0x4a>
    4dfa:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    4dfc:	008b8d13          	addi	s10,s7,8
    4e00:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4e04:	03000593          	li	a1,48
    4e08:	855a                	mv	a0,s6
    4e0a:	d3fff0ef          	jal	4b48 <putc>
  putc(fd, 'x');
    4e0e:	07800593          	li	a1,120
    4e12:	855a                	mv	a0,s6
    4e14:	d35ff0ef          	jal	4b48 <putc>
    4e18:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4e1a:	00002b97          	auipc	s7,0x2
    4e1e:	666b8b93          	addi	s7,s7,1638 # 7480 <digits>
    4e22:	03c9d793          	srli	a5,s3,0x3c
    4e26:	97de                	add	a5,a5,s7
    4e28:	0007c583          	lbu	a1,0(a5)
    4e2c:	855a                	mv	a0,s6
    4e2e:	d1bff0ef          	jal	4b48 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4e32:	0992                	slli	s3,s3,0x4
    4e34:	397d                	addiw	s2,s2,-1
    4e36:	fe0916e3          	bnez	s2,4e22 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
    4e3a:	8bea                	mv	s7,s10
      state = 0;
    4e3c:	4981                	li	s3,0
    4e3e:	6d02                	ld	s10,0(sp)
    4e40:	bd21                	j	4c58 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    4e42:	008b8993          	addi	s3,s7,8
    4e46:	000bb903          	ld	s2,0(s7)
    4e4a:	00090f63          	beqz	s2,4e68 <vprintf+0x25a>
        for(; *s; s++)
    4e4e:	00094583          	lbu	a1,0(s2)
    4e52:	c195                	beqz	a1,4e76 <vprintf+0x268>
          putc(fd, *s);
    4e54:	855a                	mv	a0,s6
    4e56:	cf3ff0ef          	jal	4b48 <putc>
        for(; *s; s++)
    4e5a:	0905                	addi	s2,s2,1
    4e5c:	00094583          	lbu	a1,0(s2)
    4e60:	f9f5                	bnez	a1,4e54 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e62:	8bce                	mv	s7,s3
      state = 0;
    4e64:	4981                	li	s3,0
    4e66:	bbcd                	j	4c58 <vprintf+0x4a>
          s = "(null)";
    4e68:	00002917          	auipc	s2,0x2
    4e6c:	59890913          	addi	s2,s2,1432 # 7400 <malloc+0x248c>
        for(; *s; s++)
    4e70:	02800593          	li	a1,40
    4e74:	b7c5                	j	4e54 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e76:	8bce                	mv	s7,s3
      state = 0;
    4e78:	4981                	li	s3,0
    4e7a:	bbf9                	j	4c58 <vprintf+0x4a>
    4e7c:	64a6                	ld	s1,72(sp)
    4e7e:	79e2                	ld	s3,56(sp)
    4e80:	7a42                	ld	s4,48(sp)
    4e82:	7aa2                	ld	s5,40(sp)
    4e84:	7b02                	ld	s6,32(sp)
    4e86:	6be2                	ld	s7,24(sp)
    4e88:	6c42                	ld	s8,16(sp)
    4e8a:	6ca2                	ld	s9,8(sp)
    }
  }
}
    4e8c:	60e6                	ld	ra,88(sp)
    4e8e:	6446                	ld	s0,80(sp)
    4e90:	6906                	ld	s2,64(sp)
    4e92:	6125                	addi	sp,sp,96
    4e94:	8082                	ret

0000000000004e96 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4e96:	715d                	addi	sp,sp,-80
    4e98:	ec06                	sd	ra,24(sp)
    4e9a:	e822                	sd	s0,16(sp)
    4e9c:	1000                	addi	s0,sp,32
    4e9e:	e010                	sd	a2,0(s0)
    4ea0:	e414                	sd	a3,8(s0)
    4ea2:	e818                	sd	a4,16(s0)
    4ea4:	ec1c                	sd	a5,24(s0)
    4ea6:	03043023          	sd	a6,32(s0)
    4eaa:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4eae:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4eb2:	8622                	mv	a2,s0
    4eb4:	d5bff0ef          	jal	4c0e <vprintf>
}
    4eb8:	60e2                	ld	ra,24(sp)
    4eba:	6442                	ld	s0,16(sp)
    4ebc:	6161                	addi	sp,sp,80
    4ebe:	8082                	ret

0000000000004ec0 <printf>:

void
printf(const char *fmt, ...)
{
    4ec0:	711d                	addi	sp,sp,-96
    4ec2:	ec06                	sd	ra,24(sp)
    4ec4:	e822                	sd	s0,16(sp)
    4ec6:	1000                	addi	s0,sp,32
    4ec8:	e40c                	sd	a1,8(s0)
    4eca:	e810                	sd	a2,16(s0)
    4ecc:	ec14                	sd	a3,24(s0)
    4ece:	f018                	sd	a4,32(s0)
    4ed0:	f41c                	sd	a5,40(s0)
    4ed2:	03043823          	sd	a6,48(s0)
    4ed6:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4eda:	00840613          	addi	a2,s0,8
    4ede:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4ee2:	85aa                	mv	a1,a0
    4ee4:	4505                	li	a0,1
    4ee6:	d29ff0ef          	jal	4c0e <vprintf>
}
    4eea:	60e2                	ld	ra,24(sp)
    4eec:	6442                	ld	s0,16(sp)
    4eee:	6125                	addi	sp,sp,96
    4ef0:	8082                	ret

0000000000004ef2 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    4ef2:	1141                	addi	sp,sp,-16
    4ef4:	e422                	sd	s0,8(sp)
    4ef6:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4ef8:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4efc:	00004797          	auipc	a5,0x4
    4f00:	5547b783          	ld	a5,1364(a5) # 9450 <freep>
    4f04:	a02d                	j	4f2e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4f06:	4618                	lw	a4,8(a2)
    4f08:	9f2d                	addw	a4,a4,a1
    4f0a:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4f0e:	6398                	ld	a4,0(a5)
    4f10:	6310                	ld	a2,0(a4)
    4f12:	a83d                	j	4f50 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4f14:	ff852703          	lw	a4,-8(a0)
    4f18:	9f31                	addw	a4,a4,a2
    4f1a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    4f1c:	ff053683          	ld	a3,-16(a0)
    4f20:	a091                	j	4f64 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f22:	6398                	ld	a4,0(a5)
    4f24:	00e7e463          	bltu	a5,a4,4f2c <free+0x3a>
    4f28:	00e6ea63          	bltu	a3,a4,4f3c <free+0x4a>
{
    4f2c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f2e:	fed7fae3          	bgeu	a5,a3,4f22 <free+0x30>
    4f32:	6398                	ld	a4,0(a5)
    4f34:	00e6e463          	bltu	a3,a4,4f3c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f38:	fee7eae3          	bltu	a5,a4,4f2c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    4f3c:	ff852583          	lw	a1,-8(a0)
    4f40:	6390                	ld	a2,0(a5)
    4f42:	02059813          	slli	a6,a1,0x20
    4f46:	01c85713          	srli	a4,a6,0x1c
    4f4a:	9736                	add	a4,a4,a3
    4f4c:	fae60de3          	beq	a2,a4,4f06 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    4f50:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4f54:	4790                	lw	a2,8(a5)
    4f56:	02061593          	slli	a1,a2,0x20
    4f5a:	01c5d713          	srli	a4,a1,0x1c
    4f5e:	973e                	add	a4,a4,a5
    4f60:	fae68ae3          	beq	a3,a4,4f14 <free+0x22>
    p->s.ptr = bp->s.ptr;
    4f64:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    4f66:	00004717          	auipc	a4,0x4
    4f6a:	4ef73523          	sd	a5,1258(a4) # 9450 <freep>
}
    4f6e:	6422                	ld	s0,8(sp)
    4f70:	0141                	addi	sp,sp,16
    4f72:	8082                	ret

0000000000004f74 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    4f7c:	ec4e                	sd	s3,24(sp)
    4f7e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4f80:	02051493          	slli	s1,a0,0x20
    4f84:	9081                	srli	s1,s1,0x20
    4f86:	04bd                	addi	s1,s1,15
    4f88:	8091                	srli	s1,s1,0x4
    4f8a:	0014899b          	addiw	s3,s1,1
    4f8e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4f90:	00004517          	auipc	a0,0x4
    4f94:	4c053503          	ld	a0,1216(a0) # 9450 <freep>
    4f98:	c915                	beqz	a0,4fcc <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4f9a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4f9c:	4798                	lw	a4,8(a5)
    4f9e:	08977a63          	bgeu	a4,s1,5032 <malloc+0xbe>
    4fa2:	f04a                	sd	s2,32(sp)
    4fa4:	e852                	sd	s4,16(sp)
    4fa6:	e456                	sd	s5,8(sp)
    4fa8:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    4faa:	8a4e                	mv	s4,s3
    4fac:	0009871b          	sext.w	a4,s3
    4fb0:	6685                	lui	a3,0x1
    4fb2:	00d77363          	bgeu	a4,a3,4fb8 <malloc+0x44>
    4fb6:	6a05                	lui	s4,0x1
    4fb8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4fbc:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4fc0:	00004917          	auipc	s2,0x4
    4fc4:	49090913          	addi	s2,s2,1168 # 9450 <freep>
  if(p == (char*)-1)
    4fc8:	5afd                	li	s5,-1
    4fca:	a081                	j	500a <malloc+0x96>
    4fcc:	f04a                	sd	s2,32(sp)
    4fce:	e852                	sd	s4,16(sp)
    4fd0:	e456                	sd	s5,8(sp)
    4fd2:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    4fd4:	0000b797          	auipc	a5,0xb
    4fd8:	ca478793          	addi	a5,a5,-860 # fc78 <base>
    4fdc:	00004717          	auipc	a4,0x4
    4fe0:	46f73a23          	sd	a5,1140(a4) # 9450 <freep>
    4fe4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    4fe6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    4fea:	b7c1                	j	4faa <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    4fec:	6398                	ld	a4,0(a5)
    4fee:	e118                	sd	a4,0(a0)
    4ff0:	a8a9                	j	504a <malloc+0xd6>
  hp->s.size = nu;
    4ff2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    4ff6:	0541                	addi	a0,a0,16
    4ff8:	efbff0ef          	jal	4ef2 <free>
  return freep;
    4ffc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5000:	c12d                	beqz	a0,5062 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5002:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5004:	4798                	lw	a4,8(a5)
    5006:	02977263          	bgeu	a4,s1,502a <malloc+0xb6>
    if(p == freep)
    500a:	00093703          	ld	a4,0(s2)
    500e:	853e                	mv	a0,a5
    5010:	fef719e3          	bne	a4,a5,5002 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5014:	8552                	mv	a0,s4
    5016:	aebff0ef          	jal	4b00 <sbrk>
  if(p == (char*)-1)
    501a:	fd551ce3          	bne	a0,s5,4ff2 <malloc+0x7e>
        return 0;
    501e:	4501                	li	a0,0
    5020:	7902                	ld	s2,32(sp)
    5022:	6a42                	ld	s4,16(sp)
    5024:	6aa2                	ld	s5,8(sp)
    5026:	6b02                	ld	s6,0(sp)
    5028:	a03d                	j	5056 <malloc+0xe2>
    502a:	7902                	ld	s2,32(sp)
    502c:	6a42                	ld	s4,16(sp)
    502e:	6aa2                	ld	s5,8(sp)
    5030:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5032:	fae48de3          	beq	s1,a4,4fec <malloc+0x78>
        p->s.size -= nunits;
    5036:	4137073b          	subw	a4,a4,s3
    503a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    503c:	02071693          	slli	a3,a4,0x20
    5040:	01c6d713          	srli	a4,a3,0x1c
    5044:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5046:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    504a:	00004717          	auipc	a4,0x4
    504e:	40a73323          	sd	a0,1030(a4) # 9450 <freep>
      return (void*)(p + 1);
    5052:	01078513          	addi	a0,a5,16
  }
}
    5056:	70e2                	ld	ra,56(sp)
    5058:	7442                	ld	s0,48(sp)
    505a:	74a2                	ld	s1,40(sp)
    505c:	69e2                	ld	s3,24(sp)
    505e:	6121                	addi	sp,sp,64
    5060:	8082                	ret
    5062:	7902                	ld	s2,32(sp)
    5064:	6a42                	ld	s4,16(sp)
    5066:	6aa2                	ld	s5,8(sp)
    5068:	6b02                	ld	s6,0(sp)
    506a:	b7f5                	j	5056 <malloc+0xe2>
