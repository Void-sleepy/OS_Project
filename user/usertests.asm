...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	3ea78793          	addi	a5,a5,1002 # 73f8 <malloc+0x2498>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	ffa50513          	addi	a0,a0,-6 # 5060 <malloc+0x100>
      6e:	63f040ef          	jal	4eac <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	fe050513          	addi	a0,a0,-32 # 5080 <malloc+0x120>
      a8:	605040ef          	jal	4eac <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	fd850513          	addi	a0,a0,-40 # 5098 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	fe250513          	addi	a0,a0,-30 # 50b8 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	fae50513          	addi	a0,a0,-82 # 50a0 <malloc+0x140>
      fa:	5b3040ef          	jal	4eac <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	fc250513          	addi	a0,a0,-62 # 50c8 <malloc+0x168>
     10e:	59f040ef          	jal	4eac <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	f7450513          	addi	a0,a0,-140 # 50f0 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	f6a50513          	addi	a0,a0,-150 # 5110 <malloc+0x1b0>
     1ae:	4ff040ef          	jal	4eac <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	ef450513          	addi	a0,a0,-268 # 5138 <malloc+0x1d8>
     24c:	085040ef          	jal	4ad0 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	ee4a8a93          	addi	s5,s5,-284 # 5138 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	e8650513          	addi	a0,a0,-378 # 5148 <malloc+0x1e8>
     2ca:	3e3040ef          	jal	4eac <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	e8c50513          	addi	a0,a0,-372 # 5168 <malloc+0x208>
     2e4:	3c9040ef          	jal	4eac <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	e8250513          	addi	a0,a0,-382 # 5180 <malloc+0x220>
     306:	7ca040ef          	jal	4ad0 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	e7298993          	addi	s3,s3,-398 # 5180 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	e3650513          	addi	a0,a0,-458 # 5180 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	daa58593          	addi	a1,a1,-598 # 5108 <malloc+0x1a8>
     366:	73a040ef          	jal	4aa0 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	e3050513          	addi	a0,a0,-464 # 51a0 <malloc+0x240>
     378:	335040ef          	jal	4eac <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	702040ef          	jal	4a80 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	e0650513          	addi	a0,a0,-506 # 5188 <malloc+0x228>
     38a:	323040ef          	jal	4eac <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	6f0040ef          	jal	4a80 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	df450513          	addi	a0,a0,-524 # 5188 <malloc+0x228>
     39c:	311040ef          	jal	4eac <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	dd450513          	addi	a0,a0,-556 # 5180 <malloc+0x220>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	f6878793          	addi	a5,a5,-152 # 73f8 <malloc+0x2498>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	cf2a0a13          	addi	s4,s4,-782 # 51b0 <malloc+0x250>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	c7450513          	addi	a0,a0,-908 # 51b8 <malloc+0x258>
     54c:	161040ef          	jal	4eac <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	c7650513          	addi	a0,a0,-906 # 51d0 <malloc+0x270>
     562:	14b040ef          	jal	4eac <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	c9050513          	addi	a0,a0,-880 # 5200 <malloc+0x2a0>
     578:	135040ef          	jal	4eac <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	502040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	cae50513          	addi	a0,a0,-850 # 5230 <malloc+0x2d0>
     58a:	123040ef          	jal	4eac <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	ca850513          	addi	a0,a0,-856 # 5240 <malloc+0x2e0>
     5a0:	10d040ef          	jal	4eac <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	e3a78793          	addi	a5,a5,-454 # 73f8 <malloc+0x2498>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	c7ea0a13          	addi	s4,s4,-898 # 5270 <malloc+0x310>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	b0ea8a93          	addi	s5,s5,-1266 # 5108 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	bfa50513          	addi	a0,a0,-1030 # 5278 <malloc+0x318>
     686:	027040ef          	jal	4eac <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	bfc50513          	addi	a0,a0,-1028 # 5290 <malloc+0x330>
     69c:	011040ef          	jal	4eac <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	3de040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	b8a50513          	addi	a0,a0,-1142 # 5230 <malloc+0x2d0>
     6ae:	7fe040ef          	jal	4eac <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	3cc040ef          	jal	4a80 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	c0850513          	addi	a0,a0,-1016 # 52c0 <malloc+0x360>
     6c0:	7ec040ef          	jal	4eac <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	c0a50513          	addi	a0,a0,-1014 # 52d8 <malloc+0x378>
     6d6:	7d6040ef          	jal	4eac <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	9fc50513          	addi	a0,a0,-1540 # 50f0 <malloc+0x190>
     6fc:	3d4040ef          	jal	4ad0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	9ec50513          	addi	a0,a0,-1556 # 50f0 <malloc+0x190>
     70c:	3b4040ef          	jal	4ac0 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	9ec58593          	addi	a1,a1,-1556 # 5100 <malloc+0x1a0>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	9c850513          	addi	a0,a0,-1592 # 50f0 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	9a450513          	addi	a0,a0,-1628 # 50f0 <malloc+0x190>
     754:	36c040ef          	jal	4ac0 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	99450513          	addi	a0,a0,-1644 # 50f0 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	bda58593          	addi	a1,a1,-1062 # 5368 <malloc+0x408>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	92c50513          	addi	a0,a0,-1748 # 50f0 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	b1050513          	addi	a0,a0,-1264 # 5308 <malloc+0x3a8>
     800:	6ac040ef          	jal	4eac <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	b1c50513          	addi	a0,a0,-1252 # 5328 <malloc+0x3c8>
     814:	698040ef          	jal	4eac <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	b1c50513          	addi	a0,a0,-1252 # 5338 <malloc+0x3d8>
     824:	688040ef          	jal	4eac <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	b2850513          	addi	a0,a0,-1240 # 5358 <malloc+0x3f8>
     838:	674040ef          	jal	4eac <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	af850513          	addi	a0,a0,-1288 # 5338 <malloc+0x3d8>
     848:	664040ef          	jal	4eac <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	b1a50513          	addi	a0,a0,-1254 # 5370 <malloc+0x410>
     85e:	64e040ef          	jal	4eac <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	b2450513          	addi	a0,a0,-1244 # 5390 <malloc+0x430>
     874:	638040ef          	jal	4eac <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	b1850513          	addi	a0,a0,-1256 # 53b0 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	b2c98993          	addi	s3,s3,-1236 # 53d8 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	b5ca8a93          	addi	s5,s5,-1188 # 5410 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	ac250513          	addi	a0,a0,-1342 # 53b0 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     922:	a9250513          	addi	a0,a0,-1390 # 53b0 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	a7450513          	addi	a0,a0,-1420 # 53b8 <malloc+0x458>
     94c:	560040ef          	jal	4eac <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	a8e50513          	addi	a0,a0,-1394 # 53e8 <malloc+0x488>
     962:	54a040ef          	jal	4eac <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	ab050513          	addi	a0,a0,-1360 # 5420 <malloc+0x4c0>
     978:	534040ef          	jal	4eac <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	ac450513          	addi	a0,a0,-1340 # 5448 <malloc+0x4e8>
     98c:	520040ef          	jal	4eac <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	ad050513          	addi	a0,a0,-1328 # 5468 <malloc+0x508>
     9a0:	50c040ef          	jal	4eac <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	ad450513          	addi	a0,a0,-1324 # 5480 <malloc+0x520>
     9b4:	4f8040ef          	jal	4eac <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	aca50513          	addi	a0,a0,-1334 # 54a0 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	a8450513          	addi	a0,a0,-1404 # 54a0 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a4c50513          	addi	a0,a0,-1460 # 54a8 <malloc+0x548>
     a64:	448040ef          	jal	4eac <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	a5650513          	addi	a0,a0,-1450 # 54c8 <malloc+0x568>
     a7a:	432040ef          	jal	4eac <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	a6a50513          	addi	a0,a0,-1430 # 54f0 <malloc+0x590>
     a8e:	41e040ef          	jal	4eac <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	9fa50513          	addi	a0,a0,-1542 # 54a0 <malloc+0x540>
     ...
     ad0:	a4450513          	addi	a0,a0,-1468 # 5510 <malloc+0x5b0>
     ad4:	3d8040ef          	jal	4eac <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	a5650513          	addi	a0,a0,-1450 # 5538 <malloc+0x5d8>
     aea:	3c2040ef          	jal	4eac <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	a5850513          	addi	a0,a0,-1448 # 5550 <malloc+0x5f0>
     b00:	3ac040ef          	jal	4eac <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	a6c50513          	addi	a0,a0,-1428 # 5578 <malloc+0x618>
     b14:	398040ef          	jal	4eac <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	a5e50513          	addi	a0,a0,-1442 # 5590 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	a7a58593          	addi	a1,a1,-1414 # 55c0 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	a3650513          	addi	a0,a0,-1482 # 5590 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     be6:	9ae50513          	addi	a0,a0,-1618 # 5590 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	9a250513          	addi	a0,a0,-1630 # 55a0 <malloc+0x640>
     c06:	2a6040ef          	jal	4eac <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	9b650513          	addi	a0,a0,-1610 # 55c8 <malloc+0x668>
     c1a:	292040ef          	jal	4eac <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	9c250513          	addi	a0,a0,-1598 # 55e8 <malloc+0x688>
     c2e:	27e040ef          	jal	4eac <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	9d650513          	addi	a0,a0,-1578 # 5610 <malloc+0x6b0>
     c42:	26a040ef          	jal	4eac <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	9e250513          	addi	a0,a0,-1566 # 5630 <malloc+0x6d0>
     c56:	256040ef          	jal	4eac <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	9ee50513          	addi	a0,a0,-1554 # 5650 <malloc+0x6f0>
     c6a:	242040ef          	jal	4eac <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	9ee50513          	addi	a0,a0,-1554 # 5670 <malloc+0x710>
     c8a:	647030ef          	jal	4ad0 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	9ea50513          	addi	a0,a0,-1558 # 5678 <malloc+0x718>
     c96:	63b030ef          	jal	4ad0 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	9d250513          	addi	a0,a0,-1582 # 5670 <malloc+0x710>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	90e58593          	addi	a1,a1,-1778 # 55c0 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	8f650513          	addi	a0,a0,-1802 # 5680 <malloc+0x720>
     d92:	11a040ef          	jal	4eac <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	8fa50513          	addi	a0,a0,-1798 # 5698 <malloc+0x738>
     da6:	106040ef          	jal	4eac <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	8fe50513          	addi	a0,a0,-1794 # 56b0 <malloc+0x750>
     dba:	0f2040ef          	jal	4eac <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	90a50513          	addi	a0,a0,-1782 # 56d0 <malloc+0x770>
     dce:	0de040ef          	jal	4eac <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	92650513          	addi	a0,a0,-1754 # 5700 <malloc+0x7a0>
     de2:	0ca040ef          	jal	4eac <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	92a50513          	addi	a0,a0,-1750 # 5718 <malloc+0x7b8>
     df6:	0b6040ef          	jal	4eac <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	92e50513          	addi	a0,a0,-1746 # 5730 <malloc+0x7d0>
     e0a:	0a2040ef          	jal	4eac <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	94250513          	addi	a0,a0,-1726 # 5758 <malloc+0x7f8>
     e1e:	08e040ef          	jal	4eac <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	95e50513          	addi	a0,a0,-1698 # 5788 <malloc+0x828>
     e32:	07a040ef          	jal	4eac <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	95498993          	addi	s3,s3,-1708 # 57a8 <malloc+0x848>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	92c50513          	addi	a0,a0,-1748 # 57b8 <malloc+0x858>
     e94:	018040ef          	jal	4eac <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	92450513          	addi	a0,a0,-1756 # 57d8 <malloc+0x878>
     ebc:	415030ef          	jal	4ad0 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	91450513          	addi	a0,a0,-1772 # 57d8 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	8faa0a13          	addi	s4,s4,-1798 # 57d8 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	8ac50513          	addi	a0,a0,-1876 # 57d8 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	84c50513          	addi	a0,a0,-1972 # 57e0 <malloc+0x880>
     f9c:	711030ef          	jal	4eac <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	85250513          	addi	a0,a0,-1966 # 5800 <malloc+0x8a0>
     fb6:	6f7030ef          	jal	4eac <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	86650513          	addi	a0,a0,-1946 # 5828 <malloc+0x8c8>
     fca:	6e3030ef          	jal	4eac <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	07e98993          	addi	s3,s3,126 # 5098 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	8e878793          	addi	a5,a5,-1816 # 6978 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    10e8:	31478793          	addi	a5,a5,788 # 73f8 <malloc+0x2498>
    ...
    110c:	f9050513          	addi	a0,a0,-112 # 5098 <malloc+0x138>
    ...
    1120:	7b450513          	addi	a0,a0,1972 # 58d0 <malloc+0x970>
    1124:	589030ef          	jal	4eac <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	71450513          	addi	a0,a0,1812 # 5848 <malloc+0x8e8>
    113c:	571030ef          	jal	4eac <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	71c50513          	addi	a0,a0,1820 # 5868 <malloc+0x908>
    1154:	559030ef          	jal	4eac <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	72250513          	addi	a0,a0,1826 # 5888 <malloc+0x928>
    116e:	53f030ef          	jal	4eac <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	73250513          	addi	a0,a0,1842 # 58b0 <malloc+0x950>
    1186:	527030ef          	jal	4eac <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	0f5030ef          	jal	4a80 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	d0850513          	addi	a0,a0,-760 # 6e98 <malloc+0x1f38>
    1198:	515030ef          	jal	4eac <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	72e50513          	addi	a0,a0,1838 # 58f8 <malloc+0x998>
    11d2:	4db030ef          	jal	4eac <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	f0450513          	addi	a0,a0,-252 # 50f0 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1216:	edea0a13          	addi	s4,s4,-290 # 50f0 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	73ea8a93          	addi	s5,s5,1854 # 5958 <malloc+0x9f8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	6b250513          	addi	a0,a0,1714 # 5928 <malloc+0x9c8>
    127e:	42f030ef          	jal	4eac <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	6b650513          	addi	a0,a0,1718 # 5940 <malloc+0x9e0>
    1292:	41b030ef          	jal	4eac <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	6c850513          	addi	a0,a0,1736 # 5968 <malloc+0xa08>
    12a8:	405030ef          	jal	4eac <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	e32a0a13          	addi	s4,s4,-462 # 50f0 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    12c6:	00004a97          	auipc	s5,0x4
    12ca:	6c2a8a93          	addi	s5,s5,1730 # 5988 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	df050513          	addi	a0,a0,-528 # 50f0 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    131a:	62a50513          	addi	a0,a0,1578 # 5940 <malloc+0x9e0>
    131e:	38f030ef          	jal	4eac <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	66450513          	addi	a0,a0,1636 # 5990 <malloc+0xa30>
    1334:	379030ef          	jal	4eac <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	d4e78793          	addi	a5,a5,-690 # 5098 <malloc+0x138>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00004797          	auipc	a5,0x4
    135a:	65a78793          	addi	a5,a5,1626 # 59b0 <malloc+0xa50>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00004517          	auipc	a0,0x4
    136a:	65250513          	addi	a0,a0,1618 # 59b8 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    138e:	62e50513          	addi	a0,a0,1582 # 59b8 <malloc+0xa58>
    ...
    13a6:	63650513          	addi	a0,a0,1590 # 59d8 <malloc+0xa78>
    13aa:	303030ef          	jal	4eac <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	57050513          	addi	a0,a0,1392 # 5928 <malloc+0x9c8>
    13c0:	2ed030ef          	jal	4eac <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	5f450513          	addi	a0,a0,1524 # 59c0 <malloc+0xa60>
    13d4:	2d9030ef          	jal	4eac <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	cb650513          	addi	a0,a0,-842 # 5098 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    140e:	5de50513          	addi	a0,a0,1502 # 59e8 <malloc+0xa88>
    1412:	29b030ef          	jal	4eac <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	5e250513          	addi	a0,a0,1506 # 5a00 <malloc+0xaa0>
    1426:	287030ef          	jal	4eac <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	58a50513          	addi	a0,a0,1418 # 59b8 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	01850513          	addi	a0,a0,24 # 5468 <malloc+0x508>
    1458:	255030ef          	jal	4eac <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	4dc50513          	addi	a0,a0,1244 # 5940 <malloc+0x9e0>
    146c:	241030ef          	jal	4eac <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	60e030ef          	jal	4a80 <exit>
  unlink("echo-ok");
    1476:	00004517          	auipc	a0,0x4
    147a:	54250513          	addi	a0,a0,1346 # 59b8 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	57c50513          	addi	a0,a0,1404 # 5a18 <malloc+0xab8>
    14a4:	209030ef          	jal	4eac <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	4e850513          	addi	a0,a0,1256 # 5a30 <malloc+0xad0>
    1550:	15d030ef          	jal	4eac <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	48650513          	addi	a0,a0,1158 # 5a48 <malloc+0xae8>
    15ca:	0e3030ef          	jal	4eac <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	48a50513          	addi	a0,a0,1162 # 5a60 <malloc+0xb00>
    15de:	0cf030ef          	jal	4eac <printf>
          return;
    ...
    160a:	47250513          	addi	a0,a0,1138 # 5a78 <malloc+0xb18>
    160e:	09f030ef          	jal	4eac <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	45a50513          	addi	a0,a0,1114 # 5a98 <malloc+0xb38>
    1646:	067030ef          	jal	4eac <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	28850513          	addi	a0,a0,648 # 5928 <malloc+0x9c8>
    16a8:	005030ef          	jal	4eac <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	3fc50513          	addi	a0,a0,1020 # 5ab0 <malloc+0xb50>
    16bc:	7f0030ef          	jal	4eac <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	40050513          	addi	a0,a0,1024 # 5ac8 <malloc+0xb68>
    16d0:	7dc030ef          	jal	4eac <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	20450513          	addi	a0,a0,516 # 5928 <malloc+0x9c8>
    172c:	780030ef          	jal	4eac <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	1ec50513          	addi	a0,a0,492 # 5928 <malloc+0x9c8>
    1744:	768030ef          	jal	4eac <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	34e50513          	addi	a0,a0,846 # 5ae8 <malloc+0xb88>
    17a2:	70a030ef          	jal	4eac <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	2d8030ef          	jal	4a80 <exit>
{
    ...
    17da:	32250513          	addi	a0,a0,802 # 5af8 <malloc+0xb98>
    17de:	6ce030ef          	jal	4eac <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	68850513          	addi	a0,a0,1672 # 6e98 <malloc+0x1f38>
    1818:	694030ef          	jal	4eac <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	09650513          	addi	a0,a0,150 # 5928 <malloc+0x9c8>
    189a:	612030ef          	jal	4eac <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	10a50513          	addi	a0,a0,266 # 59c0 <malloc+0xa60>
    18be:	5ee030ef          	jal	4eac <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	20450513          	addi	a0,a0,516 # 5b18 <malloc+0xbb8>
    191c:	590030ef          	jal	4eac <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	1f850513          	addi	a0,a0,504 # 5b30 <malloc+0xbd0>
    1940:	56c030ef          	jal	4eac <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	1ce50513          	addi	a0,a0,462 # 5b58 <malloc+0xbf8>
    1992:	51a030ef          	jal	4eac <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	6e450513          	addi	a0,a0,1764 # 5108 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	6b0b0b13          	addi	s6,s6,1712 # 5108 <malloc+0x1a8>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	120c0c13          	addi	s8,s8,288 # 5b80 <malloc+0xc20>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	ebc50513          	addi	a0,a0,-324 # 5928 <malloc+0x9c8>
    1a74:	438030ef          	jal	4eac <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	0c450513          	addi	a0,a0,196 # 5bd0 <malloc+0xc70>
    1b14:	398030ef          	jal	4eac <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	06450513          	addi	a0,a0,100 # 5b88 <malloc+0xc28>
    1b2c:	380030ef          	jal	4eac <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	06850513          	addi	a0,a0,104 # 5ba0 <malloc+0xc40>
    1b40:	36c030ef          	jal	4eac <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	06c50513          	addi	a0,a0,108 # 5bb8 <malloc+0xc58>
    1b54:	358030ef          	jal	4eac <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	d3e50513          	addi	a0,a0,-706 # 5928 <malloc+0x9c8>
    1bf2:	2ba030ef          	jal	4eac <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	ff450513          	addi	a0,a0,-12 # 5bf8 <malloc+0xc98>
    1c0c:	2a0030ef          	jal	4eac <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	cb650513          	addi	a0,a0,-842 # 5928 <malloc+0x9c8>
    1c7a:	232030ef          	jal	4eac <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	f8250513          	addi	a0,a0,-126 # 5c18 <malloc+0xcb8>
    1c9e:	20e030ef          	jal	4eac <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	f4a50513          	addi	a0,a0,-182 # 5c30 <malloc+0xcd0>
    1cee:	1be030ef          	jal	4eac <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	c2e50513          	addi	a0,a0,-978 # 5928 <malloc+0x9c8>
    1d02:	1aa030ef          	jal	4eac <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	6d678793          	addi	a5,a5,1750 # 73f8 <malloc+0x2498>
  ...
  exit(0);
    ...
    1d8e:	ece50513          	addi	a0,a0,-306 # 5c58 <malloc+0xcf8>
    1d92:	11a030ef          	jal	4eac <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	b8a50513          	addi	a0,a0,-1142 # 5928 <malloc+0x9c8>
    1da6:	106030ef          	jal	4eac <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	08e50513          	addi	a0,a0,142 # 6e98 <malloc+0x1f38>
    1e12:	09a030ef          	jal	4eac <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	ddc50513          	addi	a0,a0,-548 # 5c78 <malloc+0xd18>
    1ea4:	008030ef          	jal	4eac <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	2b450513          	addi	a0,a0,692 # 5168 <malloc+0x208>
    1ebc:	7f1020ef          	jal	4eac <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	a5078793          	addi	a5,a5,-1456 # 6978 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    1f66:	d2e50513          	addi	a0,a0,-722 # 5c90 <malloc+0xd30>
    1f6a:	743020ef          	jal	4eac <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	8d050513          	addi	a0,a0,-1840 # 5848 <malloc+0x8e8>
    1f80:	72d020ef          	jal	4eac <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	8da50513          	addi	a0,a0,-1830 # 5868 <malloc+0x908>
    1f96:	717020ef          	jal	4eac <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	8e250513          	addi	a0,a0,-1822 # 5888 <malloc+0x928>
    1fae:	6ff020ef          	jal	4eac <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	8f450513          	addi	a0,a0,-1804 # 58b0 <malloc+0x950>
    1fc4:	6e9020ef          	jal	4eac <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	cd850513          	addi	a0,a0,-808 # 5cd0 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2024:	cd050513          	addi	a0,a0,-816 # 5cf0 <malloc+0xd90>
    2028:	685020ef          	jal	4eac <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	c6250513          	addi	a0,a0,-926 # 5c98 <malloc+0xd38>
    203e:	66f020ef          	jal	4eac <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	c6650513          	addi	a0,a0,-922 # 5cb0 <malloc+0xd50>
    2052:	65b020ef          	jal	4eac <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	229020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	c7c50513          	addi	a0,a0,-900 # 5cd8 <malloc+0xd78>
    2064:	649020ef          	jal	4eac <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	c5c50513          	addi	a0,a0,-932 # 5cd0 <malloc+0xd70>
    207c:	255020ef          	jal	4ad0 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	1ee50513          	addi	a0,a0,494 # 5270 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    20a8:	c7c50513          	addi	a0,a0,-900 # 5d20 <malloc+0xdc0>
    20ac:	601020ef          	jal	4eac <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	1cf020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    20b6:	00004517          	auipc	a0,0x4
    20ba:	c2250513          	addi	a0,a0,-990 # 5cd8 <malloc+0xd78>
    20be:	5ef020ef          	jal	4eac <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	c2850513          	addi	a0,a0,-984 # 5d48 <malloc+0xde8>
    2128:	585020ef          	jal	4eac <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	bf850513          	addi	a0,a0,-1032 # 5d68 <malloc+0xe08>
    2178:	535020ef          	jal	4eac <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	c0c50513          	addi	a0,a0,-1012 # 5dc8 <malloc+0xe68>
    21c4:	4e9020ef          	jal	4eac <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	bb250513          	addi	a0,a0,-1102 # 5d88 <malloc+0xe28>
    21de:	4cf020ef          	jal	4eac <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	bbe50513          	addi	a0,a0,-1090 # 5da8 <malloc+0xe48>
    21f2:	4bb020ef          	jal	4eac <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22f0:	afc50513          	addi	a0,a0,-1284 # 5de8 <malloc+0xe88>
    22f4:	3b9020ef          	jal	4eac <printf>
    exit(1);
    22f8:	4505                	li	a0,1
    ...
    2304:	b3050513          	addi	a0,a0,-1232 # 5e30 <malloc+0xed0>
    2308:	3a5020ef          	jal	4eac <printf>
    exit(1);
    230c:	4505                	li	a0,1
    ...
    231c:	b3850513          	addi	a0,a0,-1224 # 5e50 <malloc+0xef0>
    2320:	38d020ef          	jal	4eac <printf>
    exit(1);
    2324:	4505                	li	a0,1
    ...
    2334:	b6050513          	addi	a0,a0,-1184 # 5e90 <malloc+0xf30>
    2338:	375020ef          	jal	4eac <printf>
    exit(1);
    233c:	4505                	li	a0,1
    ...
    2348:	b7c50513          	addi	a0,a0,-1156 # 5ec0 <malloc+0xf60>
    234c:	361020ef          	jal	4eac <printf>
    exit(1);
    2350:	4505                	li	a0,1
    ...
    2360:	b9c50513          	addi	a0,a0,-1124 # 5ef8 <malloc+0xf98>
    2364:	349020ef          	jal	4eac <printf>
    exit(1);
    2368:	4505                	li	a0,1
...
000000000000236e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    238e:	b9650513          	addi	a0,a0,-1130 # 5f20 <malloc+0xfc0>
    2392:	72e020ef          	jal	4ac0 <open>
    2396:	84aa                	mv	s1,a0
  unlink("sbrk");
    2398:	00004517          	auipc	a0,0x4
    239c:	b8850513          	addi	a0,a0,-1144 # 5f20 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    23dc:	b5050513          	addi	a0,a0,-1200 # 5f28 <malloc+0xfc8>
    23e0:	2cd020ef          	jal	4eac <printf>
    exit(1);
    23e4:	4505                	li	a0,1
    ...
    23f0:	b5450513          	addi	a0,a0,-1196 # 5f40 <malloc+0xfe0>
    23f4:	2b9020ef          	jal	4eac <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    2404:	63050513          	addi	a0,a0,1584 # 5a30 <malloc+0xad0>
    2408:	2a5020ef          	jal	4eac <printf>
    exit(1);
    240c:	4505                	li	a0,1
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2426:	b3650513          	addi	a0,a0,-1226 # 5f58 <malloc+0xff8>
  ...
  close(fd);
    ...
    245e:	4e650513          	addi	a0,a0,1254 # 5940 <malloc+0x9e0>
    2462:	24b020ef          	jal	4eac <printf>
    exit(1);
    2466:	4505                	li	a0,1
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2494:	a0850513          	addi	a0,a0,-1528 # 6e98 <malloc+0x1f38>
    2498:	215020ef          	jal	4eac <printf>
    exit(1);
    249c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24ce:	9ce50513          	addi	a0,a0,-1586 # 6e98 <malloc+0x1f38>
    24d2:	1db020ef          	jal	4eac <printf>
    exit(1);
    24d6:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    250e:	98e50513          	addi	a0,a0,-1650 # 6e98 <malloc+0x1f38>
    2512:	19b020ef          	jal	4eac <printf>
    exit(1);
    2516:	4505                	li	a0,1
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    262e:	86e50513          	addi	a0,a0,-1938 # 6e98 <malloc+0x1f38>
    2632:	07b020ef          	jal	4eac <printf>
      exit(1);
    2636:	4505                	li	a0,1
    ...
    266e:	a2e50513          	addi	a0,a0,-1490 # 5098 <malloc+0x138>
    2672:	faa43c23          	sd	a0,-72(s0)
    2676:	00003797          	auipc	a5,0x3
    267a:	a9278793          	addi	a5,a5,-1390 # 5108 <malloc+0x1a8>
...
0000000000002694 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c4:	92050513          	addi	a0,a0,-1760 # 5fe0 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26da:	98250513          	addi	a0,a0,-1662 # 6058 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    275e:	80650513          	addi	a0,a0,-2042 # 5f60 <malloc+0x1000>
    2762:	74a020ef          	jal	4eac <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2772:	83a50513          	addi	a0,a0,-1990 # 5fa8 <malloc+0x1048>
    2776:	736020ef          	jal	4eac <printf>
    exit(1);
    277a:	4505                	li	a0,1
    ...
    2786:	88e50513          	addi	a0,a0,-1906 # 6010 <malloc+0x10b0>
    278a:	722020ef          	jal	4eac <printf>
    exit(1);
    278e:	4505                	li	a0,1
    ...
    279a:	8f250513          	addi	a0,a0,-1806 # 6088 <malloc+0x1128>
    279e:	70e020ef          	jal	4eac <printf>
    exit(1);
    27a2:	4505                	li	a0,1
    ...
    27ae:	93e50513          	addi	a0,a0,-1730 # 60e8 <malloc+0x1188>
    27b2:	6fa020ef          	jal	4eac <printf>
    exit(1);
    27b6:	4505                	li	a0,1
    ...
    27c2:	98250513          	addi	a0,a0,-1662 # 6140 <malloc+0x11e0>
    27c6:	6e6020ef          	jal	4eac <printf>
    exit(1);
    27ca:	4505                	li	a0,1
...
00000000000027d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    280a:	97250513          	addi	a0,a0,-1678 # 6178 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2836:	95650513          	addi	a0,a0,-1706 # 6188 <malloc+0x1228>
    283a:	672020ef          	jal	4eac <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    28ac:	8d050513          	addi	a0,a0,-1840 # 6178 <malloc+0x1218>
    28b0:	238020ef          	jal	4ae8 <mkdir>
    28b4:	12050063          	beqz	a0,29d4 <diskfull+0x204>
  unlink("diskfulldir");
    28b8:	00004517          	auipc	a0,0x4
    28bc:	8c050513          	addi	a0,a0,-1856 # 6178 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29da:	7d250513          	addi	a0,a0,2002 # 61a8 <malloc+0x1248>
    29de:	4ce020ef          	jal	4eac <printf>
...
00000000000029e4 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a40:	7a450513          	addi	a0,a0,1956 # 61e0 <malloc+0x1280>
    2a44:	468020ef          	jal	4eac <printf>
    exit(1);
    2a48:	4505                	li	a0,1
    ...
    2a54:	7a850513          	addi	a0,a0,1960 # 61f8 <malloc+0x1298>
    2a58:	454020ef          	jal	4eac <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a68:	7c450513          	addi	a0,a0,1988 # 6228 <malloc+0x12c8>
    2a6c:	440020ef          	jal	4eac <printf>
    exit(1);
    2a70:	4505                	li	a0,1
    ...
    2a7c:	7d850513          	addi	a0,a0,2008 # 6250 <malloc+0x12f0>
    2a80:	42c020ef          	jal	4eac <printf>
    exit(1);
    2a84:	4505                	li	a0,1
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2adc:	e5050513          	addi	a0,a0,-432 # 5928 <malloc+0x9c8>
    2ae0:	3cc020ef          	jal	4eac <printf>
    exit(1);
    2ae4:	4505                	li	a0,1
    ...
    2af0:	6f450513          	addi	a0,a0,1780 # 61e0 <malloc+0x1280>
    2af4:	3b8020ef          	jal	4eac <printf>
      exit(1);
    2af8:	4505                	li	a0,1
    ...
    2b04:	76850513          	addi	a0,a0,1896 # 6268 <malloc+0x1308>
    2b08:	3a4020ef          	jal	4eac <printf>
      exit(1);
    2b0c:	4505                	li	a0,1
    ...
    2b18:	71450513          	addi	a0,a0,1812 # 6228 <malloc+0x12c8>
    2b1c:	390020ef          	jal	4eac <printf>
      exit(1);
    2b20:	4505                	li	a0,1
...
0000000000002b36 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b92:	65250513          	addi	a0,a0,1618 # 61e0 <malloc+0x1280>
    2b96:	316020ef          	jal	4eac <printf>
    exit(1);
    2b9a:	4505                	li	a0,1
    ...
    2ba6:	6e650513          	addi	a0,a0,1766 # 6288 <malloc+0x1328>
    2baa:	302020ef          	jal	4eac <printf>
    exit(1);
    2bae:	4505                	li	a0,1
    ...
    2bba:	6f250513          	addi	a0,a0,1778 # 62a8 <malloc+0x1348>
    2bbe:	2ee020ef          	jal	4eac <printf>
    exit(1);
    2bc2:	4505                	li	a0,1
    ...
    2bce:	6f650513          	addi	a0,a0,1782 # 62c0 <malloc+0x1360>
    2bd2:	2da020ef          	jal	4eac <printf>
    exit(1);
    2bd6:	4505                	li	a0,1
...
0000000000002bdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2bee:	81e50513          	addi	a0,a0,-2018 # 6408 <malloc+0x14a8>
    2bf2:	6df010ef          	jal	4ad0 <unlink>
  if(mkdir("dd") != 0){
    2bf6:	00003517          	auipc	a0,0x3
    2bfa:	6e250513          	addi	a0,a0,1762 # 62d8 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2c0e:	6ee50513          	addi	a0,a0,1774 # 62f8 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2c22:	7ea58593          	addi	a1,a1,2026 # 6408 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2c34:	6a850513          	addi	a0,a0,1704 # 62d8 <malloc+0x1378>
    2c38:	699010ef          	jal	4ad0 <unlink>
    2c3c:	2c055963          	bgez	a0,2f0e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c40:	00003517          	auipc	a0,0x3
    2c44:	71050513          	addi	a0,a0,1808 # 6350 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c58:	72450513          	addi	a0,a0,1828 # 6378 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2c6c:	74058593          	addi	a1,a1,1856 # 63a8 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c80:	73450513          	addi	a0,a0,1844 # 63b0 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d66:	61650513          	addi	a0,a0,1558 # 6378 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d7a:	81a50513          	addi	a0,a0,-2022 # 6590 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    2eec:	3f850513          	addi	a0,a0,1016 # 62e0 <malloc+0x1380>
    2ef0:	7bd010ef          	jal	4eac <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f00:	40450513          	addi	a0,a0,1028 # 6300 <malloc+0x13a0>
    2f04:	7a9010ef          	jal	4eac <printf>
    exit(1);
    2f08:	4505                	li	a0,1
    ...
    2f14:	41050513          	addi	a0,a0,1040 # 6320 <malloc+0x13c0>
    2f18:	795010ef          	jal	4eac <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f28:	43450513          	addi	a0,a0,1076 # 6358 <malloc+0x13f8>
    2f2c:	781010ef          	jal	4eac <printf>
    exit(1);
    2f30:	4505                	li	a0,1
    ...
    2f3c:	45050513          	addi	a0,a0,1104 # 6388 <malloc+0x1428>
    2f40:	76d010ef          	jal	4eac <printf>
    exit(1);
    2f44:	4505                	li	a0,1
    ...
    2f50:	47450513          	addi	a0,a0,1140 # 63c0 <malloc+0x1460>
    2f54:	759010ef          	jal	4eac <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f64:	48050513          	addi	a0,a0,1152 # 63e0 <malloc+0x1480>
    2f68:	745010ef          	jal	4eac <printf>
    exit(1);
    2f6c:	4505                	li	a0,1
    ...
    2f78:	49c50513          	addi	a0,a0,1180 # 6410 <malloc+0x14b0>
    2f7c:	731010ef          	jal	4eac <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f8c:	4b050513          	addi	a0,a0,1200 # 6438 <malloc+0x14d8>
    2f90:	71d010ef          	jal	4eac <printf>
    exit(1);
    2f94:	4505                	li	a0,1
    ...
    2fa0:	4bc50513          	addi	a0,a0,1212 # 6458 <malloc+0x14f8>
    2fa4:	709010ef          	jal	4eac <printf>
    exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2fb4:	4d050513          	addi	a0,a0,1232 # 6480 <malloc+0x1520>
    2fb8:	6f5010ef          	jal	4eac <printf>
    exit(1);
    2fbc:	4505                	li	a0,1
    ...
    2fc8:	4e450513          	addi	a0,a0,1252 # 64a8 <malloc+0x1548>
    2fcc:	6e1010ef          	jal	4eac <printf>
    exit(1);
    2fd0:	4505                	li	a0,1
    ...
    2fdc:	50050513          	addi	a0,a0,1280 # 64d8 <malloc+0x1578>
    2fe0:	6cd010ef          	jal	4eac <printf>
    exit(1);
    2fe4:	4505                	li	a0,1
    ...
    2ff0:	51c50513          	addi	a0,a0,1308 # 6508 <malloc+0x15a8>
    2ff4:	6b9010ef          	jal	4eac <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3004:	52050513          	addi	a0,a0,1312 # 6520 <malloc+0x15c0>
    3008:	6a5010ef          	jal	4eac <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    3018:	52c50513          	addi	a0,a0,1324 # 6540 <malloc+0x15e0>
    301c:	691010ef          	jal	4eac <printf>
    exit(1);
    3020:	4505                	li	a0,1
    ...
    302c:	53850513          	addi	a0,a0,1336 # 6560 <malloc+0x1600>
    3030:	67d010ef          	jal	4eac <printf>
    exit(1);
    3034:	4505                	li	a0,1
    ...
    3040:	56450513          	addi	a0,a0,1380 # 65a0 <malloc+0x1640>
    3044:	669010ef          	jal	4eac <printf>
    exit(1);
    3048:	4505                	li	a0,1
    ...
    3054:	58050513          	addi	a0,a0,1408 # 65d0 <malloc+0x1670>
    3058:	655010ef          	jal	4eac <printf>
    exit(1);
    305c:	4505                	li	a0,1
    ...
    3068:	58c50513          	addi	a0,a0,1420 # 65f0 <malloc+0x1690>
    306c:	641010ef          	jal	4eac <printf>
    exit(1);
    3070:	4505                	li	a0,1
    ...
    307c:	59850513          	addi	a0,a0,1432 # 6610 <malloc+0x16b0>
    3080:	62d010ef          	jal	4eac <printf>
    exit(1);
    3084:	4505                	li	a0,1
    ...
    3090:	5a450513          	addi	a0,a0,1444 # 6630 <malloc+0x16d0>
    3094:	619010ef          	jal	4eac <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a4:	5c050513          	addi	a0,a0,1472 # 6660 <malloc+0x1700>
    30a8:	605010ef          	jal	4eac <printf>
    exit(1);
    30ac:	4505                	li	a0,1
    ...
    30b8:	5d450513          	addi	a0,a0,1492 # 6688 <malloc+0x1728>
    30bc:	5f1010ef          	jal	4eac <printf>
    exit(1);
    30c0:	4505                	li	a0,1
    ...
    30cc:	5e850513          	addi	a0,a0,1512 # 66b0 <malloc+0x1750>
    30d0:	5dd010ef          	jal	4eac <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    ...
    30e0:	5fc50513          	addi	a0,a0,1532 # 66d8 <malloc+0x1778>
    30e4:	5c9010ef          	jal	4eac <printf>
    exit(1);
    30e8:	4505                	li	a0,1
    ...
    30f4:	60850513          	addi	a0,a0,1544 # 66f8 <malloc+0x1798>
    30f8:	5b5010ef          	jal	4eac <printf>
    exit(1);
    30fc:	4505                	li	a0,1
    ...
    3108:	61450513          	addi	a0,a0,1556 # 6718 <malloc+0x17b8>
    310c:	5a1010ef          	jal	4eac <printf>
    exit(1);
    3110:	4505                	li	a0,1
    ...
    311c:	62850513          	addi	a0,a0,1576 # 6740 <malloc+0x17e0>
    3120:	58d010ef          	jal	4eac <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3130:	63450513          	addi	a0,a0,1588 # 6760 <malloc+0x1800>
    3134:	579010ef          	jal	4eac <printf>
    exit(1);
    3138:	4505                	li	a0,1
    ...
    3144:	64050513          	addi	a0,a0,1600 # 6780 <malloc+0x1820>
    3148:	565010ef          	jal	4eac <printf>
    exit(1);
    314c:	4505                	li	a0,1
    ...
    3158:	65450513          	addi	a0,a0,1620 # 67a8 <malloc+0x1848>
    315c:	551010ef          	jal	4eac <printf>
    exit(1);
    3160:	4505                	li	a0,1
    ...
    316c:	2d050513          	addi	a0,a0,720 # 6438 <malloc+0x14d8>
    3170:	53d010ef          	jal	4eac <printf>
    exit(1);
    3174:	4505                	li	a0,1
    ...
    3180:	64c50513          	addi	a0,a0,1612 # 67c8 <malloc+0x1868>
    3184:	529010ef          	jal	4eac <printf>
    exit(1);
    3188:	4505                	li	a0,1
    ...
    3194:	65850513          	addi	a0,a0,1624 # 67e8 <malloc+0x1888>
    3198:	515010ef          	jal	4eac <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31a8:	67450513          	addi	a0,a0,1652 # 6818 <malloc+0x18b8>
    31ac:	501010ef          	jal	4eac <printf>
    exit(1);
    31b0:	4505                	li	a0,1
    ...
    31bc:	68050513          	addi	a0,a0,1664 # 6838 <malloc+0x18d8>
    31c0:	4ed010ef          	jal	4eac <printf>
    exit(1);
    31c4:	4505                	li	a0,1
...
00000000000031ca <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3256:	60650513          	addi	a0,a0,1542 # 6858 <malloc+0x18f8>
    325a:	453010ef          	jal	4eac <printf>
    exit(1);
    325e:	4505                	li	a0,1
    ...
    326a:	60a50513          	addi	a0,a0,1546 # 6870 <malloc+0x1910>
    326e:	43f010ef          	jal	4eac <printf>
    exit(1);
    3272:	4505                	li	a0,1
    ...
    327e:	60e50513          	addi	a0,a0,1550 # 6888 <malloc+0x1928>
    3282:	42b010ef          	jal	4eac <printf>
    exit(1);
    3286:	4505                	li	a0,1
    ...
    3292:	61250513          	addi	a0,a0,1554 # 68a0 <malloc+0x1940>
    3296:	417010ef          	jal	4eac <printf>
    exit(1);
    329a:	4505                	li	a0,1
    ...
    32a6:	fae50513          	addi	a0,a0,-82 # 6250 <malloc+0x12f0>
    32aa:	403010ef          	jal	4eac <printf>
    exit(1);
    32ae:	4505                	li	a0,1
    ...
    32ba:	60a50513          	addi	a0,a0,1546 # 68c0 <malloc+0x1960>
    32be:	3ef010ef          	jal	4eac <printf>
    exit(1);
    32c2:	4505                	li	a0,1
    ...
    32ce:	61e50513          	addi	a0,a0,1566 # 68e8 <malloc+0x1988>
    32d2:	3db010ef          	jal	4eac <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e2:	62a50513          	addi	a0,a0,1578 # 6908 <malloc+0x19a8>
    32e6:	3c7010ef          	jal	4eac <printf>
    exit(1);
    32ea:	4505                	li	a0,1
...
00000000000032f0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3306:	62650513          	addi	a0,a0,1574 # 6928 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    331a:	61250513          	addi	a0,a0,1554 # 6928 <malloc+0x19c8>
    331e:	7d2010ef          	jal	4af0 <chdir>
    3322:	c569                	beqz	a0,33ec <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3324:	4581                	li	a1,0
    3326:	00003517          	auipc	a0,0x3
    332a:	64a50513          	addi	a0,a0,1610 # 6970 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    33aa:	3da50513          	addi	a0,a0,986 # 5780 <malloc+0x820>
    33ae:	712010ef          	jal	4ac0 <open>
    33b2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    33b4:	4605                	li	a2,1
    33b6:	00002597          	auipc	a1,0x2
    33ba:	d5258593          	addi	a1,a1,-686 # 5108 <malloc+0x1a8>
  ...
  close(fd);
    ...
    33de:	55650513          	addi	a0,a0,1366 # 6930 <malloc+0x19d0>
    33e2:	2cb010ef          	jal	4eac <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	56250513          	addi	a0,a0,1378 # 6950 <malloc+0x19f0>
    33f6:	2b7010ef          	jal	4eac <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	57e50513          	addi	a0,a0,1406 # 6980 <malloc+0x1a20>
    340a:	2a3010ef          	jal	4eac <printf>
    exit(1);
    340e:	4505                	li	a0,1
    ...
    341a:	56a50513          	addi	a0,a0,1386 # 6980 <malloc+0x1a20>
    341e:	28f010ef          	jal	4eac <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    342e:	57e50513          	addi	a0,a0,1406 # 69a8 <malloc+0x1a48>
    3432:	27b010ef          	jal	4eac <printf>
    exit(1);
    3436:	4505                	li	a0,1
    ...
    3442:	59250513          	addi	a0,a0,1426 # 69d0 <malloc+0x1a70>
    3446:	267010ef          	jal	4eac <printf>
    exit(1);
    344a:	4505                	li	a0,1
    ...
    3456:	5a650513          	addi	a0,a0,1446 # 69f8 <malloc+0x1a98>
    345a:	253010ef          	jal	4eac <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346a:	5ba50513          	addi	a0,a0,1466 # 6a20 <malloc+0x1ac0>
    346e:	23f010ef          	jal	4eac <printf>
    exit(1);
    3472:	4505                	li	a0,1
    ...
    347e:	5c650513          	addi	a0,a0,1478 # 6a40 <malloc+0x1ae0>
    3482:	22b010ef          	jal	4eac <printf>
    exit(1);
    3486:	4505                	li	a0,1
    ...
    3492:	5da50513          	addi	a0,a0,1498 # 6a68 <malloc+0x1b08>
    3496:	217010ef          	jal	4eac <printf>
    exit(1);
    349a:	4505                	li	a0,1
...
00000000000034a0 <iref>:
{
    ...
    34be:	5c6a0a13          	addi	s4,s4,1478 # 6a80 <malloc+0x1b20>
    mkdir("");
    34c2:	00003497          	auipc	s1,0x3
    34c6:	0c648493          	addi	s1,s1,198 # 6588 <malloc+0x1628>
    link("README", "");
    34ca:	00002a97          	auipc	s5,0x2
    34ce:	da6a8a93          	addi	s5,s5,-602 # 5270 <malloc+0x310>
    fd = open("xx", O_CREATE);
    34d2:	00003997          	auipc	s3,0x3
    34d6:	4a698993          	addi	s3,s3,1190 # 6978 <malloc+0x1a18>
    34da:	a835                	j	3516 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34dc:	85da                	mv	a1,s6
    34de:	00003517          	auipc	a0,0x3
    34e2:	5aa50513          	addi	a0,a0,1450 # 6a88 <malloc+0x1b28>
    34e6:	1c7010ef          	jal	4eac <printf>
      exit(1);
    34ea:	4505                	li	a0,1
    ...
    34f6:	5ae50513          	addi	a0,a0,1454 # 6aa0 <malloc+0x1b40>
    34fa:	1b3010ef          	jal	4eac <printf>
      exit(1);
    34fe:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    355e:	d4698993          	addi	s3,s3,-698 # 62a0 <malloc+0x1340>
    unlink("irefd");
    3562:	00003917          	auipc	s2,0x3
    3566:	51e90913          	addi	s2,s2,1310 # 6a80 <malloc+0x1b20>
    chdir("..");
    356a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    357e:	cce50513          	addi	a0,a0,-818 # 6248 <malloc+0x12e8>
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35aa:	51250513          	addi	a0,a0,1298 # 6ab8 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    35c6:	4f650513          	addi	a0,a0,1270 # 6ab8 <malloc+0x1b58>
    ...
    35d8:	50450513          	addi	a0,a0,1284 # 6ad8 <malloc+0x1b78>
    35dc:	0d1010ef          	jal	4eac <printf>
      exit(1);
    35e0:	4505                	li	a0,1
    ...
    35ec:	4d850513          	addi	a0,a0,1240 # 6ac0 <malloc+0x1b60>
    35f0:	0bd010ef          	jal	4eac <printf>
    exit(1);
    35f4:	4505                	li	a0,1
    ...
    3600:	32c50513          	addi	a0,a0,812 # 5928 <malloc+0x9c8>
    3604:	0a9010ef          	jal	4eac <printf>
    exit(1);
    3608:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    361e:	49e50513          	addi	a0,a0,1182 # 6ab8 <malloc+0x1b58>
    3622:	4ae010ef          	jal	4ad0 <unlink>
    3626:	c919                	beqz	a0,363c <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3628:	85a6                	mv	a1,s1
    362a:	00002517          	auipc	a0,0x2
    362e:	4ee50513          	addi	a0,a0,1262 # 5b18 <malloc+0xbb8>
    3632:	07b010ef          	jal	4eac <printf>
    exit(1);
    3636:	4505                	li	a0,1
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    365c:	4a850513          	addi	a0,a0,1192 # 6b00 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    367c:	48850513          	addi	a0,a0,1160 # 6b00 <malloc+0x1ba0>
  ...
  sleep(10); // one second
    ...
    36a4:	44850513          	addi	a0,a0,1096 # 5ae8 <malloc+0xb88>
    36a8:	005010ef          	jal	4eac <printf>
    exit(1);
    36ac:	4505                	li	a0,1
    36ae:	3d2010ef          	jal	4a80 <exit>
      int fd = open("stopforking", 0);
    36b2:	00003497          	auipc	s1,0x3
    36b6:	44e48493          	addi	s1,s1,1102 # 6b00 <malloc+0x1ba0>
    36ba:	4581                	li	a1,0
    36bc:	8526                	mv	a0,s1
    ...
    36d6:	42e50513          	addi	a0,a0,1070 # 6b00 <malloc+0x1ba0>
...
00000000000036ea <killstatus>:
{
  ...
  exit(0);
    ...
    373c:	1f050513          	addi	a0,a0,496 # 5928 <malloc+0x9c8>
    3740:	76c010ef          	jal	4eac <printf>
      exit(1);
    3744:	4505                	li	a0,1
    ...
    3756:	3be50513          	addi	a0,a0,958 # 6b10 <malloc+0x1bb0>
    375a:	752010ef          	jal	4eac <printf>
       exit(1);
    375e:	4505                	li	a0,1
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    378a:	36250513          	addi	a0,a0,866 # 5ae8 <malloc+0xb88>
    378e:	71e010ef          	jal	4eac <printf>
    exit(1);
    3792:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    37ac:	18050513          	addi	a0,a0,384 # 5928 <malloc+0x9c8>
    37b0:	6fc010ef          	jal	4eac <printf>
    exit(1);
    37b4:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37dc:	93058593          	addi	a1,a1,-1744 # 5108 <malloc+0x1a8>
    ...
    37fe:	12e50513          	addi	a0,a0,302 # 5928 <malloc+0x9c8>
    3802:	6aa010ef          	jal	4eac <printf>
     exit(1);
    3806:	4505                	li	a0,1
    ...
    3812:	32250513          	addi	a0,a0,802 # 6b30 <malloc+0x1bd0>
    3816:	696010ef          	jal	4eac <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3842:	30a50513          	addi	a0,a0,778 # 6b48 <malloc+0x1be8>
    3846:	666010ef          	jal	4eac <printf>
}
  ...
  printf("kill... ");
    ...
    3866:	2fe50513          	addi	a0,a0,766 # 6b60 <malloc+0x1c00>
    386a:	642010ef          	jal	4eac <printf>
  kill(pid1);
    386e:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3884:	2f050513          	addi	a0,a0,752 # 6b70 <malloc+0x1c10>
    3888:	624010ef          	jal	4eac <printf>
  wait(0);
    388c:	4501                	li	a0,0
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    38e4:	04850513          	addi	a0,a0,72 # 5928 <malloc+0x9c8>
    38e8:	5c4010ef          	jal	4eac <printf>
      exit(1);
    38ec:	4505                	li	a0,1
    ...
    38f8:	1bc50513          	addi	a0,a0,444 # 5ab0 <malloc+0xb50>
    38fc:	5b0010ef          	jal	4eac <printf>
        exit(1);
    3900:	4505                	li	a0,1
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3952:	0e250513          	addi	a0,a0,226 # 5a30 <malloc+0xad0>
    3956:	556010ef          	jal	4eac <printf>
    exit(1);
    395a:	4505                	li	a0,1
    ...
    3976:	79658593          	addi	a1,a1,1942 # 5108 <malloc+0x1a8>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3a16:	16e50513          	addi	a0,a0,366 # 6b80 <malloc+0x1c20>
    3a1a:	492010ef          	jal	4eac <printf>
    exit(1);
    3a1e:	4505                	li	a0,1
    ...
    3a2a:	f0250513          	addi	a0,a0,-254 # 5928 <malloc+0x9c8>
    3a2e:	47e010ef          	jal	4eac <printf>
    exit(1);
    3a32:	4505                	li	a0,1
    ...
    3a66:	13e50513          	addi	a0,a0,318 # 6ba0 <malloc+0x1c40>
    3a6a:	442010ef          	jal	4eac <printf>
    exit(1);
    3a6e:	4505                	li	a0,1
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3abe:	6084                	ld	s1,0(s1)
      free(m1);
    3ac0:	41e010ef          	jal	4ede <free>
    while(m1){
    3ac4:	fce5                	bnez	s1,3abc <mem+0x42>
    m1 = malloc(1024*20);
    3ac6:	6515                	lui	a0,0x5
    3ac8:	498010ef          	jal	4f60 <malloc>
    if(m1 == 0){
    3acc:	c511                	beqz	a0,3ad8 <mem+0x5e>
    free(m1);
    3ace:	410010ef          	jal	4ede <free>
    exit(0);
    3ad2:	4501                	li	a0,0
    ...
    3ade:	0f650513          	addi	a0,a0,246 # 6bd0 <malloc+0x1c70>
    3ae2:	3ca010ef          	jal	4eac <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
...
0000000000003af2 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b02:	0f250513          	addi	a0,a0,242 # 6bf0 <malloc+0x1c90>
    3b06:	7cb000ef          	jal	4ad0 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b0a:	20200593          	li	a1,514
    3b0e:	00003517          	auipc	a0,0x3
    3b12:	0e250513          	addi	a0,a0,226 # 6bf0 <malloc+0x1c90>
  ...
  if(pid == 0) {
    ...
    3b7c:	08850513          	addi	a0,a0,136 # 6c00 <malloc+0x1ca0>
    3b80:	32c010ef          	jal	4eac <printf>
    exit(1);
    3b84:	4505                	li	a0,1
    ...
    3b90:	09c50513          	addi	a0,a0,156 # 6c28 <malloc+0x1cc8>
    3b94:	318010ef          	jal	4eac <printf>
      exit(1);
    3b98:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bc0:	03450513          	addi	a0,a0,52 # 6bf0 <malloc+0x1c90>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bf8:	05450513          	addi	a0,a0,84 # 6c48 <malloc+0x1ce8>
    3bfc:	2b0010ef          	jal	4eac <printf>
    exit(1);
    3c00:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c28:	fcc50513          	addi	a0,a0,-52 # 6bf0 <malloc+0x1c90>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c4a:	02a50513          	addi	a0,a0,42 # 6c70 <malloc+0x1d10>
    3c4e:	25e010ef          	jal	4eac <printf>
    exit(1);
    3c52:	4505                	li	a0,1
...
0000000000003c5e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c82:	00a78793          	addi	a5,a5,10 # 6c88 <malloc+0x1d28>
    3c86:	f6f43823          	sd	a5,-144(s0)
    3c8a:	00003797          	auipc	a5,0x3
    3c8e:	00678793          	addi	a5,a5,6 # 6c90 <malloc+0x1d30>
    3c92:	f6f43c23          	sd	a5,-136(s0)
    3c96:	00003797          	auipc	a5,0x3
    3c9a:	00278793          	addi	a5,a5,2 # 6c98 <malloc+0x1d38>
    3c9e:	f8f43023          	sd	a5,-128(s0)
    3ca2:	00003797          	auipc	a5,0x3
    3ca6:	ffe78793          	addi	a5,a5,-2 # 6ca0 <malloc+0x1d40>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d08:	c2450513          	addi	a0,a0,-988 # 5928 <malloc+0x9c8>
    3d0c:	1a0010ef          	jal	4eac <printf>
      exit(1);
    3d10:	4505                	li	a0,1
    ...
    3d6a:	c5a50513          	addi	a0,a0,-934 # 59c0 <malloc+0xa60>
    3d6e:	13e010ef          	jal	4eac <printf>
        exit(1);
    3d72:	4505                	li	a0,1
    3d74:	50d000ef          	jal	4a80 <exit>
          printf("write failed %d\n", n);
    3d78:	00003517          	auipc	a0,0x3
    3d7c:	f3050513          	addi	a0,a0,-208 # 6ca8 <malloc+0x1d48>
    3d80:	12c010ef          	jal	4eac <printf>
          exit(1);
    3d84:	4505                	li	a0,1
    ...
    3d96:	f2e50513          	addi	a0,a0,-210 # 6cc0 <malloc+0x1d60>
    3d9a:	112010ef          	jal	4eac <printf>
          exit(1);
    3d9e:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e06:	ece50513          	addi	a0,a0,-306 # 6cd0 <malloc+0x1d70>
    3e0a:	0a2010ef          	jal	4eac <printf>
      exit(1);
    3e0e:	4505                	li	a0,1
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e60:	e8cb8b93          	addi	s7,s7,-372 # 6ce8 <malloc+0x1d88>
  for(i = 0; i < N; i++){
    ...
    3e9a:	e5a50513          	addi	a0,a0,-422 # 6cf0 <malloc+0x1d90>
    3e9e:	00e010ef          	jal	4eac <printf>
        exit(1);
    3ea2:	4505                	li	a0,1
    ...
    3eb0:	e3c50513          	addi	a0,a0,-452 # 6ce8 <malloc+0x1d88>
  ...
  fd = open(".", 0);
    ...
    3ed8:	8ac50513          	addi	a0,a0,-1876 # 5780 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f48:	dcc50513          	addi	a0,a0,-564 # 6d10 <malloc+0x1db0>
    3f4c:	761000ef          	jal	4eac <printf>
        exit(1);
    3f50:	4505                	li	a0,1
    ...
    3f60:	dd450513          	addi	a0,a0,-556 # 6d30 <malloc+0x1dd0>
    3f64:	749000ef          	jal	4eac <printf>
        exit(1);
    3f68:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f8c:	dd050513          	addi	a0,a0,-560 # 6d58 <malloc+0x1df8>
    3f90:	71d000ef          	jal	4eac <printf>
    exit(1);
    3f94:	4505                	li	a0,1
    ...
    3fa0:	98c50513          	addi	a0,a0,-1652 # 5928 <malloc+0x9c8>
    3fa4:	709000ef          	jal	4eac <printf>
      exit(1);
    3fa8:	4505                	li	a0,1
...
00000000000040d6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ee:	ca650513          	addi	a0,a0,-858 # 6d90 <malloc+0x1e30>
    40f2:	1df000ef          	jal	4ad0 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40f6:	20200593          	li	a1,514
    40fa:	00003517          	auipc	a0,0x3
    40fe:	c9650513          	addi	a0,a0,-874 # 6d90 <malloc+0x1e30>
  ...
  fd = open("bigfile.dat", 0);
    ...
    414a:	c4a50513          	addi	a0,a0,-950 # 6d90 <malloc+0x1e30>
  ...
  for(i = 0; ; i++){
    ...
    41a6:	bfe50513          	addi	a0,a0,-1026 # 6da0 <malloc+0x1e40>
    41aa:	503000ef          	jal	4eac <printf>
    exit(1);
    41ae:	4505                	li	a0,1
    ...
    41ba:	c0a50513          	addi	a0,a0,-1014 # 6dc0 <malloc+0x1e60>
    41be:	4ef000ef          	jal	4eac <printf>
      exit(1);
    41c2:	4505                	li	a0,1
    ...
    41ce:	c1650513          	addi	a0,a0,-1002 # 6de0 <malloc+0x1e80>
    41d2:	4db000ef          	jal	4eac <printf>
    exit(1);
    41d6:	4505                	li	a0,1
    ...
    41e2:	c2250513          	addi	a0,a0,-990 # 6e00 <malloc+0x1ea0>
    41e6:	4c7000ef          	jal	4eac <printf>
      exit(1);
    41ea:	4505                	li	a0,1
    ...
    41f6:	c2e50513          	addi	a0,a0,-978 # 6e20 <malloc+0x1ec0>
    41fa:	4b3000ef          	jal	4eac <printf>
      exit(1);
    41fe:	4505                	li	a0,1
    ...
    420a:	c3250513          	addi	a0,a0,-974 # 6e38 <malloc+0x1ed8>
    420e:	49f000ef          	jal	4eac <printf>
      exit(1);
    4212:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    422c:	b6850513          	addi	a0,a0,-1176 # 6d90 <malloc+0x1e30>
    ...
    424c:	c1050513          	addi	a0,a0,-1008 # 6e58 <malloc+0x1ef8>
    4250:	45d000ef          	jal	4eac <printf>
    exit(1);
    4254:	4505                	li	a0,1
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426a:	c1250513          	addi	a0,a0,-1006 # 6e78 <malloc+0x1f18>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4290:	bec50513          	addi	a0,a0,-1044 # 6e78 <malloc+0x1f18>
  ...
  close(fd);
    ...
    42ea:	db250513          	addi	a0,a0,-590 # 5098 <malloc+0x138>
    42ee:	7ca000ef          	jal	4ab8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	b8250513          	addi	a0,a0,-1150 # 6e78 <malloc+0x1f18>
    ...
    4312:	b7a50513          	addi	a0,a0,-1158 # 6e88 <malloc+0x1f28>
    4316:	397000ef          	jal	4eac <printf>
    exit(1);
    431a:	4505                	li	a0,1
    ...
    432a:	b8250513          	addi	a0,a0,-1150 # 6ea8 <malloc+0x1f48>
    432e:	37f000ef          	jal	4eac <printf>
    exit(1);
    4332:	4505                	li	a0,1
...
0000000000004338 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4358:	b7450513          	addi	a0,a0,-1164 # 6ec8 <malloc+0x1f68>
    435c:	351000ef          	jal	4eac <printf>
  for(nfiles = 0; ; nfiles++){
    4360:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4374:	b68c8c93          	addi	s9,s9,-1176 # 6ed8 <malloc+0x1f78>
    name[0] = 'f';
    ...
    43dc:	b1050513          	addi	a0,a0,-1264 # 6ee8 <malloc+0x1f88>
    43e0:	2cd000ef          	jal	4eac <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    444a:	ac250513          	addi	a0,a0,-1342 # 6f08 <malloc+0x1fa8>
    444e:	25f000ef          	jal	4eac <printf>
}
    ...
    4498:	a6450513          	addi	a0,a0,-1436 # 6ef8 <malloc+0x1f98>
    449c:	211000ef          	jal	4eac <printf>
    close(fd);
    44a0:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    44c2:	a6250513          	addi	a0,a0,-1438 # 6f20 <malloc+0x1fc0>
    44c6:	1e7000ef          	jal	4eac <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    44e6:	a6650513          	addi	a0,a0,-1434 # 6f48 <malloc+0x1fe8>
    44ea:	1c3000ef          	jal	4eac <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4506:	a2e50513          	addi	a0,a0,-1490 # 6f30 <malloc+0x1fd0>
    450a:	1a3000ef          	jal	4eac <printf>
    exit(1);
    450e:	4505                	li	a0,1
    ...
    4522:	a3250513          	addi	a0,a0,-1486 # 6f50 <malloc+0x1ff0>
    4526:	187000ef          	jal	4eac <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    457a:	9e250513          	addi	a0,a0,-1566 # 6f58 <malloc+0x1ff8>
    457e:	12f000ef          	jal	4eac <printf>
          return 1;
    4582:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    45da:	b3298993          	addi	s3,s3,-1230 # 5108 <malloc+0x1a8>
      uint64 a = (uint64) sbrk(4096);
    ...
    4604:	9b050513          	addi	a0,a0,-1616 # 6fb0 <malloc+0x2050>
    4608:	0a5000ef          	jal	4eac <printf>
        exit(1);
    460c:	4505                	li	a0,1
    ...
    461c:	95850513          	addi	a0,a0,-1704 # 6f70 <malloc+0x2010>
    4620:	08d000ef          	jal	4eac <printf>
    exit(1);
    4624:	4505                	li	a0,1
    ...
    4634:	96050513          	addi	a0,a0,-1696 # 6f90 <malloc+0x2030>
    4638:	075000ef          	jal	4eac <printf>
    exit(1);
    463c:	4505                	li	a0,1
  ...
  while(1){
    ...
    4674:	96050513          	addi	a0,a0,-1696 # 6fd0 <malloc+0x2070>
    4678:	035000ef          	jal	4eac <printf>
      exit(1);
    467c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    46c2:	932b8b93          	addi	s7,s7,-1742 # 6ff0 <malloc+0x2090>
    int free0 = countfree();
    int free1 = 0;
    ...
    46dc:	930d0d13          	addi	s10,s10,-1744 # 7008 <malloc+0x20a8>
          return 1;
        }
      }
    }
    ...
    46e4:	948c8c93          	addi	s9,s9,-1720 # 7028 <malloc+0x20c8>
    46e8:	a819                	j	46fe <drivetests+0x62>
        printf("usertests slow tests starting\n");
    46ea:	856a                	mv	a0,s10
    46ec:	7c0000ef          	jal	4eac <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    47a0:	8bc58593          	addi	a1,a1,-1860 # 7058 <malloc+0x20f8>
    47a4:	854a                	mv	a0,s2
    ...
    47b2:	8b258593          	addi	a1,a1,-1870 # 7060 <malloc+0x2100>
    47b6:	854a                	mv	a0,s2
    47b8:	08c000ef          	jal	4844 <strcmp>
    47bc:	cd15                	beqz	a0,47f8 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    47be:	00003597          	auipc	a1,0x3
    47c2:	8aa58593          	addi	a1,a1,-1878 # 7068 <malloc+0x2108>
    47c6:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    47e4:	89050513          	addi	a0,a0,-1904 # 7070 <malloc+0x2110>
    47e8:	6c4000ef          	jal	4eac <printf>
    exit(1);
    47ec:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4808:	89c50513          	addi	a0,a0,-1892 # 70a0 <malloc+0x2140>
    480c:	6a0000ef          	jal	4eac <printf>
  exit(0);
    4810:	4501                	li	a0,0
...
trace:
 li a7, SYS_trace
    4b20:	03300893          	li	a7,51
 ecall
    4b24:	00000073          	ecall
 ret
    4b28:	8082                	ret

0000000000004b2a <stats>:

.global stats
stats:
 li a7, SYS_stats
    4b2a:	03400893          	li	a7,52
 ecall
    4b2e:	00000073          	ecall
 ret
    4b32:	8082                	ret

0000000000004b34 <putc>:
...
putc(int fd, char c)
{
    4b34:	1101                	addi	sp,sp,-32
    4b36:	ec06                	sd	ra,24(sp)
    4b38:	e822                	sd	s0,16(sp)
    4b3a:	1000                	addi	s0,sp,32
    4b3c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4b40:	4605                	li	a2,1
    4b42:	fef40593          	addi	a1,s0,-17
    4b46:	f5bff0ef          	jal	4aa0 <write>
}
    4b4a:	60e2                	ld	ra,24(sp)
    4b4c:	6442                	ld	s0,16(sp)
    4b4e:	6105                	addi	sp,sp,32
    4b50:	8082                	ret

0000000000004b52 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    4b5e:	c299                	beqz	a3,4b64 <printint+0x12>
    4b60:	0805c963          	bltz	a1,4bf2 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4b64:	2581                	sext.w	a1,a1
  neg = 0;
    4b66:	4881                	li	a7,0
    4b68:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4b6e:	2601                	sext.w	a2,a2
    4b70:	00003517          	auipc	a0,0x3
    4b74:	90050513          	addi	a0,a0,-1792 # 7470 <digits>
    4b78:	883a                	mv	a6,a4
    4b7a:	2705                	addiw	a4,a4,1
    4b7c:	02c5f7bb          	remuw	a5,a1,a2
    4b80:	1782                	slli	a5,a5,0x20
    4b82:	9381                	srli	a5,a5,0x20
    4b84:	97aa                	add	a5,a5,a0
    4b86:	0007c783          	lbu	a5,0(a5)
    4b8a:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4b8e:	0005879b          	sext.w	a5,a1
    4b92:	02c5d5bb          	divuw	a1,a1,a2
    4b96:	0685                	addi	a3,a3,1
    4b98:	fec7f0e3          	bgeu	a5,a2,4b78 <printint+0x26>
  if(neg)
    4b9c:	00088c63          	beqz	a7,4bb4 <printint+0x62>
    buf[i++] = '-';
    4ba0:	fd070793          	addi	a5,a4,-48
    4ba4:	00878733          	add	a4,a5,s0
    4ba8:	02d00793          	li	a5,45
    4bac:	fef70823          	sb	a5,-16(a4)
    4bb0:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4bb4:	02e05a63          	blez	a4,4be8 <printint+0x96>
    4bb8:	f04a                	sd	s2,32(sp)
    4bba:	ec4e                	sd	s3,24(sp)
    4bbc:	fc040793          	addi	a5,s0,-64
    4bc0:	00e78933          	add	s2,a5,a4
    4bc4:	fff78993          	addi	s3,a5,-1
    4bc8:	99ba                	add	s3,s3,a4
    4bca:	377d                	addiw	a4,a4,-1
    4bcc:	1702                	slli	a4,a4,0x20
    4bce:	9301                	srli	a4,a4,0x20
    4bd0:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4bd4:	fff94583          	lbu	a1,-1(s2)
    4bd8:	8526                	mv	a0,s1
    4bda:	f5bff0ef          	jal	4b34 <putc>
  while(--i >= 0)
    4bde:	197d                	addi	s2,s2,-1
    4be0:	ff391ae3          	bne	s2,s3,4bd4 <printint+0x82>
    4be4:	7902                	ld	s2,32(sp)
    4be6:	69e2                	ld	s3,24(sp)
}
    4be8:	70e2                	ld	ra,56(sp)
    4bea:	7442                	ld	s0,48(sp)
    4bec:	74a2                	ld	s1,40(sp)
    4bee:	6121                	addi	sp,sp,64
    4bf0:	8082                	ret
    x = -xx;
    4bf2:	40b005bb          	negw	a1,a1
    neg = 1;
    4bf6:	4885                	li	a7,1
    x = -xx;
    4bf8:	bf85                	j	4b68 <printint+0x16>

0000000000004bfa <vprintf>:
}
...
{
    4bfa:	711d                	addi	sp,sp,-96
    4bfc:	ec86                	sd	ra,88(sp)
    4bfe:	e8a2                	sd	s0,80(sp)
    4c00:	e0ca                	sd	s2,64(sp)
    4c02:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4c04:	0005c903          	lbu	s2,0(a1)
    4c08:	26090863          	beqz	s2,4e78 <vprintf+0x27e>
    4c0c:	e4a6                	sd	s1,72(sp)
    4c0e:	fc4e                	sd	s3,56(sp)
    4c10:	f852                	sd	s4,48(sp)
    4c12:	f456                	sd	s5,40(sp)
    4c14:	f05a                	sd	s6,32(sp)
    4c16:	ec5e                	sd	s7,24(sp)
    4c18:	e862                	sd	s8,16(sp)
    4c1a:	e466                	sd	s9,8(sp)
    4c1c:	8b2a                	mv	s6,a0
    4c1e:	8a2e                	mv	s4,a1
    4c20:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4c28:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4c2c:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4c30:	06c00c93          	li	s9,108
    4c34:	a005                	j	4c54 <vprintf+0x5a>
        putc(fd, c0);
    4c36:	85ca                	mv	a1,s2
    4c38:	855a                	mv	a0,s6
    4c3a:	efbff0ef          	jal	4b34 <putc>
    4c3e:	a019                	j	4c44 <vprintf+0x4a>
    } else if(state == '%'){
    4c40:	03598263          	beq	s3,s5,4c64 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4c44:	2485                	addiw	s1,s1,1
    4c46:	8726                	mv	a4,s1
    4c48:	009a07b3          	add	a5,s4,s1
    4c4c:	0007c903          	lbu	s2,0(a5)
    4c50:	20090c63          	beqz	s2,4e68 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
    4c54:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4c58:	fe0994e3          	bnez	s3,4c40 <vprintf+0x46>
      if(c0 == '%'){
    4c5c:	fd579de3          	bne	a5,s5,4c36 <vprintf+0x3c>
        state = '%';
    4c60:	89be                	mv	s3,a5
    4c62:	b7cd                	j	4c44 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4c64:	00ea06b3          	add	a3,s4,a4
    4c68:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4c6c:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4c6e:	c681                	beqz	a3,4c76 <vprintf+0x7c>
    4c70:	9752                	add	a4,a4,s4
    4c72:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4c76:	03878f63          	beq	a5,s8,4cb4 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
    4c7a:	05978963          	beq	a5,s9,4ccc <vprintf+0xd2>
    ...
    4c7e:	07500713          	li	a4,117
    4c82:	0ee78363          	beq	a5,a4,4d68 <vprintf+0x16e>
    ...
    4c86:	07800713          	li	a4,120
    4c8a:	12e78563          	beq	a5,a4,4db4 <vprintf+0x1ba>
    ...
    4c8e:	07000713          	li	a4,112
    4c92:	14e78a63          	beq	a5,a4,4de6 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4c96:	07300713          	li	a4,115
    4c9a:	18e78a63          	beq	a5,a4,4e2e <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4c9e:	02500713          	li	a4,37
    4ca2:	04e79563          	bne	a5,a4,4cec <vprintf+0xf2>
        putc(fd, '%');
    4ca6:	02500593          	li	a1,37
    4caa:	855a                	mv	a0,s6
    4cac:	e89ff0ef          	jal	4b34 <putc>
      ...
      state = 0;
    4cb0:	4981                	li	s3,0
    4cb2:	bf49                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4cb4:	008b8913          	addi	s2,s7,8
    4cb8:	4685                	li	a3,1
    4cba:	4629                	li	a2,10
    4cbc:	000ba583          	lw	a1,0(s7)
    4cc0:	855a                	mv	a0,s6
    4cc2:	e91ff0ef          	jal	4b52 <printint>
    4cc6:	8bca                	mv	s7,s2
      state = 0;
    4cc8:	4981                	li	s3,0
    4cca:	bfad                	j	4c44 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4ccc:	06400793          	li	a5,100
    4cd0:	02f68963          	beq	a3,a5,4d02 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4cd4:	06c00793          	li	a5,108
    4cd8:	04f68263          	beq	a3,a5,4d1c <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
    4cdc:	07500793          	li	a5,117
    4ce0:	0af68063          	beq	a3,a5,4d80 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
    4ce4:	07800793          	li	a5,120
    4ce8:	0ef68263          	beq	a3,a5,4dcc <vprintf+0x1d2>
        putc(fd, '%');
    4cec:	02500593          	li	a1,37
    4cf0:	855a                	mv	a0,s6
    4cf2:	e43ff0ef          	jal	4b34 <putc>
        putc(fd, c0);
    4cf6:	85ca                	mv	a1,s2
    4cf8:	855a                	mv	a0,s6
    4cfa:	e3bff0ef          	jal	4b34 <putc>
      state = 0;
    4cfe:	4981                	li	s3,0
    4d00:	b791                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d02:	008b8913          	addi	s2,s7,8
    4d06:	4685                	li	a3,1
    4d08:	4629                	li	a2,10
    4d0a:	000ba583          	lw	a1,0(s7)
    4d0e:	855a                	mv	a0,s6
    4d10:	e43ff0ef          	jal	4b52 <printint>
        i += 1;
    4d14:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d16:	8bca                	mv	s7,s2
      state = 0;
    4d18:	4981                	li	s3,0
        i += 1;
    4d1a:	b72d                	j	4c44 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4d1c:	06400793          	li	a5,100
    4d20:	02f60763          	beq	a2,a5,4d4e <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4d24:	07500793          	li	a5,117
    4d28:	06f60963          	beq	a2,a5,4d9a <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4d2c:	07800793          	li	a5,120
    4d30:	faf61ee3          	bne	a2,a5,4cec <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4d40:	855a                	mv	a0,s6
    4d42:	e11ff0ef          	jal	4b52 <printint>
        i += 2;
    4d46:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4d48:	8bca                	mv	s7,s2
      state = 0;
    4d4a:	4981                	li	s3,0
        i += 2;
    4d4c:	bde5                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d4e:	008b8913          	addi	s2,s7,8
    4d52:	4685                	li	a3,1
    4d54:	4629                	li	a2,10
    4d56:	000ba583          	lw	a1,0(s7)
    4d5a:	855a                	mv	a0,s6
    4d5c:	df7ff0ef          	jal	4b52 <printint>
        i += 2;
    4d60:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d62:	8bca                	mv	s7,s2
      state = 0;
    4d64:	4981                	li	s3,0
        i += 2;
    4d66:	bdf9                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 0);
    4d68:	008b8913          	addi	s2,s7,8
    4d6c:	4681                	li	a3,0
    4d6e:	4629                	li	a2,10
    4d70:	000ba583          	lw	a1,0(s7)
    4d74:	855a                	mv	a0,s6
    4d76:	dddff0ef          	jal	4b52 <printint>
    4d7a:	8bca                	mv	s7,s2
      state = 0;
    4d7c:	4981                	li	s3,0
    4d7e:	b5d9                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4d8c:	855a                	mv	a0,s6
    4d8e:	dc5ff0ef          	jal	4b52 <printint>
        i += 1;
    4d92:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    4d94:	8bca                	mv	s7,s2
      state = 0;
    4d96:	4981                	li	s3,0
        i += 1;
    4d98:	b575                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4d9a:	008b8913          	addi	s2,s7,8
    4d9e:	4681                	li	a3,0
    4da0:	4629                	li	a2,10
    4da2:	000ba583          	lw	a1,0(s7)
    4da6:	855a                	mv	a0,s6
    4da8:	dabff0ef          	jal	4b52 <printint>
        i += 2;
    4dac:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4dae:	8bca                	mv	s7,s2
      state = 0;
    4db0:	4981                	li	s3,0
        i += 2;
    4db2:	bd49                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 16, 0);
    4db4:	008b8913          	addi	s2,s7,8
    4db8:	4681                	li	a3,0
    4dba:	4641                	li	a2,16
    4dbc:	000ba583          	lw	a1,0(s7)
    4dc0:	855a                	mv	a0,s6
    4dc2:	d91ff0ef          	jal	4b52 <printint>
    4dc6:	8bca                	mv	s7,s2
      state = 0;
    4dc8:	4981                	li	s3,0
    4dca:	bdad                	j	4c44 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4dcc:	008b8913          	addi	s2,s7,8
    4dd0:	4681                	li	a3,0
    4dd2:	4641                	li	a2,16
    4dd4:	000ba583          	lw	a1,0(s7)
    4dd8:	855a                	mv	a0,s6
    4dda:	d79ff0ef          	jal	4b52 <printint>
        i += 1;
    ...
    4de2:	4981                	li	s3,0
        i += 1;
    4de4:	b585                	j	4c44 <vprintf+0x4a>
    4de6:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    4de8:	008b8d13          	addi	s10,s7,8
    4dec:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4df0:	03000593          	li	a1,48
    4df4:	855a                	mv	a0,s6
    4df6:	d3fff0ef          	jal	4b34 <putc>
  putc(fd, 'x');
    4dfa:	07800593          	li	a1,120
    4dfe:	855a                	mv	a0,s6
    4e00:	d35ff0ef          	jal	4b34 <putc>
    4e04:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4e06:	00002b97          	auipc	s7,0x2
    4e0a:	66ab8b93          	addi	s7,s7,1642 # 7470 <digits>
    4e0e:	03c9d793          	srli	a5,s3,0x3c
    4e12:	97de                	add	a5,a5,s7
    4e14:	0007c583          	lbu	a1,0(a5)
    4e18:	855a                	mv	a0,s6
    4e1a:	d1bff0ef          	jal	4b34 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4e1e:	0992                	slli	s3,s3,0x4
    4e20:	397d                	addiw	s2,s2,-1
    4e22:	fe0916e3          	bnez	s2,4e0e <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
    4e26:	8bea                	mv	s7,s10
      state = 0;
    4e28:	4981                	li	s3,0
    4e2a:	6d02                	ld	s10,0(sp)
    4e2c:	bd21                	j	4c44 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    4e2e:	008b8993          	addi	s3,s7,8
    4e32:	000bb903          	ld	s2,0(s7)
    4e36:	00090f63          	beqz	s2,4e54 <vprintf+0x25a>
        for(; *s; s++)
    4e3a:	00094583          	lbu	a1,0(s2)
    4e3e:	c195                	beqz	a1,4e62 <vprintf+0x268>
          putc(fd, *s);
    4e40:	855a                	mv	a0,s6
    4e42:	cf3ff0ef          	jal	4b34 <putc>
        for(; *s; s++)
    4e46:	0905                	addi	s2,s2,1
    4e48:	00094583          	lbu	a1,0(s2)
    4e4c:	f9f5                	bnez	a1,4e40 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e4e:	8bce                	mv	s7,s3
      state = 0;
    4e50:	4981                	li	s3,0
    4e52:	bbcd                	j	4c44 <vprintf+0x4a>
          s = "(null)";
    4e54:	00002917          	auipc	s2,0x2
    4e58:	59c90913          	addi	s2,s2,1436 # 73f0 <malloc+0x2490>
        for(; *s; s++)
    4e5c:	02800593          	li	a1,40
    4e60:	b7c5                	j	4e40 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e62:	8bce                	mv	s7,s3
      state = 0;
    4e64:	4981                	li	s3,0
    4e66:	bbf9                	j	4c44 <vprintf+0x4a>
    4e68:	64a6                	ld	s1,72(sp)
    4e6a:	79e2                	ld	s3,56(sp)
    4e6c:	7a42                	ld	s4,48(sp)
    4e6e:	7aa2                	ld	s5,40(sp)
    4e70:	7b02                	ld	s6,32(sp)
    4e72:	6be2                	ld	s7,24(sp)
    4e74:	6c42                	ld	s8,16(sp)
    4e76:	6ca2                	ld	s9,8(sp)
    }
  }
}
    4e78:	60e6                	ld	ra,88(sp)
    4e7a:	6446                	ld	s0,80(sp)
    4e7c:	6906                	ld	s2,64(sp)
    4e7e:	6125                	addi	sp,sp,96
    4e80:	8082                	ret

0000000000004e82 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4e82:	715d                	addi	sp,sp,-80
    4e84:	ec06                	sd	ra,24(sp)
    4e86:	e822                	sd	s0,16(sp)
    4e88:	1000                	addi	s0,sp,32
    4e8a:	e010                	sd	a2,0(s0)
    4e8c:	e414                	sd	a3,8(s0)
    4e8e:	e818                	sd	a4,16(s0)
    4e90:	ec1c                	sd	a5,24(s0)
    4e92:	03043023          	sd	a6,32(s0)
    4e96:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4e9a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4e9e:	8622                	mv	a2,s0
    4ea0:	d5bff0ef          	jal	4bfa <vprintf>
}
    4ea4:	60e2                	ld	ra,24(sp)
    4ea6:	6442                	ld	s0,16(sp)
    4ea8:	6161                	addi	sp,sp,80
    4eaa:	8082                	ret

0000000000004eac <printf>:

void
printf(const char *fmt, ...)
{
    4eac:	711d                	addi	sp,sp,-96
    4eae:	ec06                	sd	ra,24(sp)
    4eb0:	e822                	sd	s0,16(sp)
    4eb2:	1000                	addi	s0,sp,32
    4eb4:	e40c                	sd	a1,8(s0)
    4eb6:	e810                	sd	a2,16(s0)
    4eb8:	ec14                	sd	a3,24(s0)
    4eba:	f018                	sd	a4,32(s0)
    4ebc:	f41c                	sd	a5,40(s0)
    4ebe:	03043823          	sd	a6,48(s0)
    4ec2:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4ec6:	00840613          	addi	a2,s0,8
    4eca:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4ece:	85aa                	mv	a1,a0
    4ed0:	4505                	li	a0,1
    4ed2:	d29ff0ef          	jal	4bfa <vprintf>
}
    4ed6:	60e2                	ld	ra,24(sp)
    4ed8:	6442                	ld	s0,16(sp)
    4eda:	6125                	addi	sp,sp,96
    4edc:	8082                	ret

0000000000004ede <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    4ee0:	e422                	sd	s0,8(sp)
    4ee2:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4ee4:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4ee8:	00004797          	auipc	a5,0x4
    4eec:	5687b783          	ld	a5,1384(a5) # 9450 <freep>
    4ef0:	a02d                	j	4f1a <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4ef2:	4618                	lw	a4,8(a2)
    4ef4:	9f2d                	addw	a4,a4,a1
    4ef6:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4efa:	6398                	ld	a4,0(a5)
    4efc:	6310                	ld	a2,0(a4)
    4efe:	a83d                	j	4f3c <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4f00:	ff852703          	lw	a4,-8(a0)
    4f04:	9f31                	addw	a4,a4,a2
    4f06:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    4f08:	ff053683          	ld	a3,-16(a0)
    4f0c:	a091                	j	4f50 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f0e:	6398                	ld	a4,0(a5)
    4f10:	00e7e463          	bltu	a5,a4,4f18 <free+0x3a>
    4f14:	00e6ea63          	bltu	a3,a4,4f28 <free+0x4a>
{
    4f18:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f1a:	fed7fae3          	bgeu	a5,a3,4f0e <free+0x30>
    4f1e:	6398                	ld	a4,0(a5)
    4f20:	00e6e463          	bltu	a3,a4,4f28 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f24:	fee7eae3          	bltu	a5,a4,4f18 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    4f28:	ff852583          	lw	a1,-8(a0)
    4f2c:	6390                	ld	a2,0(a5)
    4f2e:	02059813          	slli	a6,a1,0x20
    4f32:	01c85713          	srli	a4,a6,0x1c
    4f36:	9736                	add	a4,a4,a3
    4f38:	fae60de3          	beq	a2,a4,4ef2 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    4f3c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4f40:	4790                	lw	a2,8(a5)
    4f42:	02061593          	slli	a1,a2,0x20
    4f46:	01c5d713          	srli	a4,a1,0x1c
    4f4a:	973e                	add	a4,a4,a5
    4f4c:	fae68ae3          	beq	a3,a4,4f00 <free+0x22>
    p->s.ptr = bp->s.ptr;
    4f50:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    4f52:	00004717          	auipc	a4,0x4
    4f56:	4ef73f23          	sd	a5,1278(a4) # 9450 <freep>
}
    4f5a:	6422                	ld	s0,8(sp)
    4f5c:	0141                	addi	sp,sp,16
    4f5e:	8082                	ret

0000000000004f60 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    4f60:	7139                	addi	sp,sp,-64
    4f62:	fc06                	sd	ra,56(sp)
    4f64:	f822                	sd	s0,48(sp)
    4f66:	f426                	sd	s1,40(sp)
    4f68:	ec4e                	sd	s3,24(sp)
    4f6a:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4f6c:	02051493          	slli	s1,a0,0x20
    4f70:	9081                	srli	s1,s1,0x20
    4f72:	04bd                	addi	s1,s1,15
    4f74:	8091                	srli	s1,s1,0x4
    4f76:	0014899b          	addiw	s3,s1,1
    4f7a:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4f7c:	00004517          	auipc	a0,0x4
    4f80:	4d453503          	ld	a0,1236(a0) # 9450 <freep>
    4f84:	c915                	beqz	a0,4fb8 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4f86:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4f88:	4798                	lw	a4,8(a5)
    4f8a:	08977a63          	bgeu	a4,s1,501e <malloc+0xbe>
    4f8e:	f04a                	sd	s2,32(sp)
    4f90:	e852                	sd	s4,16(sp)
    4f92:	e456                	sd	s5,8(sp)
    4f94:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    4f96:	8a4e                	mv	s4,s3
    4f98:	0009871b          	sext.w	a4,s3
    4f9c:	6685                	lui	a3,0x1
    4f9e:	00d77363          	bgeu	a4,a3,4fa4 <malloc+0x44>
    4fa2:	6a05                	lui	s4,0x1
    4fa4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4fa8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4fac:	00004917          	auipc	s2,0x4
    4fb0:	4a490913          	addi	s2,s2,1188 # 9450 <freep>
  if(p == (char*)-1)
    4fb4:	5afd                	li	s5,-1
    4fb6:	a081                	j	4ff6 <malloc+0x96>
    4fb8:	f04a                	sd	s2,32(sp)
    4fba:	e852                	sd	s4,16(sp)
    4fbc:	e456                	sd	s5,8(sp)
    4fbe:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    4fc0:	0000b797          	auipc	a5,0xb
    4fc4:	cb878793          	addi	a5,a5,-840 # fc78 <base>
    4fc8:	00004717          	auipc	a4,0x4
    4fcc:	48f73423          	sd	a5,1160(a4) # 9450 <freep>
    4fd0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    4fd2:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    4fd6:	b7c1                	j	4f96 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    4fd8:	6398                	ld	a4,0(a5)
    4fda:	e118                	sd	a4,0(a0)
    4fdc:	a8a9                	j	5036 <malloc+0xd6>
  hp->s.size = nu;
    4fde:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    4fe2:	0541                	addi	a0,a0,16
    4fe4:	efbff0ef          	jal	4ede <free>
  return freep;
    4fe8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    4fec:	c12d                	beqz	a0,504e <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4fee:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4ff0:	4798                	lw	a4,8(a5)
    4ff2:	02977263          	bgeu	a4,s1,5016 <malloc+0xb6>
    if(p == freep)
    4ff6:	00093703          	ld	a4,0(s2)
    4ffa:	853e                	mv	a0,a5
    4ffc:	fef719e3          	bne	a4,a5,4fee <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5000:	8552                	mv	a0,s4
    5002:	b07ff0ef          	jal	4b08 <sbrk>
  if(p == (char*)-1)
    5006:	fd551ce3          	bne	a0,s5,4fde <malloc+0x7e>
        return 0;
    500a:	4501                	li	a0,0
    500c:	7902                	ld	s2,32(sp)
    500e:	6a42                	ld	s4,16(sp)
    5010:	6aa2                	ld	s5,8(sp)
    5012:	6b02                	ld	s6,0(sp)
    5014:	a03d                	j	5042 <malloc+0xe2>
    5016:	7902                	ld	s2,32(sp)
    5018:	6a42                	ld	s4,16(sp)
    501a:	6aa2                	ld	s5,8(sp)
    501c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    501e:	fae48de3          	beq	s1,a4,4fd8 <malloc+0x78>
        p->s.size -= nunits;
    5022:	4137073b          	subw	a4,a4,s3
    5026:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5028:	02071693          	slli	a3,a4,0x20
    502c:	01c6d713          	srli	a4,a3,0x1c
    5030:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5032:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5036:	00004717          	auipc	a4,0x4
    503a:	40a73d23          	sd	a0,1050(a4) # 9450 <freep>
      return (void*)(p + 1);
    503e:	01078513          	addi	a0,a5,16
  }
}
    5042:	70e2                	ld	ra,56(sp)
    5044:	7442                	ld	s0,48(sp)
    5046:	74a2                	ld	s1,40(sp)
    5048:	69e2                	ld	s3,24(sp)
    504a:	6121                	addi	sp,sp,64
    504c:	8082                	ret
    504e:	7902                	ld	s2,32(sp)
    5050:	6a42                	ld	s4,16(sp)
    5052:	6aa2                	ld	s5,8(sp)
    5054:	6b02                	ld	s6,0(sp)
    5056:	b7f5                	j	5042 <malloc+0xe2>
