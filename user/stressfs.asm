...
stat(const char *n, struct stat *st)
{
 ...
 22a:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 22c:	85ca                	mv	a1,s2
 22e:	164000ef          	jal	392 <fstat>
 232:	892a                	mv	s2,a0
  close(fd);
 234:	8526                	mv	a0,s1
 236:	1a4000ef          	jal	3da <close>
  return r;
 23a:	64a2                	ld	s1,8(sp)
}
 23c:	854a                	mv	a0,s2
