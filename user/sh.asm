...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	1ce58593          	addi	a1,a1,462 # 11e0 <malloc+0x104>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	19c58593          	addi	a1,a1,412 # 11f0 <malloc+0x114>
      5c:	4509                	li	a0,2
      5e:	7a1000ef          	jal	ffe <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	17650513          	addi	a0,a0,374 # 11f8 <malloc+0x11c>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	24e70713          	addi	a4,a4,590 # 12f8 <malloc+0x21c>
    ...
    panic("runcmd");
      ...
      c6:	13e50513          	addi	a0,a0,318 # 1200 <malloc+0x124>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	12c58593          	addi	a1,a1,300 # 1208 <malloc+0x12c>
      e4:	4509                	li	a0,2
      e6:	719000ef          	jal	ffe <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	10858593          	addi	a1,a1,264 # 1218 <malloc+0x13c>
     118:	4509                	li	a0,2
     11a:	6e5000ef          	jal	ffe <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	0b650513          	addi	a0,a0,182 # 1228 <malloc+0x14c>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	d84a8a93          	addi	s5,s5,-636 # 1250 <malloc+0x174>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	d5250513          	addi	a0,a0,-686 # 1230 <malloc+0x154>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	cbe60613          	addi	a2,a2,-834 # 1258 <malloc+0x17c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	caeb0b13          	addi	s6,s6,-850 # 1278 <malloc+0x19c>
  ...
  return ret;
     ...
     5f8:	c6c50513          	addi	a0,a0,-916 # 1260 <malloc+0x184>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c2250513          	addi	a0,a0,-990 # 1268 <malloc+0x18c>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	bfc60613          	addi	a2,a2,-1028 # 1280 <malloc+0x1a4>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	ba8a0a13          	addi	s4,s4,-1112 # 1288 <malloc+0x1ac>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	b8660613          	addi	a2,a2,-1146 # 1290 <malloc+0x1b4>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	af860613          	addi	a2,a2,-1288 # 1258 <malloc+0x17c>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b2460613          	addi	a2,a2,-1244 # 12a8 <malloc+0x1cc>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	ade50513          	addi	a0,a0,-1314 # 1298 <malloc+0x1bc>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	aea50513          	addi	a0,a0,-1302 # 12b0 <malloc+0x1d4>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b2270713          	addi	a4,a4,-1246 # 1310 <malloc+0x234>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	96e60613          	addi	a2,a2,-1682 # 11e8 <malloc+0x10c>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a2058593          	addi	a1,a1,-1504 # 12c8 <malloc+0x1ec>
     8b0:	4509                	li	a0,2
     8b2:	74c000ef          	jal	ffe <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	9aa50513          	addi	a0,a0,-1622 # 1260 <malloc+0x184>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8d6:	a0648493          	addi	s1,s1,-1530 # 12d8 <malloc+0x1fc>
     8da:	4589                	li	a1,2
     8dc:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     970:	97458593          	addi	a1,a1,-1676 # 12e0 <malloc+0x204>
     974:	4509                	li	a0,2
     976:	688000ef          	jal	ffe <fprintf>
...
0000000000000c9c <trace>:
///////
.global trace
trace:
  li a7, SYS_trace
     c9c:	03300893          	li	a7,51
  ecall
     ca0:	00000073          	ecall
  ret
     ca4:	8082                	ret

0000000000000ca6 <stats>:

.global stats
stats:
  li a7, SYS_stats
     ca6:	03400893          	li	a7,52
  ecall
     caa:	00000073          	ecall
  ret
     cae:	8082                	ret
...
putc(int fd, char c)
{
     ...
     cb8:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     cbc:	4605                	li	a2,1
     cbe:	fef40593          	addi	a1,s0,-17
     cc2:	f5bff0ef          	jal	c1c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     cda:	c299                	beqz	a3,ce0 <printint+0x12>
     cdc:	0805c963          	bltz	a1,d6e <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     ce0:	2581                	sext.w	a1,a1
  neg = 0;
     ce2:	4881                	li	a7,0
     ce4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     cea:	2601                	sext.w	a2,a2
     cec:	00000517          	auipc	a0,0x0
     cf0:	63c50513          	addi	a0,a0,1596 # 1328 <digits>
     cf4:	883a                	mv	a6,a4
     cf6:	2705                	addiw	a4,a4,1
     cf8:	02c5f7bb          	remuw	a5,a1,a2
     cfc:	1782                	slli	a5,a5,0x20
     cfe:	9381                	srli	a5,a5,0x20
     d00:	97aa                	add	a5,a5,a0
     d02:	0007c783          	lbu	a5,0(a5)
     d06:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     d0a:	0005879b          	sext.w	a5,a1
     d0e:	02c5d5bb          	divuw	a1,a1,a2
     d12:	0685                	addi	a3,a3,1
     d14:	fec7f0e3          	bgeu	a5,a2,cf4 <printint+0x26>
  if(neg)
     d18:	00088c63          	beqz	a7,d30 <printint+0x62>
    buf[i++] = '-';
     d1c:	fd070793          	addi	a5,a4,-48
     d20:	00878733          	add	a4,a5,s0
     d24:	02d00793          	li	a5,45
     d28:	fef70823          	sb	a5,-16(a4)
     d2c:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     d30:	02e05a63          	blez	a4,d64 <printint+0x96>
     d34:	f04a                	sd	s2,32(sp)
     d36:	ec4e                	sd	s3,24(sp)
     d38:	fc040793          	addi	a5,s0,-64
     d3c:	00e78933          	add	s2,a5,a4
     d40:	fff78993          	addi	s3,a5,-1
     d44:	99ba                	add	s3,s3,a4
     d46:	377d                	addiw	a4,a4,-1
     d48:	1702                	slli	a4,a4,0x20
     d4a:	9301                	srli	a4,a4,0x20
     d4c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     d50:	fff94583          	lbu	a1,-1(s2)
     d54:	8526                	mv	a0,s1
     d56:	f5bff0ef          	jal	cb0 <putc>
  while(--i >= 0)
     d5a:	197d                	addi	s2,s2,-1
     d5c:	ff391ae3          	bne	s2,s3,d50 <printint+0x82>
     d60:	7902                	ld	s2,32(sp)
     d62:	69e2                	ld	s3,24(sp)
}
     d64:	70e2                	ld	ra,56(sp)
     d66:	7442                	ld	s0,48(sp)
     d68:	74a2                	ld	s1,40(sp)
     d6a:	6121                	addi	sp,sp,64
     d6c:	8082                	ret
    x = -xx;
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     d80:	0005c903          	lbu	s2,0(a1)
     d84:	26090863          	beqz	s2,ff4 <vprintf+0x27e>
     d88:	e4a6                	sd	s1,72(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     db0:	a005                	j	dd0 <vprintf+0x5a>
        putc(fd, c0);
     db2:	85ca                	mv	a1,s2
     db4:	855a                	mv	a0,s6
     db6:	efbff0ef          	jal	cb0 <putc>
     dba:	a019                	j	dc0 <vprintf+0x4a>
    } else if(state == '%'){
     dbc:	03598263          	beq	s3,s5,de0 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     dc0:	2485                	addiw	s1,s1,1
     dc2:	8726                	mv	a4,s1
     dc4:	009a07b3          	add	a5,s4,s1
     dc8:	0007c903          	lbu	s2,0(a5)
     dcc:	20090c63          	beqz	s2,fe4 <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
     dd0:	0009079b          	sext.w	a5,s2
    if(state == 0){
     dd4:	fe0994e3          	bnez	s3,dbc <vprintf+0x46>
      if(c0 == '%'){
     dd8:	fd579de3          	bne	a5,s5,db2 <vprintf+0x3c>
        state = '%';
     ddc:	89be                	mv	s3,a5
     dde:	b7cd                	j	dc0 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     ...
     de8:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     dea:	c681                	beqz	a3,df2 <vprintf+0x7c>
     dec:	9752                	add	a4,a4,s4
     dee:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     df2:	03878f63          	beq	a5,s8,e30 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
     df6:	05978963          	beq	a5,s9,e48 <vprintf+0xd2>
     ...
     dfe:	0ee78363          	beq	a5,a4,ee4 <vprintf+0x16e>
     ...
     e06:	12e78563          	beq	a5,a4,f30 <vprintf+0x1ba>
     ...
     e0e:	14e78a63          	beq	a5,a4,f62 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
     e12:	07300713          	li	a4,115
     e16:	18e78a63          	beq	a5,a4,faa <vprintf+0x234>
     ...
     e1e:	04e79563          	bne	a5,a4,e68 <vprintf+0xf2>
        putc(fd, '%');
     e22:	02500593          	li	a1,37
     e26:	855a                	mv	a0,s6
     e28:	e89ff0ef          	jal	cb0 <putc>
     ...
     e6c:	855a                	mv	a0,s6
     e6e:	e43ff0ef          	jal	cb0 <putc>
        putc(fd, c0);
     e72:	85ca                	mv	a1,s2
     e74:	855a                	mv	a0,s6
     e76:	e3bff0ef          	jal	cb0 <putc>
      state = 0;
     e7a:	4981                	li	s3,0
     ...
     f54:	855a                	mv	a0,s6
     f56:	d79ff0ef          	jal	cce <printint>
        i += 1;
     f5a:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
     f5c:	8bca                	mv	s7,s2
      state = 0;
     f5e:	4981                	li	s3,0
  ...
  putc(fd, '0');
     ...
     f70:	855a                	mv	a0,s6
     f72:	d3fff0ef          	jal	cb0 <putc>
  putc(fd, 'x');
     f76:	07800593          	li	a1,120
     f7a:	855a                	mv	a0,s6
     f7c:	d35ff0ef          	jal	cb0 <putc>
     f80:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f82:	00000b97          	auipc	s7,0x0
     f86:	3a6b8b93          	addi	s7,s7,934 # 1328 <digits>
     f8a:	03c9d793          	srli	a5,s3,0x3c
     f8e:	97de                	add	a5,a5,s7
     f90:	0007c583          	lbu	a1,0(a5)
     f94:	855a                	mv	a0,s6
     f96:	d1bff0ef          	jal	cb0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     f9a:	0992                	slli	s3,s3,0x4
     f9c:	397d                	addiw	s2,s2,-1
     f9e:	fe0916e3          	bnez	s2,f8a <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
     fa2:	8bea                	mv	s7,s10
      state = 0;
     fa4:	4981                	li	s3,0
     fa6:	6d02                	ld	s10,0(sp)
     fa8:	bd21                	j	dc0 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     faa:	008b8993          	addi	s3,s7,8
     fae:	000bb903          	ld	s2,0(s7)
     fb2:	00090f63          	beqz	s2,fd0 <vprintf+0x25a>
        for(; *s; s++)
     fb6:	00094583          	lbu	a1,0(s2)
     fba:	c195                	beqz	a1,fde <vprintf+0x268>
          putc(fd, *s);
     fbc:	855a                	mv	a0,s6
     fbe:	cf3ff0ef          	jal	cb0 <putc>
        for(; *s; s++)
     fc2:	0905                	addi	s2,s2,1
     fc4:	00094583          	lbu	a1,0(s2)
     fc8:	f9f5                	bnez	a1,fbc <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     fca:	8bce                	mv	s7,s3
      state = 0;
     fcc:	4981                	li	s3,0
     fce:	bbcd                	j	dc0 <vprintf+0x4a>
          s = "(null)";
     fd0:	00000917          	auipc	s2,0x0
     fd4:	32090913          	addi	s2,s2,800 # 12f0 <malloc+0x214>
        for(; *s; s++)
     fd8:	02800593          	li	a1,40
     fdc:	b7c5                	j	fbc <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
     fde:	8bce                	mv	s7,s3
      state = 0;
     fe0:	4981                	li	s3,0
     fe2:	bbf9                	j	dc0 <vprintf+0x4a>
     ...
     ff4:	60e6                	ld	ra,88(sp)
     ff6:	6446                	ld	s0,80(sp)
     ff8:	6906                	ld	s2,64(sp)
     ffa:	6125                	addi	sp,sp,96
     ffc:	8082                	ret

0000000000000ffe <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
     ffe:	715d                	addi	sp,sp,-80
    1000:	ec06                	sd	ra,24(sp)
    1002:	e822                	sd	s0,16(sp)
    1004:	1000                	addi	s0,sp,32
    1006:	e010                	sd	a2,0(s0)
    1008:	e414                	sd	a3,8(s0)
    100a:	e818                	sd	a4,16(s0)
    100c:	ec1c                	sd	a5,24(s0)
    100e:	03043023          	sd	a6,32(s0)
    1012:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    1016:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    101a:	8622                	mv	a2,s0
    101c:	d5bff0ef          	jal	d76 <vprintf>
}
    1020:	60e2                	ld	ra,24(sp)
    1022:	6442                	ld	s0,16(sp)
    1024:	6161                	addi	sp,sp,80
    1026:	8082                	ret

0000000000001028 <printf>:

void
printf(const char *fmt, ...)
{
    1028:	711d                	addi	sp,sp,-96
    102a:	ec06                	sd	ra,24(sp)
    102c:	e822                	sd	s0,16(sp)
    102e:	1000                	addi	s0,sp,32
    1030:	e40c                	sd	a1,8(s0)
    1032:	e810                	sd	a2,16(s0)
    1034:	ec14                	sd	a3,24(s0)
    1036:	f018                	sd	a4,32(s0)
    1038:	f41c                	sd	a5,40(s0)
    103a:	03043823          	sd	a6,48(s0)
    103e:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    1042:	00840613          	addi	a2,s0,8
    1046:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    104a:	85aa                	mv	a1,a0
    104c:	4505                	li	a0,1
    104e:	d29ff0ef          	jal	d76 <vprintf>
}
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    1060:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1064:	00001797          	auipc	a5,0x1
    1068:	fac7b783          	ld	a5,-84(a5) # 2010 <freep>
    106c:	a02d                	j	1096 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    106e:	4618                	lw	a4,8(a2)
    1070:	9f2d                	addw	a4,a4,a1
    1072:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1076:	6398                	ld	a4,0(a5)
    1078:	6310                	ld	a2,0(a4)
    107a:	a83d                	j	10b8 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    107c:	ff852703          	lw	a4,-8(a0)
    1080:	9f31                	addw	a4,a4,a2
    1082:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1084:	ff053683          	ld	a3,-16(a0)
    1088:	a091                	j	10cc <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    108a:	6398                	ld	a4,0(a5)
    108c:	00e7e463          	bltu	a5,a4,1094 <free+0x3a>
    1090:	00e6ea63          	bltu	a3,a4,10a4 <free+0x4a>
{
    1094:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1096:	fed7fae3          	bgeu	a5,a3,108a <free+0x30>
    109a:	6398                	ld	a4,0(a5)
    109c:	00e6e463          	bltu	a3,a4,10a4 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10a0:	fee7eae3          	bltu	a5,a4,1094 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    10a4:	ff852583          	lw	a1,-8(a0)
    10a8:	6390                	ld	a2,0(a5)
    10aa:	02059813          	slli	a6,a1,0x20
    10ae:	01c85713          	srli	a4,a6,0x1c
    10b2:	9736                	add	a4,a4,a3
    10b4:	fae60de3          	beq	a2,a4,106e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    10b8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    10bc:	4790                	lw	a2,8(a5)
    10be:	02061593          	slli	a1,a2,0x20
    10c2:	01c5d713          	srli	a4,a1,0x1c
    10c6:	973e                	add	a4,a4,a5
    10c8:	fae68ae3          	beq	a3,a4,107c <free+0x22>
    p->s.ptr = bp->s.ptr;
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    10e8:	02051493          	slli	s1,a0,0x20
    10ec:	9081                	srli	s1,s1,0x20
    10ee:	04bd                	addi	s1,s1,15
    10f0:	8091                	srli	s1,s1,0x4
    10f2:	0014899b          	addiw	s3,s1,1
    10f6:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    10f8:	00001517          	auipc	a0,0x1
    10fc:	f1853503          	ld	a0,-232(a0) # 2010 <freep>
    1100:	c915                	beqz	a0,1134 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1106:	08977a63          	bgeu	a4,s1,119a <malloc+0xbe>
  ...
  if(p == (char*)-1)
    1130:	5afd                	li	s5,-1
    1132:	a081                	j	1172 <malloc+0x96>
    1134:	f04a                	sd	s2,32(sp)
    1136:	e852                	sd	s4,16(sp)
    1138:	e456                	sd	s5,8(sp)
    113a:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    113c:	00001797          	auipc	a5,0x1
    1140:	f4c78793          	addi	a5,a5,-180 # 2088 <base>
    1144:	00001717          	auipc	a4,0x1
    1148:	ecf73623          	sd	a5,-308(a4) # 2010 <freep>
    114c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    114e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1152:	b7c1                	j	1112 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    1154:	6398                	ld	a4,0(a5)
    1156:	e118                	sd	a4,0(a0)
    1158:	a8a9                	j	11b2 <malloc+0xd6>
  hp->s.size = nu;
    115a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    115e:	0541                	addi	a0,a0,16
    1160:	efbff0ef          	jal	105a <free>
  return freep;
    1164:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1168:	c12d                	beqz	a0,11ca <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    116a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    116c:	4798                	lw	a4,8(a5)
    116e:	02977263          	bgeu	a4,s1,1192 <malloc+0xb6>
    if(p == freep)
    1172:	00093703          	ld	a4,0(s2)
    1176:	853e                	mv	a0,a5
    1178:	fef719e3          	bne	a4,a5,116a <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    117c:	8552                	mv	a0,s4
    117e:	b07ff0ef          	jal	c84 <sbrk>
  if(p == (char*)-1)
    1182:	fd551ce3          	bne	a0,s5,115a <malloc+0x7e>
        return 0;
    1186:	4501                	li	a0,0
