...
000000000000008e <runcmd>:
{
  ...
  exit(0);
    ...
    close(rcmd->fd);
      f6:	5148                	lw	a0,36(a0)
      f8:	39d000ef          	jal	c94 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
      fc:	508c                	lw	a1,32(s1)
      fe:	6888                	ld	a0,16(s1)
     100:	335000ef          	jal	c34 <open>
    ...
    if(fork1() == 0){
     ...
     14c:	e90d                	bnez	a0,17e <runcmd+0xf0>
      close(1);
     14e:	4505                	li	a0,1
     150:	345000ef          	jal	c94 <close>
      dup(p[1]);
     154:	fdc42503          	lw	a0,-36(s0)
     158:	315000ef          	jal	c6c <dup>
      close(p[0]);
     15c:	fd842503          	lw	a0,-40(s0)
     160:	335000ef          	jal	c94 <close>
      close(p[1]);
     164:	fdc42503          	lw	a0,-36(s0)
     168:	32d000ef          	jal	c94 <close>
      runcmd(pcmd->left);
     16c:	6488                	ld	a0,8(s1)
...
stat(const char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
     ae6:	85ca                	mv	a1,s2
     ae8:	164000ef          	jal	c4c <fstat>
     aec:	892a                	mv	s2,a0
  close(fd);
     aee:	8526                	mv	a0,s1
     af0:	1a4000ef          	jal	c94 <close>
  return r;
     af4:	64a2                	ld	s1,8(sp)
}
     af6:	854a                	mv	a0,s2
