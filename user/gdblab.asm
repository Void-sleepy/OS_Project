...
int main(){
  ...
  while(t--){
   ...
   c:	87850513          	addi	a0,a0,-1928 # 880 <malloc+0x100>
  10:	6bc000ef          	jal	6cc <printf>
  14:	00001517          	auipc	a0,0x1
  18:	86c50513          	addi	a0,a0,-1940 # 880 <malloc+0x100>
  1c:	6b0000ef          	jal	6cc <printf>
...
trace:
 li a7, SYS_trace
 340:	03300893          	li	a7,51
 ecall
 344:	00000073          	ecall
 ret
 348:	8082                	ret

000000000000034a <stats>:

.global stats
stats:
 li a7, SYS_stats
 34a:	03400893          	li	a7,52
 ecall
 34e:	00000073          	ecall
 ret
 352:	8082                	ret
